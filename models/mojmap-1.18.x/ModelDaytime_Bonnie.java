...
public class ModelDaytime_Bonnie<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "daytime_bonnie"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition right_hand = bone2.addOrReplaceChild("right_hand",
				CubeListBuilder.create().texOffs(42, 38)
						.addBox(0.29F, 0.4F, -1.9F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.2F)).texOffs(28, 21)
						...
						.addBox(0.29F, 0.4F, -0.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.2F)).texOffs(42, 38)
		...
		PartDefinition bone9 = bone4.addOrReplaceChild("bone9",
				CubeListBuilder.create().texOffs(60, 13)
						.addBox(-1.4F, -0.099F, -2.7F, 3.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(72, 48)
		...
		PartDefinition bone5 = Body.addOrReplaceChild("bone5", CubeListBuilder.create().texOffs(104, 94)
				.addBox(0.9375F, -0.875F, -13.375F, 5.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(106, 107)
				.addBox(-0.0625F, -0.875F, -7.375F, 5.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(86, 107)
