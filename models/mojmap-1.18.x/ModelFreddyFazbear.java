...
public class ModelFreddyFazbear<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "freddyfazbear"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(83, 52)
						.addBox(-4.0F, -8.0F, -4.0F, 8.0F, 7.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(24, 34)
						.addBox(-3.0F, -9.0F, -3.5F, 6.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(48, 49)
						.addBox(-2.0F, -12.0F, -2.5F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(87, 18)
						.addBox(-4.5F, -3.0F, -4.0F, 9.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 94)
