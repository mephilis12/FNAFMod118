...
public class ModelPlushtrap<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "plushtrap"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head2 = Head.addOrReplaceChild("Head2",
				CubeListBuilder.create().texOffs(14, 25)
						...
						.mirror().addBox(-2.5F, -4.6F, -2.5F, 5.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(43, 57).addBox(-1.5F, -5.6F, -2.5F, 3.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
						.texOffs(7, 16).addBox(-2.3F, -2.05F, -2.5F, 0.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
						.texOffs(22, 15).addBox(-1.5F, -2.05F, -3.3F, 3.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
						.texOffs(7, 16).addBox(2.3F, -2.05F, -2.5F, 0.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
						.texOffs(55, 15).addBox(-1.8F, -3.6F, -2.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.25F))
						.texOffs(55, 15).addBox(0.8F, -3.6F, -2.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.25F))
						.texOffs(37, 37).addBox(-2.0F, -4.1F, -2.0F, 4.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition LeftArm = partdefinition.addOrReplaceChild("LeftArm", CubeListBuilder.create(),
				PartPose.offset(2.5F, 11.5F, 0.5F));
		...
		PartDefinition bone8 = bone7.addOrReplaceChild("bone8",
				CubeListBuilder.create().texOffs(1, 17)
						.addBox(0.0F, -0.5F, -1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(22, 11)
						.addBox(1.0F, -0.5F, -2.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(13, 21)
						.addBox(2.0F, -0.5F, -1.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(17, 7)
						...
						.addBox(-1.5F, -3.6875F, -1.0F, 3.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
