...
public class ModelDaytime_Chica<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "daytime_chica"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = Body.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(98, 118)
						.addBox(-4.0F, -8.0F, -4.0F, 8.0F, 3.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(81, 84)
						.addBox(-4.5F, -5.0F, -4.0F, 9.0F, 6.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(0, 98)
						.addBox(-2.0F, -2.0F, -7.0F, 4.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(1, 95)
						.addBox(-1.0F, -3.0F, -6.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -15.8F, 0.0F, -0.0436F, 0.1745F, 0.0F));

		PartDefinition Head_r1 = Head.addOrReplaceChild("Head_r1",
				CubeListBuilder.create().texOffs(46, 4).addBox(-4.0F, -1.9F, 0.3F, 8.0F, 1.0F, 0.0F,
		...
		PartDefinition RightEar_r1 = bone14.addOrReplaceChild("RightEar_r1",
				CubeListBuilder.create().texOffs(72, 105).addBox(-2.0392F, -3.2064F, -3.3327F, 3.0F, 3.0F, 0.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition RightEar_r2 = bone12.addOrReplaceChild("RightEar_r2",
				CubeListBuilder.create().texOffs(72, 105).addBox(0.0392F, -1.6062F, -2.6698F, 3.0F, 3.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.5743F, -0.9999F, 1.1781F, 0.0F, 0.0F));

		PartDefinition bone13 = bone12
				.addOrReplaceChild("bone13",
						CubeListBuilder.create().texOffs(62, 124).addBox(-2.5F, 3.5743F, 0.0001F, 3.0F, 1.0F, 3.0F,
								new CubeDeformation(0.0F)),
		...
		PartDefinition RightEar_r3 = bone13.addOrReplaceChild("RightEar_r3",
				CubeListBuilder.create().texOffs(72, 105).addBox(-2.5F, -0.9281F, -2.389F, 3.0F, 3.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.5743F, -0.9999F, 1.1781F, 0.0F, 0.0F));

		PartDefinition Jaw = Head
				.addOrReplaceChild("Jaw",
						CubeListBuilder.create().texOffs(35, 119).addBox(-2.0F, -0.9F, -7.2F, 4.0F, 2.0F, 3.0F,
								new CubeDeformation(0.0F)),
		...
		PartDefinition right_hand = bone2.addOrReplaceChild("right_hand",
				CubeListBuilder.create().texOffs(61, 32)
						...
						.addBox(-0.41F, 0.7F, -0.5F, 1.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 17)
						.addBox(-0.41F, 0.7F, -0.5F, 1.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition LeftArm_r3 = right_hand.addOrReplaceChild("LeftArm_r3",
				CubeListBuilder.create().texOffs(42, 38)
						.addBox(-0.7F, -0.6F, 1.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.2F)).texOffs(52, 5)
						.addBox(-0.7F, -0.6F, -0.4F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.2F)).texOffs(42, 38)
						.addBox(-0.7F, -0.6F, -1.8F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.2F)),
				PartPose.offsetAndRotation(-0.01F, 3.2F, 0.9F, 0.0F, 0.0F, 0.9163F));

		PartDefinition LeftArm_r4 = right_hand
				.addOrReplaceChild("LeftArm_r4",
						CubeListBuilder.create().texOffs(36, 63).addBox(-0.6F, -0.1F, -1.5F, 2.0F, 1.0F, 3.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.39F, 2.7F, 1.0F, 0.0F, 0.0F, 0.8727F));

		PartDefinition bone5 = right_hand.addOrReplaceChild("bone5",
				CubeListBuilder.create().texOffs(28, 21).addBox(-0.5F, -1.0F, -1.5F, 1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.2F)),
				PartPose.offsetAndRotation(1.0203F, 1.2294F, -1.7F, 1.2217F, 0.0F, 2.2253F));

		PartDefinition bone6 = right_hand.addOrReplaceChild("bone6", CubeListBuilder.create().texOffs(13, 112)
				.addBox(-6.0F, -5.0F, -4.0F, 1.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offset(7.1186F, 3.1286F, 1.0F));

		PartDefinition cupcake = bone6.addOrReplaceChild("cupcake",
				CubeListBuilder.create().texOffs(76, 112).mirror()
						.addBox(-3.0286F, 2.0714F, -2.0F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(67, 119).mirror()
						.addBox(-1.5286F, -4.4286F, -0.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
						.texOffs(92, 122).addBox(-1.0286F, -5.4286F, -0.5F, 0.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
						.texOffs(74, 119).addBox(-3.5286F, -1.4286F, -2.5F, 5.0F, 4.0F, 5.0F, new CubeDeformation(0.0F))
						.texOffs(72, 120).addBox(1.2714F, 2.0714F, -1.5F, 0.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
						.texOffs(89, 119).addBox(1.4714F, 0.0714F, -2.0F, 0.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
						.texOffs(90, 114).addBox(1.3714F, -0.9286F, -2.5F, 0.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bone4 = LeftLeg.addOrReplaceChild("bone4",
				CubeListBuilder.create().texOffs(0, 120)
						.addBox(-1.5F, 0.5F, -1.2F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(60, 13)
		...
		PartDefinition bone9 = bone4.addOrReplaceChild("bone9",
				CubeListBuilder.create().texOffs(48, 34).addBox(-1.9F, -1.0F, -3.2F, 4.0F, 2.0F, 5.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition right_lower_leg = RightLeg.addOrReplaceChild("right_lower_leg",
				CubeListBuilder.create().texOffs(0, 120)
						.addBox(-1.5F, 0.5F, -1.2F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition bone8 = right_lower_leg.addOrReplaceChild("bone8",
				CubeListBuilder.create().texOffs(48, 34).addBox(-2.0F, -1.0F, -3.2F, 4.0F, 2.0F, 5.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bone = Body.addOrReplaceChild("bone", CubeListBuilder.create().texOffs(20, 101).addBox(-3.5F,
				-2.5F, -1.4F, 7.0F, 9.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -12.0F, -3.5F));
		...
		PartDefinition bone7 = Body.addOrReplaceChild("bone7",
				CubeListBuilder.create().texOffs(0, 82).addBox(1.2125F, -0.2017F, -1.5F, 6.0F, 6.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.0F, -17.2F, 1.5F, 0.0F, 0.0F, 0.7854F));

		PartDefinition bone10 = Body.addOrReplaceChild("bone10",
				CubeListBuilder.create().texOffs(43, 102).addBox(-4.7668F, 8.9542F, -1.5F, 1.0F, 6.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.0F, -27.5F, 1.5F, 0.0F, 0.0F, -0.3927F));

		PartDefinition bone11 = Body.addOrReplaceChild("bone11",
				CubeListBuilder.create().texOffs(43, 102).addBox(0.9952F, 10.1022F, -1.5F, 1.0F, 6.0F, 0.0F,
						new CubeDeformation(0.0F)),
