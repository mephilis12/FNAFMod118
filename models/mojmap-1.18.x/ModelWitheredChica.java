...
public class ModelWitheredChica<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "witheredchica"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition LeftArm_r1 = bone3.addOrReplaceChild("LeftArm_r1",
		...
		PartDefinition LeftArm_r2 = bone2.addOrReplaceChild("LeftArm_r2",
		...
		PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg",
				CubeListBuilder.create().texOffs(28, 43)
						.addBox(-0.9F, 3.0F, -2.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(26, 33)
		...
		PartDefinition bone4 = LeftLeg.addOrReplaceChild("bone4",
				CubeListBuilder.create().texOffs(0, 47)
						.addBox(0.6F, -8.0F, 0.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(36, 58)
		...
		PartDefinition LeftArm_r3 = bone4.addOrReplaceChild("LeftArm_r3",
		...
		PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg",
				CubeListBuilder.create().texOffs(36, 63)
						.addBox(-1.5019F, 3.0F, -0.9564F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.2F)).texOffs(28, 62)
						.addBox(-1.5F, -3.0F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(38, 39)
		...
		PartDefinition right_lower_leg = RightLeg.addOrReplaceChild("right_lower_leg",
				CubeListBuilder.create().texOffs(24, 47)
						.addBox(-4.5F, -8.0F, 0.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition LeftArm_r4 = right_lower_leg.addOrReplaceChild("LeftArm_r4",
				CubeListBuilder.create().texOffs(22, 0).addBox(-1.5F, 0.2898F, -2.0776F, 3.0F, 0.0F, 2.0F,
						new CubeDeformation(0.0F)),
