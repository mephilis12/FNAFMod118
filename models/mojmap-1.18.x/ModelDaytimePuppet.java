...
public class ModelDaytimePuppet<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "daytimepuppet"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition left_leg = partdefinition.addOrReplaceChild("left_leg",
				CubeListBuilder.create().texOffs(0, 21).addBox(-1.0F, -0.5F, -1.0F, 2.0F, 11.0F, 2.0F,
		...
		PartDefinition left_lower_leg = left_leg.addOrReplaceChild("left_lower_leg",
				CubeListBuilder.create().texOffs(34, 0).addBox(-0.5F, -0.3333F, -0.5F, 1.0F, 10.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition right_leg = partdefinition.addOrReplaceChild("right_leg",
				CubeListBuilder.create().texOffs(18, 15).addBox(-1.0F, -0.5F, -1.0F, 2.0F, 11.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition right_lower_leg = right_leg.addOrReplaceChild("right_lower_leg",
				CubeListBuilder.create().texOffs(33, 31).addBox(-0.5F, -0.3333F, -0.5F, 1.0F, 10.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition right_lower_arm = right_arm.addOrReplaceChild("right_lower_arm",
				CubeListBuilder.create().texOffs(34, 11).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 9.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition left_lower_arm = left_arm.addOrReplaceChild("left_lower_arm",
				CubeListBuilder.create().texOffs(4, 34).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 9.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(25, 31)
						.addBox(-0.5F, -26.0F, -0.5F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 11)
