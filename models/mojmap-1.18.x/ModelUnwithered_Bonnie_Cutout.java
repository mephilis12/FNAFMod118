...
public class ModelUnwithered_Bonnie_Cutout<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "unwithered_bonnie_cutout"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone = partdefinition.addOrReplaceChild("bone",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-18.4F, -53.0F, -0.99F, 38.0F, 53.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(0, 53)
		...
		PartDefinition cube_r1 = bone.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(21, 106)
						.addBox(-13.6F, -9.0F, -9.51F, 14.0F, 25.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(21, 106)
