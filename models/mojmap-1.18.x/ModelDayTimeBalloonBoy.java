...
public class ModelDayTimeBalloonBoy<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "daytimeballoonboy"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(0, 79)
						.addBox(-18.0F, -15.4375F, -3.8813F, 9.0F, 11.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(-4.5F, 0.0625F, -3.8813F, 9.0F, 9.0F, 9.0F, new CubeDeformation(0.0F)).texOffs(27, 0)
		...
		PartDefinition left_leg = body.addOrReplaceChild("left_leg",
				CubeListBuilder.create().texOffs(0, 42)
						.addBox(-1.5F, 0.3F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(12, 42)
		...
		PartDefinition right_leg = body.addOrReplaceChild("right_leg",
				CubeListBuilder.create().texOffs(0, 42)
						.addBox(-1.5F, 0.3F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(36, 6)
		...
		PartDefinition head = body.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-2.5F, -6.0556F, -3.5F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(27, 6)
