...
public class Modelpuppet<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "puppet"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(14, 0)
						.addBox(-3.5F, -3.5F, -3.0F, 7.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 44)
						.addBox(-3.0F, -7.5F, -3.0F, 6.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(-2.5F, -7.0F, -2.0F, 5.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.5F, -16.0F, 0.5F));

		PartDefinition left_arm = partdefinition.addOrReplaceChild("left_arm",
				CubeListBuilder.create().texOffs(8, 21).addBox(-0.9393F, -0.3536F, -2.2F, 2.0F, 9.0F, 2.0F,
		...
		PartDefinition left_lower_arm = left_arm.addOrReplaceChild("left_lower_arm",
				CubeListBuilder.create().texOffs(4, 34).addBox(-1.3056F, -3.3536F, -1.3914F, 1.0F, 9.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r1 = left_lower_arm.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(8, 30)
						.addBox(0.0F, -4.5F, -1.0F, 0.0F, 9.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(20, 36)
		...
		PartDefinition right_hand2 = left_lower_arm.addOrReplaceChild("right_hand2", CubeListBuilder.create(),
				PartPose.offsetAndRotation(-0.2F, 2.5F, -2.0F, 0.0F, 2.3562F, 0.0F));

		PartDefinition bone5 = right_hand2.addOrReplaceChild("bone5",
				CubeListBuilder.create().texOffs(24, 39).addBox(-0.4414F, -0.235F, -0.5325F, 1.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.4142F, 3.25F, -1.2F, -0.7418F, 0.0F, 0.0F));

		PartDefinition cube_r2 = bone5.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(38, 16).addBox(-1.5F, -1.0F, -0.5F, 1.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bone6 = right_hand2.addOrReplaceChild("bone6",
				CubeListBuilder.create().texOffs(38, 12).addBox(-0.4414F, -0.1501F, -0.5358F, 1.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.4142F, 3.15F, -1.2F, -0.3054F, 0.0F, 0.0F));

		PartDefinition cube_r3 = bone6.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(38, 8).addBox(-0.5F, -1.0F, -0.5F, 1.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bone7 = right_hand2.addOrReplaceChild("bone7",
				CubeListBuilder.create().texOffs(0, 11).addBox(-0.4414F, -0.235F, -0.5325F, 1.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.5858F, 3.25F, -1.2F, -0.7418F, 0.0F, 0.0F));

		PartDefinition cube_r4 = bone7.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(0, 0).addBox(0.5F, -1.0F, -0.5F, 1.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.9414F, 3.5684F, -0.31F, -0.3054F, 0.0F, 0.0F));

		PartDefinition right_arm = partdefinition.addOrReplaceChild("right_arm",
				CubeListBuilder.create().texOffs(26, 15).addBox(-1.4142F, 0.0F, -2.2F, 2.0F, 9.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition right_lower_arm = right_arm.addOrReplaceChild("right_lower_arm",
				CubeListBuilder.create().texOffs(34, 11).addBox(-1.6414F, -3.0F, -1.0556F, 1.0F, 9.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 12.0F, 0.0F, 0.0F, -0.7854F, 0.0F));

		PartDefinition cube_r5 = right_lower_arm.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(0, 32)
						.addBox(0.0F, -4.5F, -1.0F, 0.0F, 9.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(37, 27)
						.addBox(-1.0F, -4.5F, 0.0F, 2.0F, 9.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition right_hand = right_lower_arm.addOrReplaceChild("right_hand", CubeListBuilder.create(),
				PartPose.offsetAndRotation(-1.7F, 3.0F, 0.5F, 0.0F, -0.7854F, 0.0F));

		PartDefinition bone2 = right_hand.addOrReplaceChild("bone2",
				CubeListBuilder.create().texOffs(24, 39).addBox(-0.4373F, -0.3907F, -0.5793F, 1.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.4142F, 3.25F, -1.2F, -0.7418F, 0.0F, 0.0F));
		...
		PartDefinition bone3 = right_hand.addOrReplaceChild("bone3",
				CubeListBuilder.create().texOffs(38, 12).addBox(-0.4373F, -0.311F, -0.5124F, 1.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.4142F, 3.15F, -1.2F, -0.3054F, 0.0F, 0.0F));
		...
		PartDefinition bone4 = right_hand.addOrReplaceChild("bone4",
				CubeListBuilder.create().texOffs(0, 11).addBox(-0.4373F, -0.3907F, -0.5793F, 1.0F, 3.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.5858F, 3.25F, -1.2F, -0.7418F, 0.0F, 0.0F));
		...
		PartDefinition left_leg = partdefinition.addOrReplaceChild("left_leg", CubeListBuilder.create().texOffs(0, 21)
				.addBox(-1.0F, -0.5F, -1.0F, 2.0F, 11.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(2.5F, 3.5F, 0.5F));

		PartDefinition left_lower_leg = left_leg.addOrReplaceChild("left_lower_leg",
				CubeListBuilder.create().texOffs(34, 0).addBox(-0.5F, -4.3333F, -0.5F, 1.0F, 10.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r9 = left_lower_leg.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(38, 0)
						.addBox(-1.0F, -4.0F, 0.0F, 2.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(16, 34)
		...
		PartDefinition right_leg = partdefinition.addOrReplaceChild("right_leg", CubeListBuilder.create()
				.texOffs(18, 15).addBox(-1.0F, -0.5F, -1.0F, 2.0F, 11.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-1.5F, 3.5F, 0.5F));

		PartDefinition right_lower_leg = right_leg.addOrReplaceChild("right_lower_leg",
				CubeListBuilder.create().texOffs(33, 31).addBox(-0.5F, -4.3333F, -0.5F, 1.0F, 10.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 14.8333F, 0.0F, 0.0F, -0.7854F, 0.0F));

		PartDefinition cube_r10 = right_lower_leg.addOrReplaceChild("cube_r10",
				CubeListBuilder.create().texOffs(37, 36)
						.addBox(-1.0F, -4.0F, 0.0F, 2.0F, 8.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(12, 34)
						.addBox(0.0F, -4.0F, -1.0F, 0.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -0.3333F, 0.0F, 0.0F, -0.7854F, 0.0F));

		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(23, 26)
						.addBox(-1.5F, -23.0F, -1.0F, 4.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(25, 31)
						.addBox(-0.5F, -26.0F, -0.5F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(13, 29)
						.addBox(-1.0F, -30.0F, -1.0F, 3.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(34, 21)
						.addBox(-0.5F, -40.0F, -0.5F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 11)
