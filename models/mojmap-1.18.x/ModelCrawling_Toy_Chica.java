...
public class ModelCrawling_Toy_Chica<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "crawling_toy_chica"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(0, 0).addBox(-4.5F, -7.2F, -4.8F, 9.0F, 9.0F, 8.0F,
		...
		PartDefinition LeftArm = partdefinition.addOrReplaceChild("LeftArm",
				CubeListBuilder.create().texOffs(20, 57)
						.addBox(-0.35F, -0.4F, -0.5F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 103)
						.addBox(-1.35F, 0.6F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(12, 43)
						.addBox(-0.8F, 5.5F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(5.0F, 18.0F, -5.0F, -0.7418F, 0.0F, 0.0F));
		...
		PartDefinition right_hand2 = bone3.addOrReplaceChild("right_hand2",
				CubeListBuilder.create().texOffs(42, 67)
						.addBox(-0.89F, -0.3F, -1.5F, 2.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(34, 61)
						.addBox(1.11F, 0.7F, -0.5F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(28, 68)
		...
		PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm",
				CubeListBuilder.create().texOffs(0, 89)
						.addBox(-1.5F, 0.5F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(20, 57)
						.addBox(-0.5F, -0.5F, -0.5F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(12, 43)
						.addBox(-1.0F, 5.5F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-5.0F, 19.0F, -6.0F, -0.7854F, 0.0F, 0.0F));
		...
		PartDefinition bone2 = RightArm.addOrReplaceChild("bone2",
				...
				PartPose.offsetAndRotation(0.0F, 6.3F, 0.0F, -0.7418F, 0.0F, 0.0F));
		...
		PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg",
				...
				PartPose.offsetAndRotation(2.6F, 21.0F, 4.0F, 1.3963F, 0.0F, 0.0F));
		...
		PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg",
				CubeListBuilder.create().texOffs(12, 43)
						...
						.addBox(-1.0F, 0.0F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.5F, 20.0F, 4.0F, 1.0908F, 0.0F, 0.0F));
