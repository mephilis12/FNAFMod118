...
public class ModelUnwithered_Bonnie_Posed<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "unwithered_bonnie_posed"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition RightLeg_r1 = bone3
		...
		PartDefinition bone9 = Body.addOrReplaceChild("bone9",
				CubeListBuilder.create().texOffs(77, 98)
						.addBox(-1.0F, -0.5F, -0.7823F, 2.0F, 1.0F, 15.0F, new CubeDeformation(0.0F)).texOffs(96, 98)
		...
		PartDefinition cube_r1 = bone9.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(77, 114).addBox(-7.0F, -1.0F, 0.0F, 4.0F, 1.0F, 9.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(9.1459F, 0.5F, -11.5706F, 0.0F, -0.3927F, 0.0F));

		PartDefinition cube_r2 = bone9.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(94, 115).addBox(-13.0F, -1.0F, 0.0F, 4.0F, 1.0F, 9.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bone7 = LeftArm.addOrReplaceChild("bone7",
				CubeListBuilder.create().texOffs(29, 66)
						.addBox(-0.5F, 0.2F, -0.5F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(64, 21)
						.addBox(-1.0F, 1.2F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(16, 52)
						.addBox(-1.49F, 0.2F, -2.0F, 3.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition right_hand2 = bone7.addOrReplaceChild("right_hand2",
				CubeListBuilder.create().texOffs(42, 38)
						.addBox(-0.7F, 2.4F, -1.9F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.2F)).texOffs(61, 32)
		...
		PartDefinition Head = Body.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(25, 21)
						.addBox(-4.0F, -7.0F, -4.0F, 8.0F, 6.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(13, 37)
		...
		PartDefinition endo_head2 = Head.addOrReplaceChild("endo_head2", CubeListBuilder.create().texOffs(39, 18)
