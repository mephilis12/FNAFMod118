...
public class ModelDaytimeSpringtrap<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "daytimespringtrap"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = Body
				.addOrReplaceChild("cube_r1",
						CubeListBuilder.create().texOffs(57, 18).addBox(-4.5F, -1.5F, -3.0F, 9.0F, 3.0F, 6.0F,
		...
		PartDefinition bone6 = bone3.addOrReplaceChild("bone6",
				CubeListBuilder.create().texOffs(9, 45)
						.addBox(-1.0909F, 0.1F, -1.6F, 1.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(99, 56)
		...
		PartDefinition bone4 = LeftLeg.addOrReplaceChild("bone4",
				CubeListBuilder.create().texOffs(95, 123)
						...
						.addBox(-0.9F, 1.0F, -1.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(28, 22)
		...
		PartDefinition bone12 = bone4.addOrReplaceChild("bone12",
				CubeListBuilder.create().texOffs(0, 122)
						.addBox(-1.5F, 0.001F, -1.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(54, 123)
		...
		PartDefinition right_lower_leg = RightLeg.addOrReplaceChild("right_lower_leg",
				CubeListBuilder.create().texOffs(98, 9)
						...
						.addBox(-1.0F, 7.0F, 0.0F, 2.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bone13 = right_lower_leg.addOrReplaceChild("bone13",
				CubeListBuilder.create().texOffs(0, 122)
						.addBox(-2.0F, 0.001F, -1.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(54, 123)
		...
		PartDefinition LeftArm_r3 = bone13.addOrReplaceChild("LeftArm_r3",
				CubeListBuilder.create().texOffs(44, 115)
						.addBox(-1.5F, -1.0F, -4.0F, 0.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(44, 115)
						.addBox(-0.5F, -1.0F, -4.0F, 0.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(44, 115)
						.addBox(0.5F, -1.0F, -4.0F, 0.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(37, 122)
