...
public class ModelSpringBonnieSitting<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "springbonniesitting"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = Body.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(77, 1).addBox(-2.0F, -2.25F, 0.5F, 4.0F, 4.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -3.25F, 2.5F, -0.0837F, -0.0349F, -0.003F));

		PartDefinition cube_r2 = Body.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(0, 34).addBox(-4.5F, -1.5F, -3.0F, 9.0F, 3.0F, 6.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition LeftArm_r2 = bone6.addOrReplaceChild("LeftArm_r2",
				CubeListBuilder.create().texOffs(44, 40).addBox(0.75F, -0.4F, 1.5F, 2.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition LeftArm_r3 = bone6.addOrReplaceChild("LeftArm_r3",
				CubeListBuilder.create().texOffs(0, 64).addBox(-0.75F, -2.5F, -1.5F, 3.0F, 2.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition LeftArm_r4 = right_hand
				.addOrReplaceChild("LeftArm_r4",
						CubeListBuilder.create().texOffs(24, 63).addBox(-0.5F, -1.7F, -2.0F, 3.0F, 2.0F, 4.0F,
								new CubeDeformation(0.0F)),
		...
		PartDefinition LeftArm_r5 = right_hand.addOrReplaceChild("LeftArm_r5",
				CubeListBuilder.create().texOffs(44, 40).addBox(1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
