...
public class ModelMangle_Day<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "mangle_day"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone8 = LeftArm3.addOrReplaceChild("bone8",
				CubeListBuilder.create().texOffs(0, 13)
						.addBox(-0.5F, 1.0F, -0.5F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(50, 24)
						.addBox(-1.0F, 2.1F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(50, 36)
						.addBox(-1.0F, 7.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r3 = endoi_jaw.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(0, 40).addBox(-2.5F, -2.25F, -3.5F, 5.0F, 9.0F, 0.0F,
		...
		PartDefinition bone4 = LeftLeg.addOrReplaceChild("bone4",
				CubeListBuilder.create().texOffs(49, 48).addBox(-0.5F, 1.001F, -0.5F, 2.0F, 6.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bone7 = bone4.addOrReplaceChild("bone7",
				CubeListBuilder.create().texOffs(18, 0)
						.addBox(-1.0462F, 0.0753F, -6.21F, 2.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(39, 26)
		...
		PartDefinition bone11 = LeftLeg2.addOrReplaceChild("bone11",
				CubeListBuilder.create().texOffs(49, 48).addBox(-1.4F, 1.001F, -0.5F, 2.0F, 6.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 7.0F, 0.0F, 2.1357F, 0.0025F, 0.1526F));

		PartDefinition bone12 = bone11.addOrReplaceChild("bone12",
				CubeListBuilder.create().texOffs(18, 0)
						.addBox(0.1F, 0.902F, -6.5F, 2.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(39, 26)
		...
		PartDefinition LeftArm_r1 = right_hand3.addOrReplaceChild("LeftArm_r1",
				CubeListBuilder.create().texOffs(42, 5).addBox(-0.5333F, -0.5F, -1.5F, 3.0F, 2.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition right_lower_leg2 = RightLeg2.addOrReplaceChild("right_lower_leg2",
				CubeListBuilder.create().texOffs(49, 48).addBox(-1.5F, 1.0F, -0.5F, 2.0F, 6.0F, 2.0F,
						new CubeDeformation(0.0F)),
