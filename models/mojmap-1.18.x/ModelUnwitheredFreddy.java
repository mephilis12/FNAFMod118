...
public class ModelUnwitheredFreddy<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "unwitheredfreddy"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition LeftArm_r1 = right_lower_leg.addOrReplaceChild("LeftArm_r1",
		...
		PartDefinition RightLeg_r1 = bone8
		...
		PartDefinition bone4 = LeftLeg.addOrReplaceChild("bone4",
				CubeListBuilder.create().texOffs(0, 48)
						.addBox(-2.0F, -0.5F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(48, 34)
		...
		PartDefinition RightLeg_r3 = bone9.addOrReplaceChild("RightLeg_r3",
				CubeListBuilder.create().texOffs(74, 5).addBox(-0.3F, -1.0F, -5.0F, 2.0F, 2.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.1F, 0.0F, -2.2F, 0.0F, -0.3927F, 0.0F));

		PartDefinition RightLeg_r4 = bone9
		...
		PartDefinition cube_r2 = right_hand2.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(61, 117)
						.addBox(-5.4F, -6.0F, -1.9949F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(60, 119)
		...
		PartDefinition cube_r3 = right_hand2.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(76, 116)
						.addBox(3.09F, 0.4F, -3.25F, 2.0F, 6.0F, 6.0F, new CubeDeformation(0.15F)).texOffs(94, 116)
						.addBox(2.0F, 0.4F, -3.25F, 3.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(112, 114)
						.addBox(1.0F, 0.0F, -3.75F, 1.0F, 7.0F, 7.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition LeftArm_r4 = right_hand2.addOrReplaceChild("LeftArm_r4",
				CubeListBuilder.create().texOffs(28, 21).addBox(-0.5F, -1.0F, -0.5F, 1.0F, 2.0F, 1.0F,
		...
		PartDefinition LeftArm_r6 = right_hand2
				.addOrReplaceChild("LeftArm_r6",
		...
		PartDefinition LeftArm_r7 = right_hand2.addOrReplaceChild("LeftArm_r7",
