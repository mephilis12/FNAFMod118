...
public class ModelStandingSpringBonnie<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "standingspringbonnie"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition LeftArm_r2 = bone6.addOrReplaceChild("LeftArm_r2",
				CubeListBuilder.create().texOffs(44, 40).addBox(1.0F, -2.0F, 0.5F, 2.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition LeftArm_r3 = bone6.addOrReplaceChild("LeftArm_r3",
				CubeListBuilder.create().texOffs(0, 64).addBox(-0.4226F, -2.5F, -1.5F, 3.0F, 2.0F, 4.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition LeftArm_r4 = right_hand
				.addOrReplaceChild("LeftArm_r4",
						CubeListBuilder.create().texOffs(24, 63).addBox(-0.5F, -1.0F, -2.0F, 3.0F, 2.0F, 4.0F,
								new CubeDeformation(0.0F)),
