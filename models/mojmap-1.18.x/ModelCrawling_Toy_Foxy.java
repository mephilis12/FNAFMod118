...
public class ModelCrawling_Toy_Foxy<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "crawling_toy_foxy"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition LeftArm = partdefinition.addOrReplaceChild("LeftArm",
				CubeListBuilder.create().texOffs(11, 63)
						.addBox(-0.35F, -1.4F, -0.5F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(41, 55)
						.addBox(-1.35F, -0.4F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(28, 47)
						.addBox(-0.8F, 4.5F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm",
				CubeListBuilder.create().texOffs(29, 54)
						.addBox(-1.5F, -0.5F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(11, 63)
						.addBox(-0.5F, -1.5F, -0.5F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(28, 47)
						.addBox(-1.0F, 4.5F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r2 = endo_torso.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(24, 18)
						.addBox(-4.5F, -1.5F, -3.0F, 9.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(27, 0)
