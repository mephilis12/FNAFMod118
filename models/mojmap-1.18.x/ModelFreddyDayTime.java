...
public class ModelFreddyDayTime<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "freddydaytime"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition endo_head2 = Head.addOrReplaceChild("endo_head2", CubeListBuilder.create().texOffs(48, 77)
		...
		PartDefinition RightArm = Body.addOrReplaceChild("RightArm",
				CubeListBuilder.create().texOffs(32, 49)
						.addBox(-2.01F, 2.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(32, 49)
