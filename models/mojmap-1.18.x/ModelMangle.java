...
public class ModelMangle<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "mangle"), "main");
	...
	public ModelMangle(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition LeftArm = partdefinition.addOrReplaceChild("LeftArm",
				...
				PartPose.offsetAndRotation(6.5F, 3.5F, 1.0F, -0.0477F, 0.274F, -1.0241F));
		...
		PartDefinition RightArmHead = partdefinition.addOrReplaceChild("RightArmHead",
				...
				PartPose.offsetAndRotation(-6.5F, 3.5F, 1.0F, 0.0F, 0.0F, 1.9199F));
		...
		PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm",
				...
				PartPose.offsetAndRotation(-2.5F, 14.0F, 1.0F, 1.7453F, 1.1781F, 3.1416F));
		...
		PartDefinition Neck3 = partdefinition.addOrReplaceChild("Neck3",
				...
				PartPose.offsetAndRotation(-3.5F, -8.6F, -9.0F, -1.0779F, 0.069F, -2.8387F));
		...
		PartDefinition Head = Neck3.addOrReplaceChild("Head",
				...
				PartPose.offsetAndRotation(0.0F, 7.0F, 0.0F, -1.0472F, 0.0F, 2.7053F));
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(50, 36)
						.addBox(-7.49F, -13.51F, -0.99F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(50, 36)
		...
		PartDefinition Neck = Body.addOrReplaceChild("Neck",
				CubeListBuilder.create().texOffs(50, 24)
						...
						.addBox(-0.5F, 1.0F, -0.5F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(50, 36)
						.addBox(-1.0F, 7.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.5F, -12.5F, -1.0F, -0.8651F, -0.1334F, 3.0287F));
		...
		PartDefinition LeftLeg = Body.addOrReplaceChild("LeftLeg",
				...
				PartPose.offsetAndRotation(2.0F, -2.0F, 0.0F, -1.236F, -0.4149F, -0.1393F));
		...
		PartDefinition BackLeg = Body.addOrReplaceChild("BackLeg",
				...
				PartPose.offsetAndRotation(2.1F, -3.0F, 1.0F, 2.0076F, 0.0865F, -3.1302F));
		...
		PartDefinition RightLeg2 = Body.addOrReplaceChild("RightLeg2",
				...
				PartPose.offsetAndRotation(-2.0F, -2.0F, 0.0F, -1.2515F, 0.2909F, 0.0945F));
		...
		PartDefinition endo_torso = Body.addOrReplaceChild("endo_torso",
				CubeListBuilder.create().texOffs(48, 18)
						.addBox(1.5F, -19.0F, -2.5F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(19, 40)
		...
		PartDefinition right_hand4 = endo_torso.addOrReplaceChild("right_hand4",
				...
				PartPose.offsetAndRotation(3.0F, -28.8F, -1.0F, 0.0F, 0.0F, -3.1416F));
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw,
		...
		this.BackLowerLeg.xRot = Mth.cos(limbSwing * 0.6662F) * limbSwingAmount;
		this.RightLoweLeg.xRot = Mth.cos(limbSwing * 1.0F) * 1.0F * limbSwingAmount;
		this.RightArmHead.xRot = Mth.cos(limbSwing * 1.0F) * -1.0F * limbSwingAmount;
		this.LeftLowerLeg.xRot = Mth.cos(limbSwing * 1.0F) * -1.0F * limbSwingAmount;
		this.Neck3.yRot = headPitch / (180F / (float) Math.PI);
	}
}