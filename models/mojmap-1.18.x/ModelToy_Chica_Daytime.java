...
public class ModelToy_Chica_Daytime<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "toy_chica_daytime"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(0, 0).addBox(
				-4.5F, -7.2F, -4.8F, 9.0F, 9.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -5.8F, 1.0F));

		PartDefinition cube_r1 = Head.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(68, 17).addBox(-6.0F, -4.0F, 0.0F, 6.0F, 4.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -7.2F, -0.8F, 0.0F, 1.2654F, 0.0F));

		PartDefinition cube_r2 = Head.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(68, 13).addBox(-6.0F, -4.0F, 0.0F, 6.0F, 4.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -7.2F, -0.8F, 0.0F, -2.618F, 0.0F));

		PartDefinition cube_r3 = Head.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(68, 9).addBox(-6.0F, -4.0F, 0.0F, 6.0F, 4.0F, 0.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition bone10 = Head.addOrReplaceChild("bone10", CubeListBuilder.create(),
				PartPose.offset(1.0F, -5.9312F, -5.6113F));

		PartDefinition Head_r1 = bone10
				.addOrReplaceChild("Head_r1",
						CubeListBuilder.create().texOffs(64, 25).addBox(-5.0F, -0.4F, 0.6F, 8.0F, 1.0F, 0.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.8727F, 0.0F, 0.0F));

		PartDefinition endo_head = Head.addOrReplaceChild("endo_head", CubeListBuilder.create().texOffs(28, 48)
				.addBox(10.2381F, -1.4048F, 1.2857F, 6.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(48, 8)
				.addBox(9.7381F, -5.4048F, 0.7857F, 7.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(15, 32)
				...
				.addBox(14.7381F, -2.4048F, -2.8143F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(4, 22)
		...
		PartDefinition cube_r4 = endoi_jaw.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(50, 27)
						.addBox(-1.5F, -0.75F, -1.5F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(16, 48)
		...
		PartDefinition beak = Head.addOrReplaceChild("beak",
				CubeListBuilder.create().texOffs(39, 21)
						.addBox(12.0F, -18.5F, -8.0F, 4.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(34, 8)
		...
		PartDefinition LeftArm = partdefinition.addOrReplaceChild("LeftArm",
				CubeListBuilder.create().texOffs(20, 57)
						.addBox(-0.35F, 0.6F, -0.5F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 103)
						.addBox(-1.35F, 1.6F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(12, 43)
		...
		PartDefinition bone3 = LeftArm.addOrReplaceChild("bone3",
				CubeListBuilder.create().texOffs(0, 17)
						.addBox(-0.3F, 0.2F, -0.5F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 103)
		...
		PartDefinition right_hand2 = bone3.addOrReplaceChild("right_hand2",
				CubeListBuilder.create().texOffs(42, 67)
						.addBox(-0.89F, -0.3F, -1.5F, 2.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(76, 114)
						.addBox(0.19F, -0.8F, -3.0F, 1.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition LeftArm_r1 = right_hand2.addOrReplaceChild("LeftArm_r1",
				CubeListBuilder.create().texOffs(28, 68).addBox(0.5F, -2.0F, -1.5F, 3.0F, 2.0F, 3.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition LeftArm_r2 = right_hand2.addOrReplaceChild("LeftArm_r2",
				CubeListBuilder.create().texOffs(34, 61).addBox(0.58F, -1.0F, 1.5F, 2.0F, 2.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.11F, 1.7F, 2.0F, 2.9028F, -0.9422F, 2.7844F));

		PartDefinition bone11 = right_hand2.addOrReplaceChild("bone11", CubeListBuilder.create().texOffs(96, 121)
				.mirror().addBox(-2.0F, 2.0714F, -0.9857F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(110, 100).mirror()
				.addBox(-0.5F, -4.4286F, 0.5143F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).mirror(false)
				.texOffs(110, 105).addBox(-0.5F, -5.4286F, 1.0143F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
				.texOffs(96, 111).addBox(-2.5F, -1.4286F, -1.4857F, 5.0F, 4.0F, 5.0F, new CubeDeformation(0.0F))
				.texOffs(101, 120).addBox(-1.5F, 2.0714F, -1.2357F, 3.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
				.texOffs(118, 123).addBox(-2.0F, 0.0714F, -1.4357F, 4.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
				.texOffs(118, 119).addBox(-2.5F, -0.9286F, -1.3857F, 5.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(5.69F, 3.1286F, -0.0143F, 0.0F, -1.5708F, 1.5708F));

		PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm",
				CubeListBuilder.create().texOffs(0, 89)
						.addBox(-1.5F, 1.5F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(20, 57)
						.addBox(-0.5F, 0.5F, -0.5F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(12, 43)
		...
		PartDefinition bone2 = RightArm.addOrReplaceChild("bone2",
				CubeListBuilder.create().texOffs(0, 17)
						.addBox(-0.5F, 0.2F, -0.5F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 89)
						.addBox(-1.5F, 0.2F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(44, 54)
		...
		PartDefinition right_hand = bone2.addOrReplaceChild("right_hand",
				CubeListBuilder.create().texOffs(24, 59)
						.addBox(-0.91F, 0.7F, -1.5F, 2.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(16, 68)
						.addBox(-0.91F, 2.7F, -1.5F, 3.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(41, 49)
		...
		PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg",
				CubeListBuilder.create().texOffs(12, 43)
						.addBox(-1.0019F, 6.0F, -1.0436F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(20, 36)
		...
		PartDefinition bone4 = LeftLeg.addOrReplaceChild("bone4",
				CubeListBuilder.create().texOffs(44, 49)
						.addBox(-1.5F, 6.901F, -2.0F, 3.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 83)
		...
		PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg",
				CubeListBuilder.create().texOffs(12, 43)
						.addBox(-1.0019F, 6.0F, -0.9564F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 31)
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(0, 97)
						.addBox(-6.5F, -13.5F, -1.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 97)
		...
		PartDefinition endo_torso = Body.addOrReplaceChild("endo_torso",
				CubeListBuilder.create().texOffs(48, 13)
						.addBox(1.5F, -19.0F, -2.5F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(54, 5)
