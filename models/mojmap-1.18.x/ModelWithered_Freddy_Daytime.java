...
public class ModelWithered_Freddy_Daytime<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "withered_freddy_daytime"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = Body.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(25, 21)
						.addBox(-4.0F, -7.0F, -4.0F, 8.0F, 6.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(24, 34)
		...
		PartDefinition LeftEar = Head.addOrReplaceChild("LeftEar",
				CubeListBuilder.create().texOffs(64, 52)
						.addBox(-1.1464F, -4.7678F, -3.0F, 3.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition bone3 = LeftArm.addOrReplaceChild("bone3",
				...
				PartPose.offsetAndRotation(0.0F, 8.3F, 0.0F, -0.3927F, 0.0F, 0.3491F));
		...
		PartDefinition LeftArm_r2 = right_hand2.addOrReplaceChild("LeftArm_r2",
				CubeListBuilder.create().texOffs(28, 21).addBox(0.3F, -0.8F, 1.9F, 1.0F, 2.0F, 1.0F,
						new CubeDeformation(0.2F)),
				PartPose.offsetAndRotation(1.0F, 2.2F, -0.1F, 0.0873F, 0.0F, -1.309F));

		PartDefinition LeftArm_r3 = right_hand2
				.addOrReplaceChild("LeftArm_r3",
						CubeListBuilder.create().texOffs(42, 38).addBox(-0.7F, -0.8F, 0.9F, 2.0F, 1.0F, 1.0F,
								new CubeDeformation(0.2F)),
						PartPose.offsetAndRotation(0.0F, 3.2F, 0.0F, 0.0F, 0.0F, 0.4363F));

		PartDefinition LeftArm_r4 = right_hand2
		...
		PartDefinition LeftArm_r5 = right_hand2
				.addOrReplaceChild("LeftArm_r5",
						CubeListBuilder.create().texOffs(42, 38).addBox(-0.7F, -0.8F, -1.9F, 2.0F, 1.0F, 1.0F,
								new CubeDeformation(0.2F)),
		...
		PartDefinition bone4 = LeftLeg.addOrReplaceChild("bone4",
				CubeListBuilder.create().texOffs(0, 48)
						.addBox(-2.0F, -0.5F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(60, 13)
		...
		PartDefinition bone8 = right_lower_leg.addOrReplaceChild("bone8",
				...
				PartPose.offsetAndRotation(0.0F, 7.0F, 0.7F, 0.0F, 0.2618F, 0.0F));
