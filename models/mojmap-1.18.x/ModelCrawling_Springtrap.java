...
public class ModelCrawling_Springtrap<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "crawling_springtrap"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head", CubeListBuilder.create(),
				PartPose.offsetAndRotation(0.0F, 16.2F, -11.0F, 0.5672F, 0.0F, 0.0F));
		...
		PartDefinition LeftArm = partdefinition.addOrReplaceChild("LeftArm",
				CubeListBuilder.create().texOffs(35, 73)
						.addBox(-2.01F, 0.9F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 47)
						.addBox(-0.35F, 0.5F, -0.5F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(27, 66)
						.addBox(-0.85F, 0.5F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(37, 39)
						.addBox(-1.35F, 1.5F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(14, 38)
		...
		PartDefinition bone6 = bone3.addOrReplaceChild("bone6",
				CubeListBuilder.create().texOffs(9, 45)
						.addBox(-0.5724F, 0.0681F, -1.5F, 1.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(99, 56)
						.addBox(-1.1176F, -0.0319F, -2.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(111, 38)
						.addBox(-1.0724F, 1.5681F, -2.0F, 3.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(99, 38)
						.addBox(-0.5724F, 2.0681F, -2.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(94, 30)
		...
		PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm",
				CubeListBuilder.create().texOffs(35, 73)
						.addBox(-2.01F, 1.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(27, 65)
						.addBox(-1.0F, 0.5F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(37, 39)
						.addBox(-1.5F, 1.5F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 47)
						.addBox(-0.5F, 0.5F, -0.5F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(14, 38)
		...
		PartDefinition bone4 = LeftLeg.addOrReplaceChild("bone4",
				CubeListBuilder.create().texOffs(95, 123)
						...
						.addBox(-0.9F, 1.0F, -1.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 9.5F, 0.5F, 1.0472F, 0.0F, 0.0F));
		...
		PartDefinition bone12 = bone4.addOrReplaceChild("bone12",
				CubeListBuilder.create().texOffs(0, 122)
						.addBox(-1.5F, 0.5915F, -1.2209F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(54, 123)
						.addBox(-2.0F, 2.5915F, -5.2209F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(28, 22)
						.addBox(-1.0F, 0.5915F, 0.2791F, 2.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition LeftArm_r1 = bone12.addOrReplaceChild("LeftArm_r1",
				CubeListBuilder.create().texOffs(44, 115)
						...
						.addBox(7.0F, -1.0F, -4.0F, 0.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(37, 122)
						.addBox(4.5F, 0.0F, -4.0F, 3.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bone13 = right_lower_leg.addOrReplaceChild("bone13",
				CubeListBuilder.create().texOffs(28, 22)
						.addBox(-1.0F, -0.4093F, 0.2791F, 2.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(0, 122)
						.addBox(-1.5F, -0.4083F, -1.2209F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(54, 123)
						.addBox(-2.0F, 1.5917F, -5.2209F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)),
