...
public class ModelSittingWitheredChica<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "sittingwitheredchica"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(50, 59)
						...
						.addBox(5.05F, -13.2F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.2F)).texOffs(50, 39)
		...
		PartDefinition LeftTop2 = LeftEar2.addOrReplaceChild("LeftTop2", CubeListBuilder.create(),
				PartPose.offset(0.0F, -3.0F, 0.0F));

		PartDefinition RightEar2 = Head.addOrReplaceChild("RightEar2", CubeListBuilder.create(),
				PartPose.offsetAndRotation(-2.5F, -7.0F, -1.0F, 0.2182F, 0.0F, -0.3491F));

		PartDefinition RightTop2 = RightEar2.addOrReplaceChild("RightTop2", CubeListBuilder.create(),
				PartPose.offset(0.0F, -3.0F, 0.0F));

		PartDefinition endo_head2 = Head.addOrReplaceChild("endo_head2", CubeListBuilder.create().texOffs(0, 45)
				...
				.addBox(14.7381F, -4.6048F, -3.3143F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition cube_r2 = endoi_jaw2
		...
		PartDefinition LeftArm_r2 = bone3.addOrReplaceChild("LeftArm_r2",
				CubeListBuilder.create().texOffs(22, 62).addBox(12.5F, 2.5F, 0.0F, 3.0F, 11.0F, 0.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition LeftArm_r3 = bone2.addOrReplaceChild("LeftArm_r3",
				CubeListBuilder.create().texOffs(22, 62).addBox(-16.5F, -11.5F, 0.0F, 3.0F, 11.0F, 0.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition LeftLeg = Body.addOrReplaceChild("LeftLeg",
				CubeListBuilder.create().texOffs(28, 43)
						.addBox(-1.9F, 7.0F, -2.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(26, 33)
		...
		PartDefinition LeftArm_r4 = bone9.addOrReplaceChild("LeftArm_r4",
				CubeListBuilder.create().texOffs(22, 0).addBox(-1.5F, 0.2898F, -2.0776F, 3.0F, 0.0F, 2.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition RightLeg = Body.addOrReplaceChild("RightLeg",
				CubeListBuilder.create().texOffs(36, 63)
						.addBox(-1.5019F, 5.0F, -0.9564F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.2F)).texOffs(28, 62)
						.addBox(-1.5F, -1.0F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(38, 39)
						.addBox(-2.5F, -1.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(28, 43)
						.addBox(-2.0F, 5.0F, -2.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition right_lower_leg = RightLeg.addOrReplaceChild("right_lower_leg",
				CubeListBuilder.create().texOffs(24, 47)
						.addBox(-2.0F, 1.0F, -1.6068F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(-1.0F, 0.8F, -0.1068F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(29, 20)
						.addBox(-1.0F, 4.5F, 0.8932F, 2.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bone8 = right_lower_leg.addOrReplaceChild("bone8",
				CubeListBuilder.create().texOffs(36, 58)
						.addBox(-1.5F, -0.199F, -2.7F, 3.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(43, 28)
