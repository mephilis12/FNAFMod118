...
public class ModelPhantom_Freddy<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "phantom_freddy"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(25, 21)
						.addBox(-4.0F, -7.0F, -4.0F, 8.0F, 6.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(13, 85)
		...
		PartDefinition cube_r1 = Head.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(4, 93).addBox(-2.3F, -0.3F, -3.0F, 6.0F, 3.0F, 0.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition RightEar = Head.addOrReplaceChild("RightEar",
				CubeListBuilder.create().texOffs(64, 52)
						.addBox(-1.5F, -4.5F, -0.5F, 3.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg",
				...
				PartPose.offset(3.6F, 9.0F, 1.0F));
		...
		PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg",
				...
				PartPose.offset(-1.5F, 9.0F, 1.0F));
