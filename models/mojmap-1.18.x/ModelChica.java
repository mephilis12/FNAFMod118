...
public class ModelChica<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "chica"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition right_hand = bone2.addOrReplaceChild("right_hand",
				CubeListBuilder.create().texOffs(28, 21)
						...
						.addBox(-0.41F, 0.7F, -1.5F, 1.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(31, 41)
		...
		PartDefinition LeftArm_r2 = right_hand.addOrReplaceChild("LeftArm_r2",
				...
				PartPose.offsetAndRotation(-0.01F, 3.2F, -0.1F, 0.0F, 0.0F, 0.6545F));

		PartDefinition bone5 = right_hand.addOrReplaceChild("bone5", CubeListBuilder.create(),
				PartPose.offsetAndRotation(1.0203F, 1.2294F, -2.7F, 1.2217F, 0.0F, 2.2253F));
		...
		PartDefinition bone9 = bone4.addOrReplaceChild("bone9", CubeListBuilder.create().texOffs(48, 34).addBox(-1.9F,
				-1.0F, -3.2F, 4.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(-0.1F, 7.0F, 0.7F));
