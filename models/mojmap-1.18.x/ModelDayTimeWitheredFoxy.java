...
public class ModelDayTimeWitheredFoxy<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "daytimewitheredfoxy"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition right_hand = bone2.addOrReplaceChild("right_hand",
				CubeListBuilder.create().texOffs(0, 83)
						.addBox(-4.0F, -2.0F, 0.0F, 8.0F, 9.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(76, 33)
		...
		PartDefinition RightLeg_r1 = bone9
				.addOrReplaceChild("RightLeg_r1",
						CubeListBuilder.create().texOffs(-4, 92).addBox(-1.5F, 0.9F, -4.5F, 2.0F, 0.0F, 4.0F,
								new CubeDeformation(0.0F)),
		...
		PartDefinition RightLeg_r2 = bone9.addOrReplaceChild("RightLeg_r2",
				CubeListBuilder.create().texOffs(-4, 102).addBox(-0.3F, 0.9F, -4.5F, 2.0F, 0.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.1F, 0.0F, -2.2F, 0.0F, -0.3927F, 0.0F));

		PartDefinition RightLeg = Body.addOrReplaceChild("RightLeg",
				CubeListBuilder.create().texOffs(44, 49)
						.addBox(-1.0019F, 6.2F, -0.9564F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 17)
						.addBox(-1.0F, 0.2F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 38)
						.addBox(-2.0436F, 0.7F, -2.0019F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition right_lower_leg = RightLeg.addOrReplaceChild("right_lower_leg", CubeListBuilder.create()
				.texOffs(0, 0).addBox(-1.0F, 1.2F, -0.5F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 7.0F, 0.0F));

		PartDefinition bone8 = right_lower_leg.addOrReplaceChild("bone8",
				CubeListBuilder.create().texOffs(-4, 97)
						.addBox(-1.0F, 0.802F, -6.7F, 2.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(60, 13)
						.addBox(-1.5F, 0.211F, -2.7F, 3.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)),
