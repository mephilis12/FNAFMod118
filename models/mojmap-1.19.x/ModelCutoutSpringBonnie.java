...
public class ModelCutoutSpringBonnie<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "cutoutspringbonnie"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r2 = bone.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(0, 40)
						.addBox(-13.5F, -40.0F, 0.25F, 24.0F, 40.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(-13.5F, -40.0F, 0.0F, 24.0F, 40.0F, 0.0F, new CubeDeformation(0.0F)),
