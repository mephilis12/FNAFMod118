...
public class ModelFreddyHead<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "freddyhead"), "main");
	private final ModelPart Head;

	public ModelFreddyHead(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(9, 16)
						...
						.addBox(-3.0F, -10.0F, -3.0F, 6.0F, 1.0F, 6.0F, new CubeDeformation(0.1F)).texOffs(21, 19)
						.addBox(-2.0F, -13.0F, -2.0F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)),
