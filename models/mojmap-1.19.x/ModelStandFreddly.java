...
public class ModelStandFreddly<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "standfreddly"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = Torso.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(0, 15)
						.addBox(-4.0F, -9.0F, -4.0F, 8.0F, 7.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(26, 0)
						.addBox(-4.5F, -5.0F, -4.0F, 9.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 29)
						.addBox(-3.0F, -4.0F, -6.1F, 6.0F, 2.0F, 2.0F, new CubeDeformation(0.15F)).texOffs(0, 3)
		...
		PartDefinition bone2 = Head.addOrReplaceChild("bone2", CubeListBuilder.create(),
				PartPose.offset(-2.0F, -11.3968F, -4.4077F));

		PartDefinition Head_r1 = bone2.addOrReplaceChild("Head_r1",
				CubeListBuilder.create().texOffs(24, 20).addBox(-4.0F, -1.4F, 0.8F, 4.0F, 1.0F, 0.0F,
		...
		PartDefinition Head_r2 = bone.addOrReplaceChild("Head_r2",
				CubeListBuilder.create().texOffs(24, 20).addBox(0.0F, -1.4F, 0.8F, 4.0F, 1.0F, 0.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, 4.9657F, -1.2037F, -0.8727F, 0.0F, 0.0F));

		PartDefinition Jaw2 = Head.addOrReplaceChild("Jaw2",
				CubeListBuilder.create().texOffs(0, 50)
						.addBox(-3.5F, -1.4659F, -5.3412F, 7.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(34, 38)
						.addBox(-2.5F, -2.2159F, -4.3412F, 5.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
