		...
		if (entity instanceof Player && sourceentity instanceof GoldenFreddyEntity) {
			...
			if (world instanceof Level _level) {
				if (!_level.isClientSide()) {
					_level.playSound(null, new BlockPos(x, y, z), ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("fnaf_mod:golden_freddy_scram")), SoundSource.NEUTRAL, 1, 1);
				} else {
