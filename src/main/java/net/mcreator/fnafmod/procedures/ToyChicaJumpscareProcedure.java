...
public class ToyChicaJumpscareProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
		if (entity == null || sourceentity == null)
			return;
		if (entity instanceof Player && (sourceentity instanceof CrawlingToyChicaEntity || sourceentity instanceof NightimeToyChicaEntity)) {
			...
			if (entity instanceof LivingEntity _entity)
				_entity.setHealth(1);
			ToyChicaJumpscareFunctionProcedure.execute(world, x, y, z, entity);
			new Object() {
				private int ticks = 0;
