...
public class WitheredChicaJumpscareProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
		if (entity == null || sourceentity == null)
			return;
		if (entity instanceof Player && sourceentity instanceof WitheredChicaEntity) {
			...
			if (entity instanceof LivingEntity _entity)
				_entity.setHealth(1);
			WitheredChicaJumpscareFunctionProcedure.execute(world, x, y, z, entity);
