...
public class CrawlingToyChicaLayer extends GeoLayerRenderer {
	...
	private static final ResourceLocation MODEL = new ResourceLocation("fnaf_mod", "geo/toychica.geo.json");

	public CrawlingToyChicaLayer(IGeoRenderer<?> entityRendererIn) {
