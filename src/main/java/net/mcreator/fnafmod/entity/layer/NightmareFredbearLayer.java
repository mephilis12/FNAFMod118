...
public class NightmareFredbearLayer extends GeoLayerRenderer {
	...
	private static final ResourceLocation MODEL = new ResourceLocation("fnaf_mod", "geo/nightmare_fredbear.geo.json");

	public NightmareFredbearLayer(IGeoRenderer<?> entityRendererIn) {
