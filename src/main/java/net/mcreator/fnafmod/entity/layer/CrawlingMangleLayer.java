...
public class CrawlingMangleLayer extends GeoLayerRenderer {
	private static final ResourceLocation LAYER = new ResourceLocation("fnaf_mod", "textures/entities/eyemangle.png");
	private static final ResourceLocation MODEL = new ResourceLocation("fnaf_mod", "geo/mangle.geo.json");

	public CrawlingMangleLayer(IGeoRenderer<?> entityRendererIn) {
