...
public class ShadowFreddyLayer extends GeoLayerRenderer {
	...
	private static final ResourceLocation MODEL = new ResourceLocation("fnaf_mod", "geo/witheredfreddy.geo.json");

	public ShadowFreddyLayer(IGeoRenderer<?> entityRendererIn) {
