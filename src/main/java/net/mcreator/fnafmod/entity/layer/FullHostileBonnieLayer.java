...
public class FullHostileBonnieLayer extends GeoLayerRenderer {
	private static final ResourceLocation LAYER = new ResourceLocation("fnaf_mod", "textures/entities/evilbonnieglow.png");
	private static final ResourceLocation MODEL = new ResourceLocation("fnaf_mod", "geo/bonnie.geo.json");

	public FullHostileBonnieLayer(IGeoRenderer<?> entityRendererIn) {
