...
public class NightmarionneLayer extends GeoLayerRenderer {
	private static final ResourceLocation LAYER = new ResourceLocation("fnaf_mod", "textures/entities/nightmarionne_eyeglow.png");
	private static final ResourceLocation MODEL = new ResourceLocation("fnaf_mod", "geo/nightmarionne.geo.json");

	public NightmarionneLayer(IGeoRenderer<?> entityRendererIn) {
