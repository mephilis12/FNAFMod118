...
public class ShadowBonnieLayer extends GeoLayerRenderer {
	private static final ResourceLocation LAYER = new ResourceLocation("fnaf_mod", "textures/entities/shadow_bonnie_glow.png");
	private static final ResourceLocation MODEL = new ResourceLocation("fnaf_mod", "geo/toybonnie.geo.json");

	public ShadowBonnieLayer(IGeoRenderer<?> entityRendererIn) {
