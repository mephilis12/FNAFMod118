...
public class JJEntity extends Monster implements IAnimatable {
	...
	private <E extends IAnimatable> PlayState movementPredicate(AnimationEvent<E> event) {
		if (this.animationprocedure.equals("empty")) {
			...
			event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.balloonboy.altidle", EDefaultLoopTypes.LOOP));
			return PlayState.CONTINUE;
		}
