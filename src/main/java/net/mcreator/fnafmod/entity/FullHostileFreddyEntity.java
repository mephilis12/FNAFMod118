...
public class FullHostileFreddyEntity extends Monster {
	...
	public void awardKillScore(Entity entity, int score, DamageSource damageSource) {
		...
		FreddyFazbearThisEntityKillsAnotherOneProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), entity);
	}
