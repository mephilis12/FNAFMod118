...
public class DayTimeFreddyEntity extends Monster implements IAnimatable {
	...
	public void baseTick() {
		super.baseTick();
		DayTimeFreddyOnEntityTickUpdateProcedure.execute(this.level, this);
	...
	private <E extends IAnimatable> PlayState movementPredicate(AnimationEvent<E> event) {
		if (this.animationprocedure.equals("empty")) {
			event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.freddyfazbear.stage", EDefaultLoopTypes.LOOP));
