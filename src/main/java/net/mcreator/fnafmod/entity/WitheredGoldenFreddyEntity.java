...
public class WitheredGoldenFreddyEntity extends PathfinderMob implements IAnimatable {
	...
	private <E extends IAnimatable> PlayState movementPredicate(AnimationEvent<E> event) {
		if (this.animationprocedure.equals("empty")) {
			event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.witheredfreddy.sit", EDefaultLoopTypes.LOOP));
