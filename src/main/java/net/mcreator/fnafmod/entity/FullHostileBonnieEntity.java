...
public class FullHostileBonnieEntity extends Monster {
	...
	public void awardKillScore(Entity entity, int score, DamageSource damageSource) {
		...
		BonnieBunnyThisEntityKillsAnotherOneProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), entity);
	}
