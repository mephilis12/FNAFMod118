...
public class FullHostileChicaEntity extends Monster {
	...
	public void awardKillScore(Entity entity, int score, DamageSource damageSource) {
		...
		ChicaChickenThisEntityKillsAnotherOneProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), entity);
	}
