...
public class SpringtrapModel extends AnimatedGeoModel<SpringtrapEntity> {
	@Override
	...
	@Override
	public void setCustomAnimations(SpringtrapEntity animatable, int instanceId, AnimationEvent animationEvent) {
