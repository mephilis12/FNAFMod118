...
public class WitheredBonnieModel extends AnimatedGeoModel<WitheredBonnieEntity> {
	@Override
	...
	@Override
	public void setCustomAnimations(WitheredBonnieEntity animatable, int instanceId, AnimationEvent animationEvent) {
