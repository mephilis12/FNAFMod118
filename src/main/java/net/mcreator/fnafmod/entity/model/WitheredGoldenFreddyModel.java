...
public class WitheredGoldenFreddyModel extends AnimatedGeoModel<WitheredGoldenFreddyEntity> {
	@Override
	...
	@Override
	public void setCustomAnimations(WitheredGoldenFreddyEntity animatable, int instanceId, AnimationEvent animationEvent) {
