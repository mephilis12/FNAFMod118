...
public class PhantomChicaModel extends AnimatedGeoModel<PhantomChicaEntity> {
	@Override
	...
	@Override
	public void setCustomAnimations(PhantomChicaEntity animatable, int instanceId, AnimationEvent animationEvent) {
