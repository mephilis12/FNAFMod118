...
public class PassiveFoxyModel extends AnimatedGeoModel<PassiveFoxyEntity> {
	@Override
	...
	@Override
	public void setCustomAnimations(PassiveFoxyEntity animatable, int instanceId, AnimationEvent animationEvent) {
