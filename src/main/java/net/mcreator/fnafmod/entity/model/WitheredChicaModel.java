...
public class WitheredChicaModel extends AnimatedGeoModel<WitheredChicaEntity> {
	@Override
	...
	@Override
	public void setCustomAnimations(WitheredChicaEntity animatable, int instanceId, AnimationEvent animationEvent) {
