...
public class FoxyPirateModel extends AnimatedGeoModel<FoxyPirateEntity> {
	@Override
	...
	@Override
	public void setCustomAnimations(FoxyPirateEntity animatable, int instanceId, AnimationEvent animationEvent) {
