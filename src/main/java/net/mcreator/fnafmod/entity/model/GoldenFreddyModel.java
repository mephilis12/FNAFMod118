...
public class GoldenFreddyModel extends AnimatedGeoModel<GoldenFreddyEntity> {
	@Override
	...
	@Override
	public void setCustomAnimations(GoldenFreddyEntity animatable, int instanceId, AnimationEvent animationEvent) {
