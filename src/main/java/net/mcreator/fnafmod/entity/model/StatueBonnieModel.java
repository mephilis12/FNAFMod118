...
public class StatueBonnieModel extends AnimatedGeoModel<StatueBonnieEntity> {
	@Override
	...
	@Override
	public void setCustomAnimations(StatueBonnieEntity animatable, int instanceId, AnimationEvent animationEvent) {
