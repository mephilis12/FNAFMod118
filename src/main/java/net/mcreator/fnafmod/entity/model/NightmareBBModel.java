...
public class NightmareBBModel extends AnimatedGeoModel<NightmareBBEntity> {
	@Override
	...
	@Override
	public void setCustomAnimations(NightmareBBEntity animatable, int instanceId, AnimationEvent animationEvent) {
