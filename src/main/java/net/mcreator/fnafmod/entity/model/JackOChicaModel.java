...
public class JackOChicaModel extends AnimatedGeoModel<JackOChicaEntity> {
	@Override
	...
	@Override
	public void setCustomAnimations(JackOChicaEntity animatable, int instanceId, AnimationEvent animationEvent) {
