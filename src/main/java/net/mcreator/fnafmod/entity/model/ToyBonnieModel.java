...
public class ToyBonnieModel extends AnimatedGeoModel<ToyBonnieEntity> {
	@Override
	...
	@Override
	public void setCustomAnimations(ToyBonnieEntity animatable, int instanceId, AnimationEvent animationEvent) {
