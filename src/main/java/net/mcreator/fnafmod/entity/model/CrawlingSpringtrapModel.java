...
public class CrawlingSpringtrapModel extends AnimatedGeoModel<CrawlingSpringtrapEntity> {
	@Override
	...
	@Override
	public void setCustomAnimations(CrawlingSpringtrapEntity animatable, int instanceId, AnimationEvent animationEvent) {
