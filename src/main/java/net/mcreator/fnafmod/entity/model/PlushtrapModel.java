...
public class PlushtrapModel extends AnimatedGeoModel<PlushtrapEntity> {
	@Override
	...
	@Override
	public void setCustomAnimations(PlushtrapEntity animatable, int instanceId, AnimationEvent animationEvent) {
