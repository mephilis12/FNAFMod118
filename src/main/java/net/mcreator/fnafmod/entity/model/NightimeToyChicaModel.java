...
public class NightimeToyChicaModel extends AnimatedGeoModel<NightimeToyChicaEntity> {
	@Override
	...
	@Override
	public void setCustomAnimations(NightimeToyChicaEntity animatable, int instanceId, AnimationEvent animationEvent) {
