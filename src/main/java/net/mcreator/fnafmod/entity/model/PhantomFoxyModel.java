...
public class PhantomFoxyModel extends AnimatedGeoModel<PhantomFoxyEntity> {
	@Override
	...
	@Override
	public void setCustomAnimations(PhantomFoxyEntity animatable, int instanceId, AnimationEvent animationEvent) {
