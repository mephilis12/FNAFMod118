...
public class UnwitheredFoxyModel extends AnimatedGeoModel<UnwitheredFoxyEntity> {
	@Override
	...
	@Override
	public void setCustomAnimations(UnwitheredFoxyEntity animatable, int instanceId, AnimationEvent animationEvent) {
