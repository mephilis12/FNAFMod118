...
public class CryingChildModel extends AnimatedGeoModel<CryingChildEntity> {
	@Override
	...
	@Override
	public void setCustomAnimations(CryingChildEntity animatable, int instanceId, AnimationEvent animationEvent) {
