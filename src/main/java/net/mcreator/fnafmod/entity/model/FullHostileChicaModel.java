...
public class FullHostileChicaModel extends AnimatedGeoModel<FullHostileChicaEntity> {
	@Override
	...
	@Override
	public void setCustomAnimations(FullHostileChicaEntity animatable, int instanceId, AnimationEvent animationEvent) {
