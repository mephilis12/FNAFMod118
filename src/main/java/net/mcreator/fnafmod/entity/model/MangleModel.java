...
public class MangleModel extends AnimatedGeoModel<MangleEntity> {
	@Override
	...
	@Override
	public void setCustomAnimations(MangleEntity animatable, int instanceId, AnimationEvent animationEvent) {
