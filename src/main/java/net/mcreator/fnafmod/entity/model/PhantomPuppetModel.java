...
public class PhantomPuppetModel extends AnimatedGeoModel<PhantomPuppetEntity> {
	@Override
	...
	@Override
	public void setCustomAnimations(PhantomPuppetEntity animatable, int instanceId, AnimationEvent animationEvent) {
