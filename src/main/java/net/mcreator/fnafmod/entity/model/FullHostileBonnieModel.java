...
public class FullHostileBonnieModel extends AnimatedGeoModel<FullHostileBonnieEntity> {
	@Override
	...
	@Override
	public void setCustomAnimations(FullHostileBonnieEntity animatable, int instanceId, AnimationEvent animationEvent) {
