...
public class NightmareChicaModel extends AnimatedGeoModel<NightmareChicaEntity> {
	@Override
	...
	@Override
	public void setCustomAnimations(NightmareChicaEntity animatable, int instanceId, AnimationEvent animationEvent) {
