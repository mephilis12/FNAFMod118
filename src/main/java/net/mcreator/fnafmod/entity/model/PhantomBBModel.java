...
public class PhantomBBModel extends AnimatedGeoModel<PhantomBBEntity> {
	@Override
	...
	@Override
	public void setCustomAnimations(PhantomBBEntity animatable, int instanceId, AnimationEvent animationEvent) {
