...
public class StatueFoxyModel extends AnimatedGeoModel<StatueFoxyEntity> {
	@Override
	...
	@Override
	public void setCustomAnimations(StatueFoxyEntity animatable, int instanceId, AnimationEvent animationEvent) {
