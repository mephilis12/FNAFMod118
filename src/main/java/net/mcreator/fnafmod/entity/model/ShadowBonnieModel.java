...
public class ShadowBonnieModel extends AnimatedGeoModel<ShadowBonnieEntity> {
	@Override
	...
	@Override
	public void setCustomAnimations(ShadowBonnieEntity animatable, int instanceId, AnimationEvent animationEvent) {
