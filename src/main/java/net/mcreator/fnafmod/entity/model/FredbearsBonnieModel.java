...
public class FredbearsBonnieModel extends AnimatedGeoModel<FredbearsBonnieEntity> {
	@Override
	...
	@Override
	public void setCustomAnimations(FredbearsBonnieEntity animatable, int instanceId, AnimationEvent animationEvent) {
