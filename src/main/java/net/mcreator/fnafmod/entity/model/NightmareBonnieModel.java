...
public class NightmareBonnieModel extends AnimatedGeoModel<NightmareBonnieEntity> {
	@Override
	...
	@Override
	public void setCustomAnimations(NightmareBonnieEntity animatable, int instanceId, AnimationEvent animationEvent) {
