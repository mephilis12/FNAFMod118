...
public class PhantomFreddyModel extends AnimatedGeoModel<PhantomFreddyEntity> {
	@Override
	...
	@Override
	public void setCustomAnimations(PhantomFreddyEntity animatable, int instanceId, AnimationEvent animationEvent) {
