...
public class PhantomMangleModel extends AnimatedGeoModel<PhantomMangleEntity> {
	@Override
	...
	@Override
	public void setCustomAnimations(PhantomMangleEntity animatable, int instanceId, AnimationEvent animationEvent) {
