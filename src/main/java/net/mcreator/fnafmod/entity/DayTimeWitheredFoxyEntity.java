...
public class DayTimeWitheredFoxyEntity extends Monster {
	...
	public void awardKillScore(Entity entity, int score, DamageSource damageSource) {
		...
		FoxyPirateThisEntityKillsAnotherOneProcedure.execute(this.level, this.getX(), this.getY(), this.getZ(), entity);
	}
