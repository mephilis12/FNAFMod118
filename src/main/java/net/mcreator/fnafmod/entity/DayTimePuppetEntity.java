...
import net.mcreator.fnafmod.procedures.DayTimePuppetRightClickedOnEntityProcedure;
...
public class DayTimePuppetEntity extends PathfinderMob implements IAnimatable {
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		DayTimePuppetRightClickedOnEntityProcedure.execute(world, x, y, z, entity, sourceentity);
		return retval;
	}
	...
	private <E extends IAnimatable> PlayState movementPredicate(AnimationEvent<E> event) {
		if (this.animationprocedure.equals("empty")) {
			event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.puppet.dayidle", EDefaultLoopTypes.LOOP));
