...
public class FnafModModModels {
	...
	public static void registerLayerDefinitions(EntityRenderersEvent.RegisterLayerDefinitions event) {
		...
		event.registerLayerDefinition(ModelNightmare_Balloon_Boy.LAYER_LOCATION, ModelNightmare_Balloon_Boy::createBodyLayer);
		...
		event.registerLayerDefinition(ModelNbbDay.LAYER_LOCATION, ModelNbbDay::createBodyLayer);
		...
		event.registerLayerDefinition(Modelnightmare_mangle.LAYER_LOCATION, Modelnightmare_mangle::createBodyLayer);
