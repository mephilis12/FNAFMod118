...
public class ShadowFreddyRenderer extends MobRenderer<ShadowFreddyEntity, ModelWitheredGoldenFreddy<ShadowFreddyEntity>> {
	public ShadowFreddyRenderer(EntityRendererProvider.Context context) {
