...
public class GoldenFreddyRenderer extends GeoEntityRenderer<GoldenFreddyEntity> {
	...
	@Override
	public RenderType getRenderType(GoldenFreddyEntity animatable, float partialTicks, PoseStack stack, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {
