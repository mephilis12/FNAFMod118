...
public class TameableChicaRenderer extends GeoEntityRenderer<TameableChicaEntity> {
	...
	@Override
	public RenderType getRenderType(TameableChicaEntity entity, float partialTicks, PoseStack stack, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {
