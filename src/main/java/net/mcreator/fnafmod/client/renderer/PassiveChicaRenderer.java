...
public class PassiveChicaRenderer extends GeoEntityRenderer<PassiveChicaEntity> {
	...
	@Override
	public RenderType getRenderType(PassiveChicaEntity entity, float partialTicks, PoseStack stack, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {
