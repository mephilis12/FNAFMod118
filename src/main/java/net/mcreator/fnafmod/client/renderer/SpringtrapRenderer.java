...
public class SpringtrapRenderer extends GeoEntityRenderer<SpringtrapEntity> {
	...
	@Override
	public RenderType getRenderType(SpringtrapEntity entity, float partialTicks, PoseStack stack, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {
