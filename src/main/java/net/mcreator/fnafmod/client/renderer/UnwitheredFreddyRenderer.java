...
public class UnwitheredFreddyRenderer extends GeoEntityRenderer<UnwitheredFreddyEntity> {
	...
	@Override
	public RenderType getRenderType(UnwitheredFreddyEntity entity, float partialTicks, PoseStack stack, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {
