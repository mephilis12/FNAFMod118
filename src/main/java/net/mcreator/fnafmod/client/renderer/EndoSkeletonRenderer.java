...
public class EndoSkeletonRenderer extends GeoEntityRenderer<EndoSkeletonEntity> {
	...
	@Override
	public RenderType getRenderType(EndoSkeletonEntity entity, float partialTicks, PoseStack stack, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {
