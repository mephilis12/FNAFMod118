...
public class WitheredChicaRenderer extends GeoEntityRenderer<WitheredChicaEntity> {
	...
	@Override
	public RenderType getRenderType(WitheredChicaEntity entity, float partialTicks, PoseStack stack, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {
