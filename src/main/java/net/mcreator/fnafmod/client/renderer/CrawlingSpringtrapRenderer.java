...
public class CrawlingSpringtrapRenderer extends GeoEntityRenderer<CrawlingSpringtrapEntity> {
	...
	@Override
	public RenderType getRenderType(CrawlingSpringtrapEntity entity, float partialTicks, PoseStack stack, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {
