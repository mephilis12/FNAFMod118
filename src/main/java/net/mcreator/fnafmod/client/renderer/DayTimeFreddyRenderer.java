...
public class DayTimeFreddyRenderer extends GeoEntityRenderer<DayTimeFreddyEntity> {
	...
	@Override
	public RenderType getRenderType(DayTimeFreddyEntity animatable, float partialTicks, PoseStack stack, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {
