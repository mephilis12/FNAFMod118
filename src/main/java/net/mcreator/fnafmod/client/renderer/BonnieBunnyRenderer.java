...
public class BonnieBunnyRenderer extends GeoEntityRenderer<BonnieBunnyEntity> {
	...
	@Override
	public RenderType getRenderType(BonnieBunnyEntity animatable, float partialTicks, PoseStack stack, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {
