...
public class UnwitheredChicaRenderer extends GeoEntityRenderer<UnwitheredChicaEntity> {
	...
	@Override
	public RenderType getRenderType(UnwitheredChicaEntity animatable, float partialTicks, PoseStack stack, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {
