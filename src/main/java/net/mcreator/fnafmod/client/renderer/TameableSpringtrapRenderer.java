...
public class TameableSpringtrapRenderer extends GeoEntityRenderer<TameableSpringtrapEntity> {
	...
	@Override
	public RenderType getRenderType(TameableSpringtrapEntity entity, float partialTicks, PoseStack stack, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, ResourceLocation textureLocation) {
