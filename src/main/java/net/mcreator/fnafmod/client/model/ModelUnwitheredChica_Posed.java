...
public class ModelUnwitheredChica_Posed<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("fnaf_mod", "model_unwithered_chica_posed"),
			"main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition right_hand = bone2.addOrReplaceChild("right_hand",
				CubeListBuilder.create().texOffs(13, 112).addBox(0.1303F, -1.9531F, -3.9966F, 1.0F, 8.0F, 8.0F, new CubeDeformation(0.0F))
						.texOffs(13, 92).addBox(-0.91F, 0.2F, -2.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(1, 78)
						.addBox(-0.41F, 0.7F, -1.5F, 1.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 17).addBox(-0.41F, 0.7F, -1.5F, 1.0F,
		...
		PartDefinition LeftArm_r1 = right_hand.addOrReplaceChild("LeftArm_r1",
				CubeListBuilder.create().texOffs(4, 96).addBox(-0.7F, -0.7F, 1.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.2F)).texOffs(4, 96)
		...
		PartDefinition LeftArm_r2 = right_hand.addOrReplaceChild("LeftArm_r2",
				CubeListBuilder.create().texOffs(6, 78).addBox(-1.5F, -1.0F, -0.5F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.2F)),
		...
		PartDefinition LeftArm_r3 = right_hand.addOrReplaceChild("LeftArm_r3",
				CubeListBuilder.create().texOffs(4, 96).addBox(-0.7F, -0.7F, -2.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.2F)),
		...
		PartDefinition cupcake = right_hand.addOrReplaceChild("cupcake",
				CubeListBuilder.create().texOffs(76, 112).mirror().addBox(-3.1103F, 2.0597F, -2.9966F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F))
						.mirror(false).texOffs(67, 119).mirror().addBox(-1.6103F, -4.4403F, -1.4966F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
						.mirror(false).texOffs(92, 122).addBox(-1.1103F, -5.4403F, -1.4966F, 0.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
						.texOffs(74, 119).addBox(-3.6103F, -1.4403F, -3.4966F, 5.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(72, 120)
						.addBox(1.1897F, 2.0597F, -2.4966F, 0.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(89, 119)
						.addBox(1.3897F, 0.0597F, -2.9966F, 0.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(90, 114)
						.addBox(1.2897F, -0.9403F, -3.4966F, 0.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(6.1186F, 3.1286F, 1.0F, 0.0F, 0.0F, 1.5708F));
		PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg",
				CubeListBuilder.create().texOffs(28, 43).addBox(-1.4995F, 5.0F, -1.7391F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(26, 33)
		...
		PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg",
				CubeListBuilder.create().texOffs(36, 63).addBox(-1.5019F, 6.0F, -0.9564F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.2F))
						.texOffs(28, 62).addBox(-1.5F, 0.0F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(38, 39)
						.addBox(-2.5F, 0.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(28, 43).addBox(-2.0F, 6.0F, -2.0F, 3.0F,
		...
		PartDefinition right_lower_leg = RightLeg.addOrReplaceChild("right_lower_leg",
				CubeListBuilder.create().texOffs(24, 47).addBox(-2.0F, 0.5678F, -2.6068F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition bone8 = right_lower_leg.addOrReplaceChild("bone8",
				CubeListBuilder.create().texOffs(43, 28).addBox(-2.0F, -1.0F, -3.2F, 4.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(60, 48)
