...
public class ModelToy_Foxy<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition LeftArm = partdefinition.addOrReplaceChild("LeftArm",
				CubeListBuilder.create().texOffs(11, 63).addBox(-0.35F, 0.6F, -0.5F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(41, 55)
						.addBox(-1.35F, 1.6F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(28, 47).addBox(-0.8F, 6.5F, -1.0F, 2.0F,
		...
		PartDefinition bone3 = LeftArm
				.addOrReplaceChild(
						"bone3", CubeListBuilder.create().texOffs(0, 0).addBox(-0.3F, 0.2F, -0.5F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F))
								.texOffs(41, 55).addBox(-1.3F, 0.2F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm",
				CubeListBuilder.create().texOffs(29, 54).addBox(-1.5F, 1.5F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(11, 63)
						.addBox(-0.5F, 0.5F, -0.5F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(28, 47).addBox(-1.0F, 6.5F, -1.0F, 2.0F,
								2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-5.0F, -1.0F, 1.0F, 0.0F, 0.0F, 0.2182F));
		...
		PartDefinition Tail = partdefinition
				.addOrReplaceChild("Tail",
						CubeListBuilder.create().texOffs(0, 83).addBox(-3.0F, -2.5F, -1.0F, 6.0F, 5.0F, 6.0F, new CubeDeformation(0.0F))
								.texOffs(0, 120).addBox(-2.0F, -3.5F, 5.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)),
