	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition endo_head = Head.addOrReplaceChild("endo_head",
				CubeListBuilder.create().texOffs(48, 77).addBox(10.2381F, -1.4048F, 0.2857F, 6.0F, 4.0F, 0.0F, new CubeDeformation(0.0F))
						...
						.addBox(14.7381F, -3.2048F, -4.9143F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(23, 18).addBox(10.7381F, -3.2048F,
								-4.9143F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition LeftArm = partdefinition.addOrReplaceChild("LeftArm",
				CubeListBuilder.create().texOffs(32, 49).addBox(-1.5F, 2.0F, -2.5F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(25, 66)
						.addBox(-0.01F, 1.49F, -0.99F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(44, 49).addBox(-0.46F, 7.39F, -1.49F,
		...
		PartDefinition group = RightArm.addOrReplaceChild("group",
				CubeListBuilder.create().texOffs(60, 109).addBox(-0.4714F, -2.0193F, -1.8273F, 1.0F, 2.0F, 8.0F, new CubeDeformation(0.0F))
						.texOffs(64, 119).addBox(-0.4714F, -2.5193F, 9.1727F, 1.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(50, 117)
		...
		PartDefinition cube_r2 = group.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(59, 105).addBox(-0.5F, 0.5F, -1.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r3 = group.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(50, 117).addBox(-0.5F, -1.5F, -1.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r4 = group.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(50, 107).addBox(0.0F, -3.5F, -1.5F, 0.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(50, 105)
		...
		PartDefinition group2 = group.addOrReplaceChild("group2",
				CubeListBuilder.create().texOffs(50, 105).addBox(2.499F, -16.7357F, -16.3425F, 1.0F, 0.0F, 0.0F, new CubeDeformation(0.0F))
						.texOffs(52, 105).addBox(2.499F, -16.2357F, -18.3425F, 1.0F, 0.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(50, 105)
		...
		PartDefinition bone10 = Body.addOrReplaceChild("bone10",
				CubeListBuilder.create().texOffs(43, 103).addBox(-6.14F, 10.3185F, -2.5F, 1.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.0F, -27.5F, 1.5F, 0.0F, 0.0F, -0.3927F));
		PartDefinition bone11 = Body.addOrReplaceChild("bone11",
				CubeListBuilder.create().texOffs(43, 103).addBox(0.5206F, 12.2319F, -2.5F, 1.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)),
