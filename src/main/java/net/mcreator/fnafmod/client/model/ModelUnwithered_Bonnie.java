...
public class ModelUnwithered_Bonnie<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("fnaf_mod", "model_unwithered_bonnie"), "main");
	...
	public ModelUnwithered_Bonnie(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition right_hand = RightArm.addOrReplaceChild("right_hand",
				...
				PartPose.offsetAndRotation(-0.09F, 13.8F, -1.0F, 0.0F, 0.0F, 0.0F));
		...
		PartDefinition bone7 = LeftArm.addOrReplaceChild("bone7", CubeListBuilder.create().texOffs(29, 66).addBox(-0.5F, 0.2F, -0.5F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(64, 21)
				.addBox(-1.0F, 1.2F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(16, 52).addBox(-1.49F, 0.2F, -2.0F, 3.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 8.3F, 0.0F, 0.0F, 0.0F, 0.0F));
