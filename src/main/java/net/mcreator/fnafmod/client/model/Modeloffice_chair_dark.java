...
public class Modeloffice_chair_dark<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("fnaf_mod", "modeloffice_chair_dark"),
			"main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition group2 = partdefinition.addOrReplaceChild("group2",
				CubeListBuilder.create().texOffs(0, 0).addBox(-7.0F, -2.0F, -7.0F, 14.0F, 3.0F, 12.0F, new CubeDeformation(0.0F)).texOffs(32, 15)
		...
		PartDefinition cube_r1 = group2.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 0).addBox(-2.0F, -4.0F, -2.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.001F, 5.0F, -0.0858F, 0.0F, -0.7854F, 0.0F));
		PartDefinition group3 = group2.addOrReplaceChild("group3",
				CubeListBuilder.create().texOffs(0, 20).addBox(-6.0F, -20.5517F, 2.2814F, 12.0F, 8.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, -0.6934F, 5.5412F));
		PartDefinition cube_r2 = group3.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(24, 39).addBox(-12.0F, -13.0F, 1.0F, 10.0F, 15.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(0, 42)
		...
		PartDefinition cube_r3 = group3.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(4, 42).addBox(0.0F, -14.0F, -1.0F, 0.0F, 15.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r4 = bone.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(0, 8).addBox(-2.0F, 3.0F, 4.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(40, -7)
