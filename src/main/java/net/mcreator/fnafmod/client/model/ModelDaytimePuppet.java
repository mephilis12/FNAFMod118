...
public class ModelDaytimePuppet<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(14, 0).addBox(-3.5F, -3.5F, -3.0F, 7.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 44)
				.addBox(-3.0F, -7.5F, -3.0F, 6.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 0).addBox(-2.5F, -7.0F, -2.0F, 5.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, -16.0F, 0.5F, 0.48F, 0.0F, 0.0F));
		PartDefinition bone = partdefinition.addOrReplaceChild("bone", CubeListBuilder.create(), PartPose.offsetAndRotation(0.5F, 6.7032F, 1.7113F, 0.3054F, 0.0F, 0.0F));
		PartDefinition left_leg = partdefinition.addOrReplaceChild("left_leg", CubeListBuilder.create().texOffs(0, 21).addBox(-1.0F, -0.5F, -1.0F, 2.0F, 11.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.5F, 3.5F, 0.5F, -0.0873F, -0.1745F, 0.0F));
		PartDefinition left_lower_leg = left_leg.addOrReplaceChild("left_lower_leg", CubeListBuilder.create().texOffs(34, 0).addBox(-0.5F, -0.3333F, -0.5F, 1.0F, 10.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition right_leg = partdefinition.addOrReplaceChild("right_leg", CubeListBuilder.create().texOffs(18, 15).addBox(-1.0F, -0.5F, -1.0F, 2.0F, 11.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.5F, 3.5F, 0.5F, -0.0382F, 0.1326F, 0.0382F));
		PartDefinition right_lower_leg = right_leg.addOrReplaceChild("right_lower_leg", CubeListBuilder.create().texOffs(33, 31).addBox(-0.5F, -0.3333F, -0.5F, 1.0F, 10.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition right_lower_arm = right_arm.addOrReplaceChild("right_lower_arm", CubeListBuilder.create().texOffs(34, 11).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition right_hand = right_lower_arm.addOrReplaceChild("right_hand", CubeListBuilder.create(), PartPose.offsetAndRotation(-0.5586F, 5.5F, 1.0556F, 0.0F, -0.7854F, 0.0F));
		...
		PartDefinition cube_r4 = bone2.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(38, 16).addBox(-1.5F, -1.0F, -0.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r5 = bone3.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(38, 8).addBox(-0.5F, -1.0F, -0.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r6 = bone4.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(0, 0).addBox(0.5F, -1.0F, -0.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition left_lower_arm = left_arm.addOrReplaceChild("left_lower_arm", CubeListBuilder.create().texOffs(4, 34).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition right_hand2 = left_lower_arm.addOrReplaceChild("right_hand2", CubeListBuilder.create(), PartPose.offsetAndRotation(0.6056F, 5.3536F, -1.1086F, 0.0F, 2.3562F, 0.0F));
		PartDefinition bone5 = right_hand2.addOrReplaceChild("bone5", CubeListBuilder.create().texOffs(24, 39).addBox(-0.4414F, -0.235F, -0.5325F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.4142F, 3.25F, -1.2F, -0.7418F, 0.0F, 0.0F));
		PartDefinition cube_r8 = bone5.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(38, 16).addBox(-1.5F, -1.0F, -0.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bone6 = right_hand2.addOrReplaceChild("bone6", CubeListBuilder.create().texOffs(38, 12).addBox(-0.4414F, -0.1501F, -0.5358F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.4142F, 3.15F, -1.2F, -0.3054F, 0.0F, 0.0F));
		PartDefinition cube_r9 = bone6.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(38, 8).addBox(-0.5F, -1.0F, -0.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bone7 = right_hand2.addOrReplaceChild("bone7", CubeListBuilder.create().texOffs(0, 11).addBox(-0.4414F, -0.235F, -0.5325F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.5858F, 3.25F, -1.2F, -0.7418F, 0.0F, 0.0F));
		PartDefinition cube_r10 = bone7.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(0, 0).addBox(0.5F, -1.0F, -0.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.9414F, 3.5684F, -0.31F, -0.3054F, 0.0F, 0.0F));
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(25, 31).addBox(-0.5F, -26.0F, -0.5F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 11).addBox(-2.0F, -36.0F, -1.7F, 5.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(13, 29)
						.addBox(-1.0F, -30.0F, -1.0F, 3.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(23, 26).addBox(-1.5F, -23.0F, -1.0F, 4.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(34, 21)
						.addBox(-0.5F, -40.0F, -0.5F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(40, 52).addBox(-2.5F, -24.0F, -10.5F, 6.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(40, 52)
