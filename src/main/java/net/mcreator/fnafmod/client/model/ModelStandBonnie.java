...
public class ModelStandBonnie<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("fnaf_mod", "model_stand_bonnie"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = Torso.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(0, 15).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 7.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(26, 0).addBox(-5.0F, -4.0F, -4.0F, 10.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 29)
						.addBox(-3.0F, -3.0F, -6.1F, 6.0F, 2.0F, 2.0F, new CubeDeformation(0.15F)).texOffs(0, 3).addBox(-1.0F, -3.5F, -6.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Jaw = Head.addOrReplaceChild("Jaw", CubeListBuilder.create().texOffs(23, 15).addBox(-4.5F, -0.25F, -2.6F, 9.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(25, 33)
				.addBox(-3.5F, -0.25F, -5.6F, 7.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(34, 38).addBox(-2.5F, -1.25F, -4.6F, 5.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Bulb = endo_torso2.addOrReplaceChild("Bulb",
				CubeListBuilder.create().texOffs(0, 53).addBox(-1.0F, -1.875F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(9, 50).addBox(-1.5F, -4.625F, -1.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
