...
public class ModelNightmare_Foxy<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone3 = LeftArm2.addOrReplaceChild("bone3", CubeListBuilder.create().texOffs(0, 47).addBox(-0.3F, 0.2F, -0.5F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(75, 11)
				.addBox(-0.8F, 1.2F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 70).addBox(-1.3F, 0.7F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 8.3F, 0.0F, -0.6545F, 0.0F, 0.0F));
		...
		PartDefinition bone2 = RightArm2.addOrReplaceChild("bone2", CubeListBuilder.create().texOffs(0, 12).addBox(-0.5F, 0.2F, -0.5F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 21)
				.addBox(-1.0F, 1.2F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(40, 71).addBox(-1.5F, 0.7F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 8.3F, 0.0F, -0.7974F, -0.1536F, 0.1555F));
		PartDefinition right_hand = bone2.addOrReplaceChild("right_hand", CubeListBuilder.create(), PartPose.offsetAndRotation(-0.09F, 5.5F, 0.0F, 0.0F, -0.3491F, 0.0F));
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(65, 53).addBox(-8.05F, -11.8571F, -0.0143F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(22, 65).addBox(6.05F, -11.8571F, -0.0143F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(48, 25)
						.addBox(-4.5F, -2.7571F, -2.0143F, 9.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(1, 22).addBox(-4.5F, -8.7571F, -3.0143F, 9.0F, 6.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(1, 1)
