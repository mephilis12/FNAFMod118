...
public class ModelVent_Toy_Bonnie<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition right_hand = bone2.addOrReplaceChild("right_hand",
				CubeListBuilder.create().texOffs(62, 46).addBox(-0.91F, 0.7F, -1.5F, 2.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(57, 25)
						.addBox(-0.91F, 2.7F, -1.5F, 3.0F, 2.0F, 3.0F, new CubeDeformation(0.01F)).texOffs(50, 54).addBox(1.09F, 1.7F, -0.5F, 2.0F,
		...
		PartDefinition right_hand2 = bone3.addOrReplaceChild("right_hand2",
				CubeListBuilder.create().texOffs(10, 62).addBox(-0.89F, -0.3F, -1.5F, 2.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(38, 53)
						.addBox(1.11F, 0.7F, -0.5F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(53, 44).addBox(-0.89F, 1.7F, -1.5F, 3.0F,
		...
		PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg",
				CubeListBuilder.create().texOffs(44, 30).addBox(-1.0019F, 6.0F, -1.0436F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 37)
						.addBox(-2.6F, -0.5F, -2.5F, 5.0F, 7.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(0, 12).addBox(-1.0F, 0.0F, -1.0F, 2.0F,
		...
		PartDefinition bone4 = LeftLeg.addOrReplaceChild("bone4",
				CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, 1.001F, -0.5F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 49)
		...
		PartDefinition bone7 = bone4.addOrReplaceChild("bone7",
				CubeListBuilder.create().texOffs(15, 37).addBox(-3.4F, 1.25F, -1.75F, 3.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(15, 44)
						.addBox(-4.5F, -0.75F, -2.25F, 5.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(28, 0).addBox(-4.5F, 0.25F, -6.25F, 5.0F,
		...
		PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg",
				CubeListBuilder.create().texOffs(44, 30).addBox(-1.0019F, 6.0F, -0.9564F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(29, 32)
						.addBox(-2.5F, -0.5F, -2.5F, 5.0F, 7.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(0, 12).addBox(-1.0F, 0.0F, -1.0F, 2.0F,
								6.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition right_lower_leg = RightLeg.addOrReplaceChild("right_lower_leg",
				CubeListBuilder.create().texOffs(49, 30).addBox(-2.0F, -0.5F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						...
						.addBox(-2.5F, 5.901F, -6.5F, 5.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(15, 37).addBox(-1.5F, 6.901F, -2.0F, 3.0F,
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(53, 54).addBox(-6.5F, -13.5F, -1.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(53, 54)
		...
		PartDefinition bone11 = endo_torso.addOrReplaceChild("bone11",
				CubeListBuilder.create().texOffs(30, 6).addBox(-4.5F, -1.5F, -5.25F, 9.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(41, 54)
