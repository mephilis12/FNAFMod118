...
public class ModelDaytimeSpringtrap<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("fnaf_mod", "model_daytime_springtrap"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(14, 38).addBox(-8.05F, -13.6F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(14, 38).addBox(6.05F, -13.6F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(70, 52)
						.addBox(-4.0F, -6.5F, -2.5F, 8.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(53, 52).addBox(-0.5F, -13.0F, -4.1F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(57, 0)
		...
		PartDefinition cube_r1 = Body.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(57, 18).addBox(-4.5F, -1.5F, -3.0F, 9.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -3.0F, 0.0F, 0.0873F, 0.0F, 0.0F));
		...
		PartDefinition Head = Body.addOrReplaceChild("Head", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -16.8F, 0.0F, 0.2587F, -0.0283F, 0.2164F));
		...
		PartDefinition cube_r2 = endo_head.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(22, 35).addBox(-3.5F, -0.9F, -3.5F, 5.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r3 = upperhead.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(23, 0).addBox(-3.5F, -0.8F, -3.4F, 7.0F, 1.0F, 6.0F, new CubeDeformation(0.01F)),
		...
		PartDefinition LeftArm = Body.addOrReplaceChild("LeftArm",
				CubeListBuilder.create().texOffs(35, 73).addBox(-2.01F, 1.9F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 47).addBox(-0.35F, 1.5F, -0.5F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(27, 66)
						.addBox(-0.85F, 1.5F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(37, 39).addBox(-1.35F, 2.5F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(14, 38)
		...
		PartDefinition bone3 = LeftArm.addOrReplaceChild("bone3", CubeListBuilder.create().texOffs(0, 0).addBox(-0.3F, 0.2F, -0.5F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(46, 23)
				.addBox(-0.8F, 1.2F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(37, 47).addBox(-1.5F, 0.6F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 8.2F, 0.0F, -0.6981F, 0.0F, 0.0F));
		...
		PartDefinition bone6 = bone3.addOrReplaceChild("bone6",
				CubeListBuilder.create().texOffs(9, 45).addBox(-1.0909F, 0.1F, -1.6F, 1.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(99, 56).addBox(-1.6362F, 0.0F, -2.1F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(111, 38)
						.addBox(-1.5909F, 1.6F, -2.1F, 3.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(99, 38).addBox(-1.0909F, 2.1F, -2.1F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(94, 30)
		...
		PartDefinition RightArm = Body.addOrReplaceChild("RightArm",
				CubeListBuilder.create().texOffs(35, 73).addBox(-2.01F, 2.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(27, 65).addBox(-1.0F, 1.5F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(37, 39)
						.addBox(-1.5F, 2.5F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 47).addBox(-0.5F, 1.5F, -0.5F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(14, 38)
		...
		PartDefinition bone2 = RightArm.addOrReplaceChild("bone2", CubeListBuilder.create().texOffs(0, 0).addBox(-0.5F, 0.2F, -0.5F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(46, 23)
				.addBox(-1.0F, 1.2F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(37, 55).addBox(-1.5F, 0.6F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 8.3F, 0.0F, -0.3054F, 0.0F, 0.0F));
		...
		PartDefinition bone4 = LeftLeg.addOrReplaceChild("bone4",
				CubeListBuilder.create().texOffs(95, 123).addBox(-1.9F, -1.5F, -2.5F, 4.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(4, 47).addBox(-0.4F, 0.0F, -0.5F, 1.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(28, 111)
						.addBox(-0.9F, 1.0F, -1.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(28, 22).addBox(-0.9F, 7.001F, 0.0F, 2.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bone12 = bone4.addOrReplaceChild("bone12",
				CubeListBuilder.create().texOffs(0, 122).addBox(-1.5F, 0.001F, -1.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(54, 123).addBox(-2.0F, 2.001F, -5.5F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition right_lower_leg = RightLeg.addOrReplaceChild("right_lower_leg",
				CubeListBuilder.create().texOffs(98, 9).addBox(-2.0F, 0.5F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(83, 123).addBox(-2.0F, -1.5F, -2.5F, 4.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(4, 47)
						.addBox(-0.5F, 0.0F, -0.5F, 1.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(28, 111).addBox(-1.0F, 1.0F, -1.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(28, 22)
		...
		PartDefinition bone13 = right_lower_leg.addOrReplaceChild("bone13",
				CubeListBuilder.create().texOffs(0, 122).addBox(-2.0F, 0.001F, -1.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(54, 123).addBox(-2.5F, 2.001F, -5.5F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.5F, 7.0F, 0.0F, 1.0472F, 0.0F, 0.0F));
		PartDefinition LeftArm_r3 = bone13.addOrReplaceChild("LeftArm_r3",
				CubeListBuilder.create().texOffs(44, 115).addBox(-1.5F, -1.0F, -4.0F, 0.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(44, 115).addBox(-0.5F, -1.0F, -4.0F, 0.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(44, 115)
						.addBox(0.5F, -1.0F, -4.0F, 0.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(37, 122).addBox(-2.0F, 0.0F, -4.0F, 3.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)),
