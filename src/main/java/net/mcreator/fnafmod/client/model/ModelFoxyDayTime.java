...
public class ModelFoxyDayTime<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(20, 7).addBox(-4.0F, -13.6F, -3.5F, 8.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(0, 13)
						...
						.addBox(-6.99F, -13.51F, -0.99F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(56, 26).addBox(4.99F, -13.51F, -0.99F,
		...
		PartDefinition LeftArm_r1 = Body.addOrReplaceChild("LeftArm_r1",
				CubeListBuilder.create().texOffs(42, 0).addBox(-0.5F, -1.5F, -2.0F, 3.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(42, 25)
		...
		PartDefinition Body_r1 = Body.addOrReplaceChild("Body_r1",
				CubeListBuilder.create().texOffs(36, 4).addBox(0.0F, -1.5F, 0.0F, 2.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.0F, -13.6F, -0.5F, 0.0F, 0.0F, -0.3927F));
		PartDefinition Body_r2 = Body.addOrReplaceChild("Body_r2",
				CubeListBuilder.create().texOffs(0, 37).addBox(-2.0F, -1.5F, 0.0F, 2.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.0F, -13.6F, -0.5F, 0.0F, 0.0F, 0.3927F));
		PartDefinition Head = Body.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(0, 0).addBox(-3.5F, -8.0F, -3.0F, 7.0F, 7.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(0, 12)
						...
						.addBox(-1.5F, -1.0F, -7.5F, 3.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(55, 50).addBox(-1.0F, -4.0F, -8.4F, 2.0F,
		...
		PartDefinition Head_r1 = bone5.addOrReplaceChild("Head_r1",
				CubeListBuilder.create().texOffs(20, 16).addBox(-3.5F, -2.1F, 0.1F, 7.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.8727F, 0.0F, 0.0F));
		PartDefinition Jaw = Head.addOrReplaceChild("Jaw",
				CubeListBuilder.create().texOffs(48, 32).addBox(-2.0F, 0.502F, -7.6374F, 4.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(38, 41)
		...
		PartDefinition cube_r1 = Jaw.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(38, 36).addBox(-2.0F, -1.25F, -3.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(26, 28)
		...
		PartDefinition cube_r2 = Jaw.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(14, 46).addBox(-2.5F, -2.75F, 2.0F, 5.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -0.7255F, -2.4457F, -0.3927F, 0.0F, 0.0F));
		PartDefinition RightEar = Head.addOrReplaceChild("RightEar",
				CubeListBuilder.create().texOffs(34, 36).addBox(-1.6144F, -4.8199F, -4.8F, 3.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(20, 4)
		...
		PartDefinition RightEar2 = Head.addOrReplaceChild("RightEar2",
				CubeListBuilder.create().texOffs(34, 36).addBox(-1.3856F, -4.8199F, -4.3F, 3.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(20, 4)
		...
		PartDefinition endo_head = Head.addOrReplaceChild("endo_head",
				CubeListBuilder.create().texOffs(52, 22).addBox(10.2381F, -1.4048F, 0.7857F, 6.0F, 4.0F, 0.0F, new CubeDeformation(0.0F))
						.texOffs(50, 46).addBox(9.7381F, -5.4048F, 0.7857F, 7.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(50, 17)
						...
						.addBox(14.3381F, -3.0048F, -1.4143F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(20, 0).addBox(11.1381F, -3.2048F,
								-1.4143F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r3 = endoi_jaw.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(28, 54).addBox(-1.0F, -0.75F, -1.8F, 2.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(50, 12)
		...
		PartDefinition LeftArm = Body.addOrReplaceChild("LeftArm",
				CubeListBuilder.create().texOffs(28, 46).addBox(-1.5F, 2.0F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(8, 56)
						.addBox(-0.5F, 1.5F, -0.5F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(56, 26).addBox(-0.9F, 6.5F, -1.0F, 2.0F,
		...
		PartDefinition bone3 = LeftArm.addOrReplaceChild("bone3",
				CubeListBuilder.create().texOffs(28, 63).addBox(-1.49F, 0.2F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(44, 57)
		...
		PartDefinition right_hand2 = bone3.addOrReplaceChild("right_hand2",
				CubeListBuilder.create().texOffs(0, 56).addBox(-0.21F, 0.7F, -1.5F, 1.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(20, 17)
						.addBox(0.11F, 0.7F, 0.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(12, 37).addBox(-0.31F, 2.2F, -1.5F, 2.0F,
		...
		PartDefinition RightArm = Body.addOrReplaceChild("RightArm",
				CubeListBuilder.create().texOffs(28, 46).addBox(-1.5F, 2.0F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(8, 56)
						.addBox(-0.5F, 1.5F, -0.5F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(56, 26).addBox(-1.0F, 6.5F, -1.0F, 2.0F,
								2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-6.0F, -13.0F, 0.0F, -0.9299F, 0.4245F, 0.23F));
		PartDefinition bone2 = RightArm.addOrReplaceChild("bone2",
				CubeListBuilder.create().texOffs(44, 57).addBox(-0.5F, -2.75F, -0.5F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(28, 63)
		...
		PartDefinition right_hand = bone2.addOrReplaceChild("right_hand",
				CubeListBuilder.create().texOffs(34, 16).addBox(-4.0F, 0.1708F, 0.0F, 8.0F, 9.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(51, 40)
		...
		PartDefinition LeftLeg = Body.addOrReplaceChild("LeftLeg",
				CubeListBuilder.create().texOffs(0, 37).addBox(-1.5564F, -0.5F, -2.5019F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(56, 26)
						.addBox(-0.6F, 6.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(20, 52).addBox(-0.6F, 0.0F, -1.0F, 2.0F,
		...
		PartDefinition bone4 = LeftLeg.addOrReplaceChild("bone4",
				CubeListBuilder.create().texOffs(12, 52).addBox(0.4F, 1.001F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bone6 = bone4.addOrReplaceChild("bone6",
				CubeListBuilder.create().texOffs(26, 4).addBox(-1.3205F, -0.001F, -2.4245F, 4.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
						.texOffs(0, 47).addBox(-0.8205F, -0.001F, -0.4245F, 3.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.7205F, 6.902F, -1.5755F, -0.0436F, 0.0F, 0.0F));
		PartDefinition RightLeg_r1 = bone6.addOrReplaceChild("RightLeg_r1",
				CubeListBuilder.create().texOffs(0, 15).addBox(-0.3F, 0.948F, -4.5F, 2.0F, 0.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition RightLeg_r2 = bone6.addOrReplaceChild("RightLeg_r2",
				CubeListBuilder.create().texOffs(0, 13).addBox(-1.5F, 0.948F, -4.5F, 2.0F, 0.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.1743F, 0.0F, 0.0765F, 0.0F, 0.3927F, 0.0F));
		PartDefinition RightLeg = Body.addOrReplaceChild("RightLeg",
				CubeListBuilder.create().texOffs(56, 26).addBox(-1.0F, 6.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(20, 52)
		...
		PartDefinition right_lower_leg = RightLeg.addOrReplaceChild("right_lower_leg",
				CubeListBuilder.create().texOffs(12, 52).addBox(-1.0F, 1.0F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bone12 = right_lower_leg.addOrReplaceChild("bone12",
				CubeListBuilder.create().texOffs(0, 47).addBox(-1.5F, -0.099F, -1.9794F, 3.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(26, 4)
		...
		PartDefinition endo_torso = Body.addOrReplaceChild("endo_torso",
				CubeListBuilder.create().texOffs(52, 0).addBox(1.5F, -19.0F, -2.5F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(49, 51)
		...
		PartDefinition bone11 = Body.addOrReplaceChild("bone11",
				CubeListBuilder.create().texOffs(4, 0).addBox(0.9952F, 10.1022F, -1.5F, 1.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.0F, -27.5F, 1.5F, 0.0F, 0.0F, 0.3927F));
		PartDefinition bone10 = Body.addOrReplaceChild("bone10",
				CubeListBuilder.create().texOffs(4, 0).addBox(-4.7668F, 8.9542F, -1.5F, 1.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.0F, -27.5F, 1.5F, 0.0F, 0.0F, -0.3927F));
		PartDefinition bone7 = Body.addOrReplaceChild("bone7",
				CubeListBuilder.create().texOffs(20, 28).addBox(1.2125F, -0.2017F, -1.5F, 6.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)),
