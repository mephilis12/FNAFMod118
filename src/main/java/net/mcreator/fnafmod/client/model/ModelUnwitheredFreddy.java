...
public class ModelUnwitheredFreddy<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("fnaf_mod", "model_unwithered_freddy"),
			"main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition RightLeg_r4 = bone9.addOrReplaceChild("RightLeg_r4",
		...
		PartDefinition LeftArm_r6 = right_hand2.addOrReplaceChild("LeftArm_r6",
