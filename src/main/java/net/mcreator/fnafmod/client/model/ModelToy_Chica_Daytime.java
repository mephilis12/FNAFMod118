...
public class ModelToy_Chica_Daytime<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("fnaf_mod", "model_toy_chica_daytime"),
			"main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition right_hand2 = bone3.addOrReplaceChild("right_hand2",
				CubeListBuilder.create().texOffs(42, 67).addBox(-0.89F, -0.3F, -1.5F, 2.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(76, 114)
		...
		PartDefinition LeftArm_r1 = right_hand2.addOrReplaceChild("LeftArm_r1",
				CubeListBuilder.create().texOffs(28, 68).addBox(0.5F, -2.0F, -1.5F, 3.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition LeftArm_r2 = right_hand2.addOrReplaceChild("LeftArm_r2",
				CubeListBuilder.create().texOffs(34, 61).addBox(0.58F, -1.0F, 1.5F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bone11 = right_hand2.addOrReplaceChild("bone11",
				CubeListBuilder.create().texOffs(96, 121).mirror().addBox(-2.0F, 2.0714F, -0.9857F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F))
						.mirror(false).texOffs(110, 100).mirror().addBox(-0.5F, -4.4286F, 0.5143F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
						.mirror(false).texOffs(110, 105).addBox(-0.5F, -5.4286F, 1.0143F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F))
						.texOffs(96, 111).addBox(-2.5F, -1.4286F, -1.4857F, 5.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(101, 120)
						.addBox(-1.5F, 2.0714F, -1.2357F, 3.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(118, 123)
						.addBox(-2.0F, 0.0714F, -1.4357F, 4.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(118, 119)
						.addBox(-2.5F, -0.9286F, -1.3857F, 5.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)),
