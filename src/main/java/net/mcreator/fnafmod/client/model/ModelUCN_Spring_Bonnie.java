...
public class ModelUCN_Spring_Bonnie<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("fnaf_mod", "model_ucn_spring_bonnie"),
			"main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(83, 52).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 7.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(0, 94)
						.addBox(-3.0F, -3.0F, -6.1F, 6.0F, 2.0F, 2.0F, new CubeDeformation(0.15F)).texOffs(52, 41)
						.addBox(-1.0F, -3.5F, -6.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(87, 18)
						.addBox(-4.5F, -3.0F, -4.0F, 9.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bone3 = LeftArm.addOrReplaceChild(
				"bone3", CubeListBuilder.create().texOffs(44, 56).addBox(-1.0F, 0.2F, -2.5F, 3.0F, 5.0F, 4.0F, new CubeDeformation(0.0F))
						.texOffs(29, 66).addBox(0.04F, 0.09F, -0.99F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bone2 = RightArm
				.addOrReplaceChild("bone2",
						CubeListBuilder.create().texOffs(29, 66).addBox(-0.5F, 0.2F, -0.5F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F))
								.texOffs(44, 56).addBox(-1.5F, 0.2F, -2.0F, 3.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)),
						PartPose.offset(0.0F, 8.3F, 0.0F));
