...
public class ModelNightmare_Fredbear<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("fnaf_mod", "model_nightmare_fredbear"),
			"main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head2 = Head.addOrReplaceChild("Head2",
				CubeListBuilder.create().texOffs(37, 0).addBox(-4.5F, -2.2F, -5.0F, 9.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(84, 11)
						...
						.addBox(-1.5F, -13.2F, -2.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(33, 32).addBox(-5.0F, -5.2F, -5.0F, 10.0F,
								3.0F, 9.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0873F, 0.0F, 0.0F));
		PartDefinition Jaw = Head2.addOrReplaceChild("Jaw",
				CubeListBuilder.create().texOffs(32, 16).addBox(-5.5F, -0.85F, -4.1652F, 11.0F, 3.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(72, 46)
						...
						.addBox(-2.5F, -3.1687F, -3.2497F, 5.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(74, 60).addBox(-3.5F, -0.2068F, -0.5F,
								7.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 1.5068F, 1.0F, 0.1745F, 0.0F, 0.0F));
		PartDefinition LeftEar = Head2.addOrReplaceChild("LeftEar",
				CubeListBuilder.create().texOffs(15, 68).addBox(-1.5F, -3.2F, -1.0F, 3.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(28, 79)
						.addBox(-1.0F, -3.2F, 0.0F, 2.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(62, 34).addBox(-1.0F, 0.8F, -1.0F, 2.0F,
		...
		PartDefinition RightEar = Head2.addOrReplaceChild("RightEar",
				CubeListBuilder.create().texOffs(60, 65).addBox(-1.5F, -3.2F, -1.0F, 3.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(61, 14)
						.addBox(-1.0F, -3.2F, 0.0F, 2.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(62, 31).addBox(-1.0F, 0.8F, -1.0F, 2.0F,
								2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.5F, -9.0F, -1.0F, 0.0F, 0.0F, -0.7854F));
		...
		PartDefinition endo_head = Head2.addOrReplaceChild("endo_head",
				CubeListBuilder.create().texOffs(12, 89).addBox(-4.2619F, -5.3048F, -3.7143F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
						.texOffs(42, 54).addBox(-8.2619F, -5.3048F, -3.7143F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						...
						.addBox(-3.7619F, -4.6048F, -3.2143F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(61, 2).addBox(-7.7619F, -1.4048F,
								-2.7143F, 6.0F, 5.0F, 6.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition LeftArm2 = LeftArm.addOrReplaceChild("LeftArm2",
				CubeListBuilder.create().texOffs(20, 68).addBox(-2.51F, 0.5F, -2.5F, 5.0F, 6.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(81, 93)
						.addBox(-0.35F, 1.6F, -0.5F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(24, 41)
						.addBox(-1.35F, 2.6F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(68, 77).addBox(-0.8F, 7.5F, -1.0F, 2.0F,
		...
		PartDefinition bone3 = LeftArm2.addOrReplaceChild("bone3",
				CubeListBuilder.create().texOffs(85, 93).addBox(-0.3F, 0.2F, -0.5F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(24, 89)
						.addBox(-0.8F, 1.2F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(73, 77).addBox(-2.01F, -0.3F, -2.0F, 4.0F,
		...
		PartDefinition bone6 = bone3.addOrReplaceChild("bone6",
				CubeListBuilder.create().texOffs(67, 57).addBox(-0.5F, 0.6F, -1.625F, 1.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(77, 87)
						.addBox(-1.0F, 0.5F, -2.125F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(71, 37)
						.addBox(0.5F, 1.1F, 0.375F, 2.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(35, 68).addBox(1.0F, 1.1F, -0.125F, 2.0F,
								2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition LeftArm_r1 = bone6.addOrReplaceChild("LeftArm_r1",
				CubeListBuilder.create().texOffs(48, 60).addBox(-0.9226F, -2.5F, 2.0F, 3.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(45, 8)
		...
		PartDefinition LeftArm_r2 = bone6.addOrReplaceChild("LeftArm_r2",
				CubeListBuilder.create().texOffs(85, 83).addBox(0.5774F, -1.5F, -1.5F, 3.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition RightArm2 = RightArm.addOrReplaceChild("RightArm2",
				CubeListBuilder.create().texOffs(69, 26).addBox(-2.51F, 0.5F, -2.5F, 5.0F, 6.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(65, 87)
						.addBox(-1.5F, 2.5F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(77, 93)
						.addBox(-0.5F, 1.5F, -0.5F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(89, 79).addBox(-1.0F, 7.5F, -1.0F, 2.0F,
								2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0154F, -0.1739F, 0.435F));
		PartDefinition bone2 = RightArm2.addOrReplaceChild("bone2",
				CubeListBuilder.create().texOffs(32, 16).addBox(-0.5F, 0.2F, -0.5F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 41)
						.addBox(-1.0F, 1.2F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(16, 79).addBox(-2.01F, -0.3F, -2.0F, 4.0F,
								6.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition right_hand = bone2.addOrReplaceChild("right_hand",
				CubeListBuilder.create().texOffs(88, 47).addBox(-0.9F, 0.5F, -2.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(71, 37)
						.addBox(0.6F, 1.2F, -1.0F, 2.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(48, 76)
						.addBox(-0.4F, 0.7F, -1.5F, 1.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(41, 68).addBox(1.1F, 1.2F, -1.5F, 2.0F, 2.0F,
		...
		PartDefinition LeftArm_r3 = right_hand.addOrReplaceChild("LeftArm_r3",
				CubeListBuilder.create().texOffs(85, 73).addBox(-0.5F, -1.0F, -2.0F, 3.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition LeftArm_r4 = right_hand.addOrReplaceChild("LeftArm_r4",
				CubeListBuilder.create().texOffs(48, 60).addBox(-0.5F, -2.5F, -1.5F, 3.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(45, 8)
						.addBox(-0.5F, -2.5F, -0.5F, 3.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(48, 60)
						.addBox(-0.5F, -2.5F, 0.5F, 3.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(45, 8).addBox(-0.5F, -2.5F, 1.5F, 3.0F, 3.0F,
		...
		PartDefinition LeftLeg2 = LeftLeg.addOrReplaceChild("LeftLeg2",
				CubeListBuilder.create().texOffs(24, 54).addBox(-2.9913F, 1.0F, -4.1004F, 6.0F, 8.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(30, 94)
		...
		PartDefinition bone4 = LeftLeg2.addOrReplaceChild("bone4",
				CubeListBuilder.create().texOffs(66, 65).addBox(-2.5F, -1.0F, -2.5F, 5.0F, 7.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(89, 89)
						.addBox(-0.5F, 0.0F, 0.0F, 1.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 30).addBox(-1.0F, 1.0F, -0.5F, 2.0F, 5.0F,
		...
		PartDefinition bone8 = bone4.addOrReplaceChild("bone8",
				CubeListBuilder.create().texOffs(74, 51).addBox(-1.9F, 0.001F, -2.5F, 4.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(53, 47)
						.addBox(-2.9F, 2.001F, -7.5F, 6.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(84, 24)
						.addBox(-1.9F, 3.001F, -5.5F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(44, 88).addBox(-1.4F, 1.001F, -1.5F, 3.0F,
		...
		PartDefinition LeftArm_r5 = bone8.addOrReplaceChild("LeftArm_r5",
				CubeListBuilder.create().texOffs(0, 80).addBox(-3.5F, 0.0F, -4.0F, 3.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition RightLeg2 = RightLeg.addOrReplaceChild("RightLeg2",
				CubeListBuilder.create().texOffs(93, 93).addBox(-1.0087F, 9.0F, -0.6004F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition right_lower_leg = RightLeg2.addOrReplaceChild("right_lower_leg",
				CubeListBuilder.create().texOffs(0, 68).addBox(-2.5F, -1.0F, -2.5F, 5.0F, 7.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(92, 53)
						.addBox(-0.5F, 0.0F, 0.0F, 1.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(34, 30).addBox(-1.0F, 1.0F, -0.5F, 2.0F, 5.0F,
								2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bone7 = right_lower_leg.addOrReplaceChild("bone7",
				CubeListBuilder.create().texOffs(35, 76).addBox(-2.0F, 0.0F, -2.5F, 4.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(48, 56)
						.addBox(-3.0F, 2.0F, -7.5F, 6.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(85, 5)
						.addBox(-2.0F, 3.001F, -5.5F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(89, 29).addBox(-1.5F, 1.001F, -1.5F, 3.0F,
								3.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition LeftArm_r6 = bone7.addOrReplaceChild("LeftArm_r6",
				CubeListBuilder.create().texOffs(48, 8).addBox(-2.0F, 0.0F, -4.0F, 3.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.5F, 2.1352F, -1.5948F, 0.2182F, 0.0F, 0.0F));
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(93, 89).addBox(-8.05F, -13.6F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(91, 41)
						...
						.addBox(-5.5F, -8.5F, -6.5F, 11.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(0, 16).addBox(-5.5F, -14.5F, -6.0F, 11.0F,
								4.0F, 10.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 7.0F, 5.0F, 0.1745F, 0.0F, 0.0F));
		PartDefinition Body_r1 = Body.addOrReplaceChild("Body_r1",
				CubeListBuilder.create().texOffs(86, 37).addBox(-4.0F, -2.0F, 0.0F, 8.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -12.0F, -6.7F, -0.3054F, 0.0F, 0.0F));
		PartDefinition endo_torso = Body.addOrReplaceChild("endo_torso",
				CubeListBuilder.create().texOffs(62, 37).addBox(1.5F, -21.0F, -2.5F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(56, 88)
