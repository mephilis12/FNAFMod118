	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone2 = RightArm
				.addOrReplaceChild("bone2",
						CubeListBuilder.create().texOffs(0, 25).addBox(-0.5F, 0.2F, -0.5F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F))
								.texOffs(29, 53).addBox(-1.5F, 0.2F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bone3 = LeftArm
				.addOrReplaceChild(
						"bone3", CubeListBuilder.create().texOffs(0, 25).addBox(-0.3F, 0.2F, -0.5F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F))
								.texOffs(54, 4).addBox(-1.5F, 0.2F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)),
						PartPose.offset(0.0F, 7.3F, 0.0F));
