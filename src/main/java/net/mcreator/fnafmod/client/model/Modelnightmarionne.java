...
public class Modelnightmarionne<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("fnaf_mod", "modelnightmarionne"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head", CubeListBuilder.create(), PartPose.offset(0.5F, -19.1667F, -13.0F));
		PartDefinition Head2 = Head.addOrReplaceChild("Head2",
				CubeListBuilder.create().texOffs(0, 9).addBox(-3.0F, -8.8333F, -2.5F, 6.0F, 9.0F, 4.0F, new CubeDeformation(-0.01F)).texOffs(3, 0)
		...
		PartDefinition left_arm = partdefinition.addOrReplaceChild("left_arm", CubeListBuilder.create(), PartPose.offset(4.5745F, -15.6674F, -8.7F));
		PartDefinition left_arm2 = left_arm.addOrReplaceChild("left_arm2",
				CubeListBuilder.create().texOffs(16, 36).addBox(-1.0F, -0.5F, -1.0F, 2.0F, 9.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition left_lower_arm = left_arm2.addOrReplaceChild("left_lower_arm",
				CubeListBuilder.create().texOffs(16, 22).addBox(-0.5F, 0.5F, -0.5F, 1.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bone5 = right_hand2.addOrReplaceChild("bone5",
				CubeListBuilder.create().texOffs(46, 0).addBox(-1.4414F, -12.147F, -2.8406F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.4142F, 3.25F, -1.2F, -0.7418F, 0.0F, 0.0F));
		PartDefinition cube_r1 = bone5.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(26, 46).addBox(-1.5F, -7.8829F, -9.3298F, 1.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bone6 = right_hand2.addOrReplaceChild("bone6",
				CubeListBuilder.create().texOffs(12, 41).addBox(-1.4414F, -11.9216F, 2.4066F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.4142F, 3.15F, -1.2F, -0.3054F, 0.0F, 0.0F));
		PartDefinition cube_r2 = bone6.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(16, 47).addBox(-0.5F, -8.0F, 0.5F, 1.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bone7 = right_hand2.addOrReplaceChild("bone7",
				CubeListBuilder.create().texOffs(44, 45).addBox(-1.4414F, -12.147F, -2.8406F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.5858F, 3.25F, -1.2F, -0.7418F, 0.0F, 0.0F));
		PartDefinition cube_r3 = bone7.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(24, 46).addBox(0.5F, -8.6441F, -5.041F, 1.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition right_arm2 = right_arm.addOrReplaceChild("right_arm2",
				CubeListBuilder.create().texOffs(36, 39).addBox(-1.0F, -0.5F, -1.0F, 2.0F, 9.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition right_lower_arm = right_arm2.addOrReplaceChild("right_lower_arm",
				CubeListBuilder.create().texOffs(24, 36).addBox(-0.5F, 0.5F, -0.5F, 1.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bone2 = right_hand.addOrReplaceChild("bone2",
				CubeListBuilder.create().texOffs(46, 0).addBox(0.2205F, -12.43F, -2.8743F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.4142F, 3.25F, -1.2F, -0.7418F, 0.0F, 0.0F));
		PartDefinition cube_r4 = bone2.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(24, 46).addBox(-1.7812F, -11.6388F, -9.0441F, 1.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bone3 = right_hand.addOrReplaceChild("bone3",
				CubeListBuilder.create().texOffs(12, 41).addBox(0.2205F, -12.1922F, 2.4956F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.4142F, 3.15F, -1.2F, -0.3054F, 0.0F, 0.0F));
		PartDefinition cube_r5 = bone3.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(26, 46).addBox(-0.7812F, -12.9967F, -3.5052F, 1.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bone4 = right_hand.addOrReplaceChild("bone4",
				CubeListBuilder.create().texOffs(44, 45).addBox(0.2205F, -12.43F, -2.8743F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.5858F, 3.25F, -1.2F, -0.7418F, 0.0F, 0.0F));
		PartDefinition cube_r6 = bone4.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(16, 47).addBox(0.2188F, -7.8768F, -10.3301F, 1.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0018F, 7.4435F, -0.6403F, -0.7854F, 0.0F, 0.0F));
		PartDefinition left_leg = partdefinition.addOrReplaceChild("left_leg", CubeListBuilder.create(), PartPose.offset(3.5F, -7.5F, 1.5F));
		PartDefinition left_leg2 = left_leg.addOrReplaceChild("left_leg2",
				CubeListBuilder.create().texOffs(42, 9).addBox(0.0663F, 14.6027F, -1.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(20, 16)
		...
		PartDefinition left_lower_leg = left_leg2.addOrReplaceChild("left_lower_leg",
				CubeListBuilder.create().texOffs(28, 23).addBox(-1.0F, 1.5F, -1.0F, 2.0F, 17.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.5663F, 16.1027F, 0.0F, 0.7418F, 0.0F, 0.0F));
		PartDefinition right_leg = partdefinition.addOrReplaceChild("right_leg", CubeListBuilder.create(), PartPose.offset(-0.5F, -8.5F, 1.5F));
		PartDefinition right_leg2 = right_leg.addOrReplaceChild("right_leg2",
				CubeListBuilder.create().texOffs(0, 42).addBox(-3.0663F, 14.6027F, -1.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 22)
		...
		PartDefinition right_lower_leg = right_leg2.addOrReplaceChild("right_lower_leg",
				CubeListBuilder.create().texOffs(8, 22).addBox(-1.0F, 1.5F, -1.0F, 2.0F, 17.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.5663F, 16.1027F, 0.0F, 0.6109F, 0.0F, 0.0F));
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(28, 42).addBox(-1.0F, -18.7032F, -1.2113F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F))
						.texOffs(28, 16).addBox(-3.0F, -1.7032F, -2.4113F, 6.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(44, 39)
