...
public class ModelMangle<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("fnaf_mod", "model_mangle"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition RightArmHead = partdefinition.addOrReplaceChild("RightArmHead", CubeListBuilder.create().texOffs(29, 37).addBox(-1.5F, 2.0F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(23, 52)
				.addBox(-0.5F, 1.0F, -0.5F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(50, 36).addBox(-1.0F, 7.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-6.5F, 3.5F, 1.0F, 0.0F, 0.0F, 1.9199F));
		...
		PartDefinition right_hand3 = right_lower_leg.addOrReplaceChild("right_hand3", CubeListBuilder.create().texOffs(31, 45).addBox(-1.1F, 0.0F, -1.5F, 2.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(21, 17)
				.addBox(0.9F, 1.0F, -0.5F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(42, 5).addBox(-1.1F, 2.0F, -1.5F, 3.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 7.0F, -0.1F));
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(50, 36).addBox(-7.49F, -13.51F, -0.99F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(50, 36)
				.addBox(-2.49F, -13.51F, -1.99F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(50, 36).addBox(5.49F, -13.51F, -0.99F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 16.0F, 1.0F));
		PartDefinition Neck = Body.addOrReplaceChild("Neck", CubeListBuilder.create().texOffs(50, 24).addBox(-1.0F, 2.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(23, 52)
		...
		PartDefinition right_hand4 = endo_torso.addOrReplaceChild("right_hand4", CubeListBuilder.create().texOffs(31, 45).addBox(-1.0F, -0.2F, -1.5F, 2.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(21, 17)
				.addBox(1.0F, 0.8F, -0.5F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(42, 5).addBox(-1.0F, 1.8F, -1.5F, 3.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.0F, -28.8F, -1.0F, 0.0F, 0.0F, -3.1416F));
