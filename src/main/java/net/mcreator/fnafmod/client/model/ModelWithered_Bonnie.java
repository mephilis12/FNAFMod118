...
public class ModelWithered_Bonnie<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild(
				"Head", CubeListBuilder.create().texOffs(87, 3).addBox(-4.0F, -7.0F, -1.0F, 8.0F, 6.0F, 4.0F, new CubeDeformation(0.0F))
						.texOffs(43, 73).addBox(-3.5F, -6.7F, -0.4F, 7.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition right_hand = bone2.addOrReplaceChild("right_hand",
				CubeListBuilder.create().texOffs(23, 21).addBox(-0.41F, 0.0F, -1.5F, 1.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(31, 41)
						.addBox(0.09F, 0.0F, -1.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 17).addBox(-0.41F, 0.0F, -1.5F, 1.0F,
		...
		PartDefinition bone9 = bone4
				.addOrReplaceChild("bone9",
						CubeListBuilder.create().texOffs(-4, 97).addBox(-0.9F, 0.8F, -6.7F, 2.0F, 0.0F, 4.0F, new CubeDeformation(0.0F))
								.texOffs(60, 13).addBox(-1.4F, 0.0F, -2.7F, 3.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)),
