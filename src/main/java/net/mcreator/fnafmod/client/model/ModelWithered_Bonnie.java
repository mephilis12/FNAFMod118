...
public class ModelWithered_Bonnie<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("fnaf_mod", "model_withered_bonnie"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(87, 3).addBox(-4.0F, -7.0F, -1.0F, 8.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(43, 73).addBox(-3.5F, -6.7F, -0.4F, 7.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition endo_head = Head.addOrReplaceChild("endo_head",
				CubeListBuilder.create().texOffs(39, 18).addBox(10.2381F, -1.4048F, 1.2857F, 6.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(0, 58).addBox(9.7381F, -5.4048F, 0.7857F, 7.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(12, 48)
						.addBox(12.2381F, -1.4048F, 0.7857F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 84).addBox(14.7381F, -3.4048F, 0.8857F, 1.0F, 1.0F, 0.0F, new CubeDeformation(-0.3F)).texOffs(0, 84)
						.addBox(10.7381F, -3.4048F, 0.8857F, 1.0F, 1.0F, 0.0F, new CubeDeformation(-0.3F)).texOffs(22, 17).addBox(12.2381F, -0.4048F, 0.7857F, 2.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition RightTop = RightEar2.addOrReplaceChild("RightTop", CubeListBuilder.create(), PartPose.offset(0.0F, -3.0F, 0.0F));
		...
		PartDefinition right_hand = bone2.addOrReplaceChild("right_hand", CubeListBuilder.create().texOffs(23, 21).addBox(-0.41F, 0.0F, -1.5F, 1.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(31, 41)
				.addBox(0.09F, 0.0F, -1.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 17).addBox(-0.41F, 0.0F, -1.5F, 1.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.09F, 6.2F, 0.0F, 0.0F, 0.0F, 0.0F));
		PartDefinition LeftArm_r1 = right_hand.addOrReplaceChild("LeftArm_r1", CubeListBuilder.create().texOffs(36, 63).addBox(0.0F, -1.0F, -1.5F, 2.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.41F, 2.0F, 0.0F, 0.0F, 0.0F, 1.1781F));
		PartDefinition bone5 = right_hand.addOrReplaceChild("bone5", CubeListBuilder.create(), PartPose.offsetAndRotation(1.1176F, 0.4319F, -1.0F, 0.0F, 0.0F, 2.9671F));
		PartDefinition bone6 = right_hand.addOrReplaceChild("bone6", CubeListBuilder.create(), PartPose.offsetAndRotation(14.2176F, 3.9319F, -2.0F, 0.0F, 3.1416F, 0.0F));
		...
		PartDefinition bone9 = bone4.addOrReplaceChild("bone9",
				CubeListBuilder.create().texOffs(-4, 97).addBox(-0.9F, 0.8F, -6.7F, 2.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(60, 13).addBox(-1.4F, 0.0F, -2.7F, 3.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-0.1F, 7.0F, 0.7F));
		PartDefinition RightLeg_r1 = bone9.addOrReplaceChild("RightLeg_r1", CubeListBuilder.create().texOffs(-4, 102).addBox(-0.3F, 0.85F, -4.5F, 2.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.1F, 0.0F, -2.2F, 0.0F, -0.3927F, 0.0F));
		PartDefinition RightLeg_r2 = bone9.addOrReplaceChild("RightLeg_r2", CubeListBuilder.create().texOffs(-4, 92).addBox(-1.5F, 0.85F, -4.5F, 2.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.1F, 0.0F, -2.2F, 0.0F, 0.3927F, 0.0F));
		PartDefinition RightLeg = partdefinition
				.addOrReplaceChild(
						"RightLeg", CubeListBuilder.create().texOffs(44, 49).addBox(-1.0019F, 6.0F, -0.9564F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 17).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F))
								.texOffs(0, 37).addBox(-2.0436F, 0.0F, -2.5019F, 4.0F, 6.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(36, 78).addBox(-1.5F, 5.5F, -3.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(0, 28).addBox(-4.5034F, 6.002F, -2.402F, 9.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(44, 49).addBox(-7.5034F, -2.998F, 0.098F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(44, 49)
						.addBox(5.4966F, -2.998F, 0.098F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(112, 0).addBox(4.9966F, -1.998F, 1.098F, 3.0F, 11.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(77, 28)
						.addBox(-4.0034F, -3.498F, -2.902F, 8.0F, 5.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(29, 40).addBox(-0.5034F, -0.498F, -3.002F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(29, 40)
						.addBox(-0.5034F, 1.502F, -3.002F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(77, 15).addBox(-4.5034F, 1.502F, -2.902F, 9.0F, 4.0F, 7.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0034F, 0.498F, -0.098F));
		PartDefinition LeftArm_r3 = Body.addOrReplaceChild("LeftArm_r3", CubeListBuilder.create().texOffs(8, 93).addBox(-0.5F, -3.0F, 1.5F, 3.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)),
