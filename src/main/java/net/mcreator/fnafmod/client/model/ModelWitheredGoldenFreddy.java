...
public class ModelWitheredGoldenFreddy<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("fnaf_mod", "model_withered_golden_freddy"),
			"main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = Body.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(25, 21).addBox(-4.0F, -7.0F, -4.0F, 8.0F, 6.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(16, 70)
		...
		PartDefinition cube_r1 = Head.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(6, 73).addBox(-2.3F, -0.3F, 0.0F, 6.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition right_hand2 = bone3.addOrReplaceChild("right_hand2",
				CubeListBuilder.create().texOffs(61, 32).addBox(-0.9F, 0.2F, -2.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(23, 21)
						.addBox(-0.39F, 0.7F, -1.5F, 1.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(41, 19).addBox(0.11F, 0.7F, 0.5F, 2.0F,
		...
		PartDefinition LeftArm_r2 = right_hand2.addOrReplaceChild("LeftArm_r2",
				CubeListBuilder.create().texOffs(42, 34).addBox(-0.2F, 0.0F, -1.5F, 2.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition LeftArm_r3 = right_hand2.addOrReplaceChild("LeftArm_r3",
				CubeListBuilder.create().texOffs(28, 21).addBox(0.3F, -1.8F, 0.9F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.2F)),
		...
		PartDefinition LeftArm_r4 = right_hand2.addOrReplaceChild("LeftArm_r4",
				CubeListBuilder.create().texOffs(42, 38).addBox(-0.7F, -0.8F, 0.9F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.2F)).texOffs(42, 38)
		...
		PartDefinition right_hand = bone2.addOrReplaceChild("right_hand",
				CubeListBuilder.create().texOffs(42, 38).addBox(-1.71F, 2.4F, -0.9F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.2F)).texOffs(28, 21)
						...
						.addBox(-1.71F, 2.4F, 0.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.2F)).texOffs(42, 38).addBox(-1.71F, 2.4F, 1.9F, 2.0F,
		...
		PartDefinition bone4 = LeftLeg.addOrReplaceChild("bone4",
				CubeListBuilder.create().texOffs(0, 48).addBox(-2.0F, -0.5F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition bone8 = right_lower_leg.addOrReplaceChild("bone8",
				CubeListBuilder.create().texOffs(48, 34).addBox(-2.0F, -1.0F, -3.2F, 4.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(60, 13)
						.addBox(-1.5F, -0.099F, -2.7F, 3.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(72, 48).addBox(-1.0F, -1.0F, -7.2F, 2.0F,
