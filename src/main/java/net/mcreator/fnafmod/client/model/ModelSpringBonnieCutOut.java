...
public class ModelSpringBonnieCutOut<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("fnaf_mod", "model_spring_bonnie_cut_out"),
			"main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone = partdefinition.addOrReplaceChild("bone",
				CubeListBuilder.create().texOffs(0, 0).addBox(-15.4F, -48.0F, -0.99F, 38.0F, 48.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(0, 48)
						...
						.addBox(-4.0F, -15.5F, -1.5F, 6.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(25, 159)
						.addBox(2.0F, -15.5F, -1.5F, 6.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)),
