...
public class ModelFoxy<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Jaw = Head.addOrReplaceChild(
				"Jaw", CubeListBuilder.create().texOffs(48, 32).addBox(-2.0F, 0.502F, -7.6374F, 4.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
						.texOffs(38, 41).addBox(-2.5F, 1.002F, -8.1374F, 5.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bone3 = LeftArm
				.addOrReplaceChild("bone3",
						CubeListBuilder.create().texOffs(28, 63).addBox(-1.49F, 0.2F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F))
								.texOffs(44, 57).addBox(-0.5F, 0.2F, -0.5F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bone2 = RightArm
				.addOrReplaceChild("bone2",
						CubeListBuilder.create().texOffs(44, 57).addBox(-0.5F, 0.2F, -0.5F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F))
								.texOffs(28, 63).addBox(-1.5F, 0.2F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)),
						PartPose.offset(0.0F, 7.3F, 0.0F));
		PartDefinition right_hand = bone2.addOrReplaceChild("right_hand",
				CubeListBuilder.create().texOffs(34, 16).addBox(-3.91F, 2.1F, 1.0F, 8.0F, 9.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(51, 40)
		...
		PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg",
				CubeListBuilder.create().texOffs(0, 37).addBox(-0.5564F, -0.5F, -2.5019F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(56, 26)
		...
		PartDefinition bone4 = LeftLeg.addOrReplaceChild("bone4",
				CubeListBuilder.create().texOffs(0, 47).addBox(-0.1F, 6.901F, -2.0F, 3.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(26, 4)
		...
		PartDefinition RightLeg_r1 = bone4.addOrReplaceChild("RightLeg_r1",
				CubeListBuilder.create().texOffs(0, 13).addBox(-1.5F, 1.0F, -4.5F, 2.0F, 0.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition RightLeg_r2 = bone4.addOrReplaceChild("RightLeg_r2",
				CubeListBuilder.create().texOffs(0, 15).addBox(-0.3F, 1.0F, -4.5F, 2.0F, 0.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition right_lower_leg = RightLeg.addOrReplaceChild("right_lower_leg",
				CubeListBuilder.create().texOffs(12, 52).addBox(-1.0F, 1.0F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 47)
