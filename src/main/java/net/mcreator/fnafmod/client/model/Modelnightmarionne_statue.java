...
public class Modelnightmarionne_statue<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("fnaf_mod", "modelnightmarionne_statue"),
			"main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition left_arm = Body.addOrReplaceChild("left_arm", CubeListBuilder.create(),
				PartPose.offsetAndRotation(4.0745F, -12.3706F, -0.4113F, -1.0472F, 0.0F, 0.0F));
		...
		PartDefinition right_arm = Body.addOrReplaceChild("right_arm", CubeListBuilder.create(),
				PartPose.offsetAndRotation(-4.112F, -12.3945F, -1.454F, -1.222F, -0.0149F, 0.041F));
		...
		PartDefinition left_leg = Body.addOrReplaceChild("left_leg", CubeListBuilder.create(),
				PartPose.offsetAndRotation(3.0F, 1.7968F, -0.2113F, -1.3049F, -0.1504F, 0.5484F));
		...
		PartDefinition right_leg = Body.addOrReplaceChild("right_leg", CubeListBuilder.create(),
				PartPose.offsetAndRotation(-1.0F, 0.7968F, -0.2113F, -1.2828F, 0.103F, -0.3341F));
