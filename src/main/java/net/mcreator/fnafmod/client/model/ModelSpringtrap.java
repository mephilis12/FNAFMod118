...
public class ModelSpringtrap<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone6 = bone3.addOrReplaceChild("bone6",
				CubeListBuilder.create().texOffs(9, 45).addBox(-0.5724F, -3.9319F, -2.5F, 1.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(99, 56)
		...
		PartDefinition LeftArm_r1 = bone4.addOrReplaceChild("LeftArm_r1",
				CubeListBuilder.create().texOffs(44, 115).addBox(5.0F, -1.0F, -4.0F, 0.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(44, 115)
						.addBox(6.0F, -1.0F, -4.0F, 0.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(44, 115).addBox(7.0F, -1.0F, -4.0F, 0.0F,
		...
		PartDefinition LeftArm_r2 = bone4.addOrReplaceChild("LeftArm_r2",
				CubeListBuilder.create().texOffs(37, 122).addBox(-3.5F, 0.0F, -4.0F, 3.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition LeftArm_r3 = right_lower_leg.addOrReplaceChild("LeftArm_r3",
				CubeListBuilder.create().texOffs(44, 115).addBox(0.5F, -1.0F, -4.0F, 0.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(44, 115)
						.addBox(-0.5F, -1.0F, -4.0F, 0.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(44, 115)
						.addBox(-1.5F, -1.0F, -4.0F, 0.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(37, 122).addBox(-2.0F, 0.0F, -4.0F, 3.0F,
								1.0F, 5.0F, new CubeDeformation(0.0F)),
