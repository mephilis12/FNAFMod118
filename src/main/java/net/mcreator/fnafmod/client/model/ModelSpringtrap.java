...
public class ModelSpringtrap<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("fnaf_mod", "model_springtrap"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head", CubeListBuilder.create(), PartPose.offset(0.0F, -10.8F, 1.0F));
		...
		PartDefinition bone3 = LeftArm.addOrReplaceChild("bone3", CubeListBuilder.create().texOffs(0, 0).addBox(-0.3F, 0.2F, -0.5F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(46, 23)
				.addBox(-0.8F, 1.2F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(37, 47).addBox(-1.5F, 0.6F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 8.2F, 0.0F));
		...
		PartDefinition bone6 = bone3.addOrReplaceChild("bone6",
				CubeListBuilder.create().texOffs(9, 45).addBox(-0.5724F, -3.9319F, -2.5F, 1.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(99, 56).addBox(-1.1176F, -4.0319F, -3.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(111, 38)
						.addBox(-1.0724F, -2.4319F, -3.0F, 3.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(99, 38).addBox(-0.5724F, -1.9319F, -3.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(94, 30)
		...
		PartDefinition bone2 = RightArm.addOrReplaceChild("bone2", CubeListBuilder.create().texOffs(0, 0).addBox(-0.5F, 0.2F, -0.5F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(46, 23)
				.addBox(-1.0F, 1.2F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(37, 55).addBox(-1.5F, 0.6F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 8.3F, 0.0F));
		...
		PartDefinition bone4 = LeftLeg.addOrReplaceChild("bone4",
				CubeListBuilder.create().texOffs(95, 123).addBox(-1.9F, -1.5F, -2.5F, 4.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(4, 47).addBox(-0.4F, 0.0F, -0.5F, 1.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(28, 111)
						.addBox(-0.9F, 1.0F, -1.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 122).addBox(-1.4F, 7.001F, -1.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(54, 123)
						.addBox(-1.9F, 9.001F, -5.5F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(28, 22).addBox(-0.9F, 7.001F, 0.0F, 2.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 9.5F, 0.5F));
		PartDefinition LeftArm_r1 = bone4.addOrReplaceChild("LeftArm_r1", CubeListBuilder.create().texOffs(44, 115).addBox(5.0F, -1.0F, -4.0F, 0.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(44, 115)
				.addBox(6.0F, -1.0F, -4.0F, 0.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(44, 115).addBox(7.0F, -1.0F, -4.0F, 0.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-5.9F, 8.1352F, -1.5948F, 0.2182F, 0.0F, 0.0F));
		PartDefinition LeftArm_r2 = bone4.addOrReplaceChild("LeftArm_r2", CubeListBuilder.create().texOffs(37, 122).addBox(-3.5F, 0.0F, -4.0F, 3.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition right_lower_leg = RightLeg.addOrReplaceChild("right_lower_leg",
				CubeListBuilder.create().texOffs(98, 9).addBox(-2.0F, 0.5F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(83, 123).addBox(-2.0F, -1.5F, -2.5F, 4.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(4, 47)
						...
						.addBox(-1.0F, 7.0F, 0.0F, 2.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(0, 122).addBox(-1.5F, 7.001F, -1.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(54, 123)
