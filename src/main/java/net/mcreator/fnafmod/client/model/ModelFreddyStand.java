...
public class ModelFreddyStand<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition endo_torso = Stand.addOrReplaceChild("endo_torso",
				CubeListBuilder.create().texOffs(14, 37).addBox(2.0F, -13.0F, -2.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition bone7 = Stand.addOrReplaceChild(
				"bone7", CubeListBuilder.create().texOffs(32, 33).addBox(-3.0F, -3.0F, 0.0F, 6.0F, 6.0F, 0.0F, new CubeDeformation(0.0F))
						.texOffs(32, 33).addBox(-10.0F, 15.0F, 0.0F, 6.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offset(3.0F, -10.2426F, 0.0F));
		PartDefinition cube_r1 = bone7.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 29).addBox(-1.0F, 1.0F, 0.0F, 8.0F, 9.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(32, 33)
		...
		PartDefinition cube_r2 = bone7.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(32, 33).addBox(-7.0F, -3.0F, 4.0F, 6.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r4 = bone7.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(32, 33).addBox(-11.0F, -3.0F, 0.0F, 6.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-7.0F, 18.0F, 0.0F, 0.0F, 3.1416F, 0.0F));
		PartDefinition Body = Stand.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(34, 12).addBox(-2.4858F, -13.5F, -5.0F, 5.0F, 2.0F, 1.0F, new CubeDeformation(0.15F)).texOffs(22, 21)
		...
		PartDefinition Head = Body.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(0, 15).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 7.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(23, 15)
						.addBox(-4.5F, -3.0F, -4.0F, 9.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(16, 33)
						.addBox(-3.0F, -3.0F, -6.1F, 6.0F, 2.0F, 2.0F, new CubeDeformation(0.15F)).texOffs(26, 0).addBox(-1.0F, -3.5F, -6.5F, 2.0F,
								1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -15.8F, 0.0F, -0.0872F, 0.0038F, -0.262F));
		PartDefinition Head_r1 = Head.addOrReplaceChild("Head_r1",
				CubeListBuilder.create().texOffs(34, 11).addBox(-4.0F, -1.4F, 0.8F, 8.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -5.4312F, -5.6113F, -0.8727F, 0.0F, 0.0F));
		PartDefinition Jaw = Head.addOrReplaceChild("Jaw",
				CubeListBuilder.create().texOffs(26, 0).addBox(-3.5F, -0.5F, -5.6F, 7.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(34, 8)
