...
public class ModelPhantom_Foxy<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition LeftArm = partdefinition.addOrReplaceChild("LeftArm",
				CubeListBuilder.create().texOffs(46, 7).addBox(-1.85F, 0.6F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(25, 66)
		...
		PartDefinition LeftArm_r1 = right_hand2.addOrReplaceChild("LeftArm_r1",
				CubeListBuilder.create().texOffs(42, 34).addBox(-0.5F, -0.5F, -1.5F, 2.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.19F, 2.7F, 0.0F, 0.0F, 0.0F, 0.7418F));
		PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm",
				CubeListBuilder.create().texOffs(32, 49).addBox(-2.01F, 1.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(13, 61)
		...
		PartDefinition bone9 = bone4.addOrReplaceChild(
				"bone9", CubeListBuilder.create().texOffs(-4, 97).addBox(-0.9F, 0.82F, -6.7F, 2.0F, 0.0F, 4.0F, new CubeDeformation(0.0F))
						.texOffs(60, 13).addBox(-1.4F, -0.099F, -2.7F, 3.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-0.1F, 7.0F, 0.7F));
		PartDefinition RightLeg_r1 = bone9.addOrReplaceChild("RightLeg_r1",
				CubeListBuilder.create().texOffs(-4, 92).addBox(-1.5F, 0.85F, -4.5F, 2.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition RightLeg_r2 = bone9.addOrReplaceChild("RightLeg_r2",
				CubeListBuilder.create().texOffs(-4, 102).addBox(-0.3F, 0.85F, -4.5F, 2.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.1F, 0.0F, -2.2F, 0.0F, -0.3927F, 0.0F));
		...
		PartDefinition right_lower_leg = RightLeg.addOrReplaceChild("right_lower_leg",
				CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, 1.0F, -0.5F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 7.0F, 0.0F));
		PartDefinition bone8 = right_lower_leg.addOrReplaceChild(
				"bone8", CubeListBuilder.create().texOffs(-4, 97).addBox(-1.0F, 0.82F, -6.7F, 2.0F, 0.0F, 4.0F, new CubeDeformation(0.0F))
						.texOffs(60, 13).addBox(-1.5F, -0.099F, -2.7F, 3.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 7.0F, 0.7F));
		PartDefinition RightLeg_r3 = bone8.addOrReplaceChild("RightLeg_r3",
				CubeListBuilder.create().texOffs(-4, 92).addBox(-1.5F, 0.848F, -4.5F, 2.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition RightLeg_r4 = bone8.addOrReplaceChild("RightLeg_r4",
				CubeListBuilder.create().texOffs(-4, 102).addBox(-0.3F, 0.848F, -4.5F, 2.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.002F, -2.2F, 0.0F, -0.3927F, 0.0F));
