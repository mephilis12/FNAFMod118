...
public class ModelSittingWitheredBonnie<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("fnaf_mod", "model_sitting_withered_bonnie"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition LeftArm_r1 = Body.addOrReplaceChild("LeftArm_r1", CubeListBuilder.create().texOffs(8, 93).addBox(-0.5F, -3.0F, 1.5F, 3.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition endoi_jaw = endo_head.addOrReplaceChild("endoi_jaw", CubeListBuilder.create(), PartPose.offsetAndRotation(13.2381F, 1.8452F, 0.7857F, -0.3054F, 0.0F, 0.0F));
		...
		PartDefinition right_hand = bone2.addOrReplaceChild("right_hand",
				CubeListBuilder.create().texOffs(23, 21).addBox(-0.41F, 0.0F, -1.5F, 1.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 17).addBox(-0.41F, 0.0F, -1.5F, 1.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.09F, 6.2F, 0.0F, -1.4572F, 1.1758F, -1.4659F));
		PartDefinition LeftArm_r3 = right_hand.addOrReplaceChild("LeftArm_r3", CubeListBuilder.create().texOffs(31, 41).addBox(-1.0F, -1.5F, -0.5F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.09F, 1.5F, -1.0F, 1.2216F, 0.4971F, -0.1719F));
		PartDefinition LeftArm_r4 = right_hand.addOrReplaceChild("LeftArm_r4", CubeListBuilder.create().texOffs(36, 63).addBox(0.0F, -1.0F, -1.5F, 2.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bone9 = bone4.addOrReplaceChild("bone9",
				CubeListBuilder.create().texOffs(-4, 97).addBox(-0.9F, 0.65F, -6.7F, 2.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(60, 13).addBox(-1.4F, 0.0F, -2.7F, 3.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.1F, 7.0F, 0.7F, 1.2243F, 0.0344F, -0.0559F));
		PartDefinition RightLeg_r1 = bone9.addOrReplaceChild("RightLeg_r1", CubeListBuilder.create().texOffs(-4, 102).addBox(-0.3F, 1.7F, -4.5F, 2.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.1F, -1.0F, -2.2F, 0.0F, -0.3927F, 0.0F));
		PartDefinition RightLeg_r2 = bone9.addOrReplaceChild("RightLeg_r2", CubeListBuilder.create().texOffs(-4, 92).addBox(-1.5F, 1.7F, -4.5F, 2.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.1F, -1.0F, -2.2F, 0.0F, 0.3927F, 0.0F));
		...
		PartDefinition bone8 = right_lower_leg.addOrReplaceChild("bone8", CubeListBuilder.create().texOffs(60, 13).addBox(-1.5F, -0.099F, -2.7F, 3.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(48, 34)
				.addBox(-2.0F, -1.0F, -3.2F, 4.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(72, 48).addBox(-1.0F, -1.0F, -7.2F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition RightLeg_r4 = bone8.addOrReplaceChild("RightLeg_r4", CubeListBuilder.create().texOffs(74, 5).addBox(-0.3F, -1.0F, -5.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, -2.2F, 0.0F, -0.3927F, 0.0F));
		PartDefinition LeftArm_r5 = bone8.addOrReplaceChild("LeftArm_r5", CubeListBuilder.create().texOffs(24, 0).addBox(-1.5F, 0.0F, -2.0F, 3.0F, 0.0F, 2.0F, new CubeDeformation(0.0F)),
