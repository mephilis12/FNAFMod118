...
public class ModelFredbearFNAF4<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(86, 37).addBox(-8.05F, -13.6F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(85, 71)
						...
						.addBox(-5.5F, -10.5F, -5.0F, 11.0F, 6.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(0, 26).addBox(-4.5F, -14.5F, -5.0F, 9.0F,
		...
		PartDefinition LeftArm_r1 = Body.addOrReplaceChild("LeftArm_r1",
				CubeListBuilder.create().texOffs(0, 77).addBox(-2.5F, -2.5F, -2.0F, 3.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-7.55F, -13.1F, 0.0F, 0.0F, 0.0F, 0.3927F));
		PartDefinition LeftArm_r2 = Body.addOrReplaceChild("LeftArm_r2",
				CubeListBuilder.create().texOffs(78, 10).addBox(-0.5F, -2.5F, -2.0F, 3.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(7.55F, -13.1F, 0.0F, 0.0F, 0.0F, -0.3927F));
		PartDefinition Head = Body.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(48, 0).addBox(-4.5F, -2.2F, -5.0F, 9.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 72)
						...
						.addBox(-1.5F, -13.2F, -2.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 14).addBox(-5.0F, -5.2F, -5.0F, 10.0F,
								3.0F, 9.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -17.8F, 0.0F, 0.0F, -0.2182F, 0.0F));
		PartDefinition Jaw = Head.addOrReplaceChild("Jaw",
				CubeListBuilder.create().texOffs(28, 32).addBox(-4.5F, 0.15F, -3.1652F, 9.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(30, 0)
						.addBox(-3.5F, 0.15F, -7.1652F, 7.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(47, 43).addBox(-3.0F, -0.75F, -6.6652F,
								6.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -0.4932F, 1.0F, 0.2182F, 0.0F, 0.0F));
		PartDefinition LeftEar = Head.addOrReplaceChild("LeftEar",
				CubeListBuilder.create().texOffs(12, 63).addBox(-1.5F, -3.2F, -1.0F, 3.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(44, 48)
						.addBox(-1.0F, -3.2F, 0.0F, 2.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(60, 7).addBox(-1.0F, 0.8F, -1.0F, 2.0F, 2.0F,
		...
		PartDefinition RightEar = Head.addOrReplaceChild("RightEar",
				CubeListBuilder.create().texOffs(53, 57).addBox(-1.5F, -3.2F, -1.0F, 3.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(30, 0)
						.addBox(-1.0F, -3.2F, 0.0F, 2.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(60, 4).addBox(-1.0F, 0.8F, -1.0F, 2.0F, 2.0F,
								1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.5F, -9.0F, -1.0F, 0.0F, 0.0F, -0.7854F));
		...
		PartDefinition endo_head = Head.addOrReplaceChild("endo_head",
				CubeListBuilder.create().texOffs(40, 54).addBox(10.2381F, -1.7048F, -1.4143F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
						.texOffs(30, 31).addBox(15.2381F, -1.7048F, -1.4143F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(26, 85)
						...
						.addBox(10.7381F, -4.1548F, -2.8143F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(70, 23).addBox(9.7381F, -0.4048F,
		...
		PartDefinition LeftArm = Body.addOrReplaceChild("LeftArm",
				CubeListBuilder.create().texOffs(0, 52).addBox(-2.51F, 2.0F, -2.5F, 5.0F, 6.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(76, 86)
						.addBox(-0.35F, 1.6F, -0.5F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(75, 78)
						.addBox(-1.35F, 2.6F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(68, 84).addBox(-0.8F, 7.5F, -1.0F, 2.0F,
		...
		PartDefinition bone3 = LeftArm.addOrReplaceChild("bone3",
				CubeListBuilder.create().texOffs(80, 87).addBox(-0.3F, 0.2F, -0.5F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(29, 17)
						.addBox(-0.8F, 1.2F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(36, 68).addBox(-2.01F, -0.3F, -2.0F, 4.0F,
		...
		PartDefinition bone6 = bone3.addOrReplaceChild("bone6",
				CubeListBuilder.create().texOffs(15, 52).addBox(-0.5F, 0.6F, -1.625F, 1.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(83, 65)
		...
		PartDefinition LeftArm_r4 = bone6.addOrReplaceChild("LeftArm_r4",
				CubeListBuilder.create().texOffs(61, 78).addBox(-1.4226F, -2.5F, -1.5F, 3.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.5774F, 3.6F, -0.625F, 0.0F, 0.0F, 1.7453F));
		PartDefinition RightArm = Body.addOrReplaceChild("RightArm",
				CubeListBuilder.create().texOffs(20, 54).addBox(-2.51F, 2.0F, -2.5F, 5.0F, 6.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(14, 79)
						.addBox(-1.5F, 2.5F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(26, 26)
						.addBox(-0.5F, 1.5F, -0.5F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(84, 76).addBox(-1.0F, 7.5F, -1.0F, 2.0F,
								2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-7.0F, -13.3F, 0.0F, 0.0F, -1.0472F, 0.7854F));
		PartDefinition bone2 = RightArm.addOrReplaceChild("bone2",
				CubeListBuilder.create().texOffs(52, 31).addBox(-0.5F, 0.2F, -0.5F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 26)
						.addBox(-1.0F, 1.2F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(69, 68).addBox(-2.01F, -0.3F, -2.0F, 4.0F,
								6.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition right_hand = bone2.addOrReplaceChild("right_hand",
				CubeListBuilder.create().texOffs(83, 82).addBox(-0.9F, 0.5F, -2.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(35, 54)
		...
		PartDefinition LeftLeg = Body.addOrReplaceChild("LeftLeg",
				CubeListBuilder.create().texOffs(22, 40).addBox(-2.4913F, 0.0F, -4.1004F, 5.0F, 8.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(20, 87)
		...
		PartDefinition bone4 = LeftLeg.addOrReplaceChild("bone4",
				CubeListBuilder.create().texOffs(57, 26).addBox(-2.0F, 0.0F, -2.5F, 4.0F, 6.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(50, 82)
		...
		PartDefinition bone8 = bone4.addOrReplaceChild("bone8",
				CubeListBuilder.create().texOffs(58, 57).addBox(-1.5F, 1.0F, -7.5F, 3.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(18, 65)
						.addBox(-1.9F, 0.001F, -2.5F, 4.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(72, 5)
						.addBox(-1.9F, 3.001F, -5.5F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(82, 59).addBox(-1.4F, 1.001F, -1.5F, 3.0F,
		...
		PartDefinition LeftArm_r5 = bone8.addOrReplaceChild("LeftArm_r5",
				CubeListBuilder.create().texOffs(52, 72).addBox(-3.5F, 0.0F, -4.0F, 3.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.1F, 2.1352F, -1.5948F, 0.2182F, 0.0F, 0.0F));
		PartDefinition cube_r1 = bone8.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(60, 4).addBox(0.1741F, 0.8579F, -6.4002F, 3.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r2 = bone8.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(54, 17).addBox(-4.1221F, 0.8579F, -6.4998F, 3.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition RightLeg = Body.addOrReplaceChild("RightLeg",
				CubeListBuilder.create().texOffs(12, 87).addBox(-1.0087F, 9.0F, -0.6004F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition right_lower_leg = RightLeg.addOrReplaceChild("right_lower_leg",
				CubeListBuilder.create().texOffs(40, 57).addBox(-2.0F, 0.0F, -2.5F, 4.0F, 6.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(79, 43)
						.addBox(-2.0F, -2.0F, -3.5F, 4.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(64, 84).addBox(-0.5F, 0.0F, 0.0F, 1.0F,
		...
		PartDefinition bone7 = right_lower_leg.addOrReplaceChild("bone7",
				CubeListBuilder.create().texOffs(66, 13).addBox(-1.5F, 1.0F, -7.5F, 3.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(66, 46)
		...
		PartDefinition LeftArm_r6 = bone7.addOrReplaceChild("LeftArm_r6",
				CubeListBuilder.create().texOffs(71, 61).addBox(-2.0F, 0.0F, -4.0F, 3.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.5F, 2.1352F, -1.5948F, 0.2182F, 0.0F, 0.0F));
		PartDefinition cube_r3 = bone7.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(62, 37).addBox(-1.5F, -1.5F, -5.0F, 3.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.0F, 3.0F, -1.5F, 0.0F, 0.1745F, 0.0F));
		PartDefinition cube_r4 = bone7.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(0, 63).addBox(-1.5F, -1.5F, -5.0F, 3.0F, 3.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.0F, 3.0F, -1.5F, 0.0F, -0.2182F, 0.0F));
		PartDefinition endo_torso = Body.addOrReplaceChild("endo_torso",
				CubeListBuilder.create().texOffs(81, 19).addBox(1.5F, -19.0F, -2.5F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(37, 84)
