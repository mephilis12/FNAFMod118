...
public class ModelPhantom_BB<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(51, 50).addBox(-2.5F, -3.2F, -3.4F, 5.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(52, 53)
		...
		PartDefinition bone6 = LeftArm
				.addOrReplaceChild(
						"bone6", CubeListBuilder.create().texOffs(20, 20).addBox(0.0F, -0.5F, -0.5F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
		...
		PartDefinition left_leg = partdefinition.addOrReplaceChild("left_leg",
				CubeListBuilder.create().texOffs(28, 47).addBox(-1.5F, -0.2F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(40, 50)
		...
		PartDefinition right_leg = partdefinition.addOrReplaceChild("right_leg",
				CubeListBuilder.create().texOffs(28, 47).addBox(-1.5F, -0.2F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(27, 0)
