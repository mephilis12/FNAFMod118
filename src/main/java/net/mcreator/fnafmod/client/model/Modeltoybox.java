...
public class Modeltoybox<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Box = bone2.addOrReplaceChild("Box",
				CubeListBuilder.create().texOffs(0, 0).addBox(-18.0F, -12.0F, -1.0F, 20.0F, 13.0F, 18.0F, new CubeDeformation(0.0F)),
				PartPose.offset(8.0F, 0.0F, -8.0F));
		PartDefinition HookArm = bone2.addOrReplaceChild("HookArm",
				CubeListBuilder.create().texOffs(0, 0).addBox(-2.01F, 2.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(85, 38)
						.addBox(-1.5F, 2.5F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(40, 67)
						.addBox(-0.5F, 1.5F, -0.5F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(20, 91).addBox(-1.0F, 7.5F, -1.0F, 2.0F,
		...
		PartDefinition bone11 = HookArm.addOrReplaceChild("bone11",
				CubeListBuilder.create().texOffs(61, 91).addBox(-0.5F, 0.2F, -0.5F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(32, 31)
						.addBox(-1.0F, 1.2F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(75, 77).addBox(-1.49F, 0.2F, -2.0F, 3.0F,
		...
		PartDefinition right_hand3 = bone11.addOrReplaceChild("right_hand3",
				CubeListBuilder.create().texOffs(24, 76).addBox(-3.91F, 1.7F, 0.0F, 8.0F, 9.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(89, 81)
		...
		PartDefinition MangleHead = bone2.addOrReplaceChild("MangleHead",
				CubeListBuilder.create().texOffs(70, 25).addBox(-4.0F, -5.5833F, 1.3167F, 8.0F, 7.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(58, 13)
		...
		PartDefinition LeftEar = endo_head.addOrReplaceChild("LeftEar",
				CubeListBuilder.create().texOffs(51, 86).addBox(-2.0F, -8.0F, -0.5F, 4.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition RightEar = endo_head.addOrReplaceChild("RightEar",
				CubeListBuilder.create().texOffs(0, 86).addBox(-2.5F, -8.0F, -0.5F, 4.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(12.7381F, 0.6952F, -0.4143F, 0.0F, 0.0F, -0.7854F));
		PartDefinition bone = bone2.addOrReplaceChild("bone",
				CubeListBuilder.create().texOffs(17, 48).addBox(-1.0F, -0.5F, -0.7823F, 2.0F, 1.0F, 15.0F, new CubeDeformation(0.0F)).texOffs(42, 74)
		...
		PartDefinition cube_r1 = bone.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(23, 66).addBox(-13.0F, -1.0F, 0.0F, 4.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(5.6361F, 0.5F, -17.6936F, 0.0F, 0.3927F, 0.0F));
		PartDefinition cube_r2 = bone.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(67, 66).addBox(-7.0F, -1.0F, 0.0F, 4.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(9.1459F, 0.5F, -11.5706F, 0.0F, -0.3927F, 0.0F));
		PartDefinition group = bone2.addOrReplaceChild("group",
				CubeListBuilder.create().texOffs(0, 31).addBox(-16.0F, -16.0F, 15.5F, 16.0F, 32.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r3 = group5.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(0, 12).addBox(-1.0F, -1.0F, 0.0F, 2.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 5.8478F, 0.0F, 0.3927F, 0.0F, 0.0F));
		PartDefinition cube_r4 = group5.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(12, 12).addBox(-1.0F, -1.0F, 0.0F, 2.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 4.0F, 0.0F, -0.3927F, 0.0F, 0.0F));
		PartDefinition cube_r5 = group5.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(32, 37).addBox(-1.0F, -1.0F, 0.0F, 2.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 2.1522F, 0.0F, 0.3927F, 0.0F, 0.0F));
		PartDefinition cube_r6 = group5.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(36, 37).addBox(-1.0F, -1.0F, 0.0F, 2.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.3045F, 0.0F, -0.3927F, 0.0F, 0.0F));
		PartDefinition cube_r7 = group5.addOrReplaceChild("cube_r7",
				CubeListBuilder.create().texOffs(58, 37).addBox(-1.0F, -1.0F, 0.0F, 2.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r8 = group4.addOrReplaceChild("cube_r8",
				CubeListBuilder.create().texOffs(0, 2).addBox(-1.0F, -1.0F, 0.0F, 2.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 2.1522F, 0.0F, 0.3927F, 0.0F, 0.0F));
		PartDefinition cube_r9 = group4.addOrReplaceChild("cube_r9",
				CubeListBuilder.create().texOffs(0, 10).addBox(-1.0F, -1.0F, 0.0F, 2.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.3045F, 0.0F, -0.3927F, 0.0F, 0.0F));
		PartDefinition BBHead = bone2.addOrReplaceChild("BBHead",
				CubeListBuilder.create().texOffs(40, 64).addBox(-2.5F, 0.9F, -1.52F, 5.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(66, 38)
		...
		PartDefinition LeftArm2 = bone2.addOrReplaceChild("LeftArm2",
				CubeListBuilder.create().texOffs(62, 0).addBox(-0.5F, 1.0F, -0.5F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(84, 66)
						.addBox(-1.5F, 1.0F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(36, 52).addBox(-0.95F, 6.9F, -1.0F, 2.0F,
								2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.3F, -15.5F, 2.0F, 0.6461F, 0.473F, -2.9738F));
		PartDefinition bone5 = LeftArm2.addOrReplaceChild("bone5",
				CubeListBuilder.create().texOffs(39, 91).addBox(-0.45F, 1.0F, -0.5F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(27, 85)
						.addBox(-1.5F, 1.1F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(40, 76).addBox(-0.95F, 6.0F, -1.0F, 2.0F,
								2.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition ToyFreddyHead = bone2.addOrReplaceChild("ToyFreddyHead",
				CubeListBuilder.create().texOffs(0, 64).addBox(-5.0F, 2.7F, -3.52F, 10.0F, 5.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(58, 36)
						...
						.addBox(-3.0F, -3.3F, -3.22F, 6.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(0, 10).addBox(-2.0F, -7.3F, -2.22F, 4.0F,
		...
		PartDefinition snout = ToyFreddyHead.addOrReplaceChild("snout",
				CubeListBuilder.create().texOffs(84, 4).addBox(11.5F, -18.0F, -8.0F, 5.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(8, 91)
		...
		PartDefinition ToyChicaHead = bone2.addOrReplaceChild("ToyChicaHead",
				CubeListBuilder.create().texOffs(32, 31).addBox(-4.2311F, 0.375F, -4.0533F, 9.0F, 9.0F, 8.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r10 = ToyChicaHead.addOrReplaceChild("cube_r10",
				CubeListBuilder.create().texOffs(86, 13).addBox(-6.0F, -4.0F, 0.0F, 6.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r11 = ToyChicaHead.addOrReplaceChild("cube_r11",
				CubeListBuilder.create().texOffs(83, 86).addBox(-6.0F, -4.0F, 0.0F, 6.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r12 = ToyChicaHead.addOrReplaceChild("cube_r12",
				CubeListBuilder.create().texOffs(39, 87).addBox(-6.0F, -4.0F, 0.0F, 6.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r1 = bone35.addOrReplaceChild("Head_r1",
				CubeListBuilder.create().texOffs(0, 63).addBox(-5.0F, -0.4F, 0.6F, 8.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.8727F, 0.0F, 0.0F));
		PartDefinition beak2 = ToyChicaHead.addOrReplaceChild(
				"beak2", CubeListBuilder.create().texOffs(85, 76).addBox(12.5F, -21.5F, -9.0F, 3.0F, 2.0F, 3.0F, new CubeDeformation(0.0F))
						.texOffs(36, 60).addBox(11.5F, -20.5F, -8.0F, 5.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-13.7311F, 26.875F, 1.9467F));
		PartDefinition ToyBonnieArm = bone2.addOrReplaceChild("ToyBonnieArm",
				CubeListBuilder.create().texOffs(15, 83).addBox(-1.5F, 1.5F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(58, 0)
						.addBox(-0.5F, 0.5F, -0.5F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(36, 48).addBox(-1.0F, 6.5F, -1.0F, 2.0F,
								2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.0F, -11.0F, 1.0F, 0.1805F, 0.4201F, 2.7762F));
		PartDefinition bone24 = ToyBonnieArm
				.addOrReplaceChild("bone24",
						CubeListBuilder.create().texOffs(66, 41).addBox(-0.5F, 0.2F, -0.5F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F))
								.texOffs(61, 83).addBox(-1.5F, 0.2F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)),
						PartPose.offset(0.0F, 7.3F, 0.0F));
		PartDefinition right_hand = bone24.addOrReplaceChild("right_hand",
				CubeListBuilder.create().texOffs(73, 86).addBox(-0.91F, 0.7F, -1.5F, 2.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-0.09F, 4.5F, 0.0F));
		PartDefinition LeftArm_r1 = right_hand.addOrReplaceChild("LeftArm_r1",
				CubeListBuilder.create().texOffs(12, 0).addBox(3.0F, -1.0F, -1.5F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition LeftArm_r2 = right_hand.addOrReplaceChild("LeftArm_r2",
				CubeListBuilder.create().texOffs(58, 31).addBox(-0.5F, -1.0F, -1.5F, 3.0F, 2.0F, 3.0F, new CubeDeformation(0.01F)),
		...
		PartDefinition ToyBonnieHead = bone2.addOrReplaceChild("ToyBonnieHead",
				CubeListBuilder.create().texOffs(36, 48).addBox(-5.0F, -2.2F, -4.8F, 10.0F, 4.0F, 8.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition endo_head3 = ToyBonnieHead.addOrReplaceChild("endo_head3",
				CubeListBuilder.create().texOffs(58, 0).addBox(8.7381F, -5.9048F, -3.7143F, 9.0F, 5.0F, 8.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head_r2 = bone25.addOrReplaceChild("Head_r2",
				CubeListBuilder.create().texOffs(58, 17).addBox(-5.0F, -0.4F, 0.6F, 8.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.8727F, 0.0F, 0.0F));
		PartDefinition beak = endo_head3.addOrReplaceChild(
				"beak", CubeListBuilder.create().texOffs(0, 0).addBox(13.5F, -22.5F, -8.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F))
						.texOffs(48, 82).addBox(11.0F, -21.5F, -8.0F, 6.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
