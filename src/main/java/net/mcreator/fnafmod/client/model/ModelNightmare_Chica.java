...
public class ModelNightmare_Chica<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("fnaf_mod", "model_nightmare_chica"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head = partdefinition.addOrReplaceChild("Head",
				CubeListBuilder.create().texOffs(22, 21).addBox(-4.0F, -2.2F, -4.0F, 8.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(68, 52)
						...
						.addBox(-3.5F, -8.2F, -5.0F, 7.0F, 6.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(23, 25).addBox(-4.5F, -5.2F, -5.0F, 9.0F,
								3.0F, 7.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -10.8F, 0.0F, 0.0F, 0.0F, 0.0F));
		PartDefinition Jaw = Head.addOrReplaceChild("Jaw",
				CubeListBuilder.create().texOffs(42, 54).addBox(-2.5F, -3.1687F, -3.2497F, 5.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(52, 0)
						...
						.addBox(-2.5F, -1.35F, -7.1652F, 5.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(78, 17).addBox(-3.0F, 0.15F, -8.1652F,
								6.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.5068F, 1.0F, 0.0873F, 0.0F, 0.0F));
		PartDefinition cube_r1 = Jaw.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(52, 67).addBox(-4.5F, -1.5F, -2.5F, 7.0F, 2.0F, 2.0F, new CubeDeformation(0.01F)),
				PartPose.offsetAndRotation(1.0F, -0.172F, -0.7519F, 0.1309F, 0.0F, 0.0F));
		PartDefinition cube_r2 = Jaw.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(30, 0).addBox(-5.0F, -0.3F, -3.0F, 8.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition endo_head = Head.addOrReplaceChild("endo_head",
				CubeListBuilder.create().texOffs(13, 56).addBox(11.2381F, -3.7048F, -0.4143F, 4.0F, 4.0F, 0.0F, new CubeDeformation(0.0F))
						.texOffs(24, 18).addBox(10.5381F, -4.9048F, -3.2143F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(48, 21)
						...
						.addBox(14.4381F, -4.3548F, -3.3143F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(0, 2).addBox(11.0381F, -4.3548F,
		...
		PartDefinition cube_r3 = bone9.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(0, 56).addBox(0.1353F, -2.6734F, -0.3536F, 2.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.3927F));
		PartDefinition cube_r4 = bone9.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(18, 60).addBox(-2.1633F, -2.6864F, -0.3536F, 2.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r5 = bone10.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(52, 0).addBox(0.1353F, -2.6734F, 0.3536F, 2.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.3927F));
		PartDefinition cube_r6 = bone10.addOrReplaceChild("cube_r6",
				CubeListBuilder.create().texOffs(42, 54).addBox(-2.1633F, -2.6864F, 0.3536F, 2.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.48F));
		PartDefinition LeftArm = partdefinition.addOrReplaceChild("LeftArm", CubeListBuilder.create(), PartPose.offset(7.0F, -6.4F, 2.0F));
		PartDefinition LeftArm2 = LeftArm.addOrReplaceChild("LeftArm2",
				CubeListBuilder.create().texOffs(22, 49).addBox(-2.51F, 1.0F, -2.5F, 5.0F, 6.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(67, 83)
						.addBox(-0.35F, 1.6F, -0.5F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(74, 64)
						.addBox(-1.35F, 2.6F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(31, 60).addBox(-0.8F, 7.5F, -1.0F, 2.0F,
		...
		PartDefinition bone3 = LeftArm2.addOrReplaceChild("bone3",
				CubeListBuilder.create().texOffs(4, 85).addBox(-0.3F, 0.2F, -0.5F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(71, 82)
						.addBox(-0.8F, 1.2F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(36, 63).addBox(-2.01F, -0.3F, -2.0F, 4.0F,
		...
		PartDefinition bone6 = bone3.addOrReplaceChild("bone6",
				CubeListBuilder.create().texOffs(0, 2).addBox(-0.5F, 0.6F, -1.625F, 1.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(37, 74)
		...
		PartDefinition LeftArm_r1 = bone6.addOrReplaceChild("LeftArm_r1",
				CubeListBuilder.create().texOffs(36, 64).addBox(0.05F, -0.4F, 0.25F, 2.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(70, 74)
		...
		PartDefinition LeftArm_r2 = bone6.addOrReplaceChild("LeftArm_r2",
				CubeListBuilder.create().texOffs(73, 54).addBox(0.0774F, -1.5F, -1.5F, 3.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(63, 17)
						...
						.addBox(0.0774F, -2.5F, 1.0F, 3.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(83, 52).addBox(0.0774F, -2.5F, 2.0F, 3.0F,
		...
		PartDefinition cooper = bone6.addOrReplaceChild("cooper",
				CubeListBuilder.create().texOffs(0, 97).addBox(2.0F, 3.5F, -3.0F, 1.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(23, 120)
		...
		PartDefinition bone11 = cooper.addOrReplaceChild("bone11",
				CubeListBuilder.create().texOffs(31, 106).addBox(-0.3F, -1.0F, -4.5F, 4.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(15, 96)
		...
		PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm", CubeListBuilder.create(), PartPose.offset(-7.0F, -6.3F, 1.0F));
		PartDefinition RightArm2 = RightArm.addOrReplaceChild("RightArm2",
				CubeListBuilder.create().texOffs(50, 32).addBox(-2.51F, 1.0F, -2.5F, 5.0F, 6.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(73, 74)
						.addBox(-1.5F, 2.5F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(63, 83)
						.addBox(-0.5F, 1.5F, -0.5F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(48, 63).addBox(-1.0F, 7.5F, -1.0F, 2.0F,
								2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.0475F, -0.346F, 0.4446F));
		PartDefinition bone2 = RightArm2.addOrReplaceChild("bone2",
				CubeListBuilder.create().texOffs(0, 85).addBox(-0.5F, 0.2F, -0.5F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(82, 20)
						.addBox(-1.0F, 1.2F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(66, 17).addBox(-2.01F, -0.3F, -2.0F, 4.0F,
								6.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition right_hand = bone2.addOrReplaceChild("right_hand",
				CubeListBuilder.create().texOffs(0, 79).addBox(-0.9F, 0.5F, -2.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 20)
						.addBox(-0.4F, 0.7F, -1.5F, 1.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(83, 31)
						.addBox(0.6F, 1.2F, -1.5F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(56, 8).addBox(0.6F, 1.2F, -1.0F, 2.0F, 3.0F,
		...
		PartDefinition LeftArm_r3 = right_hand.addOrReplaceChild("LeftArm_r3",
				CubeListBuilder.create().texOffs(70, 37).addBox(-0.5F, -1.5F, -2.0F, 3.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(44, 38)
						...
						.addBox(-0.5F, -2.5F, -0.5F, 3.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(55, 78).addBox(-0.5F, -2.5F, -1.5F, 3.0F,
								3.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg", CubeListBuilder.create(), PartPose.offset(3.0913F, 5.0F, 3.1004F));
		PartDefinition LeftLeg2 = LeftLeg.addOrReplaceChild("LeftLeg2",
				CubeListBuilder.create().texOffs(0, 42).addBox(-2.4913F, 0.0F, -4.1004F, 5.0F, 8.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(83, 6)
		...
		PartDefinition bone4 = LeftLeg2.addOrReplaceChild("bone4",
				CubeListBuilder.create().texOffs(0, 56).addBox(-2.0F, -1.0F, -2.5F, 4.0F, 6.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(39, 80)
						.addBox(-1.0F, 1.0F, -0.5F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(12, 82).addBox(-0.5F, 0.0F, 0.0F, 1.0F, 9.0F,
		...
		PartDefinition bone8 = bone4.addOrReplaceChild("bone8",
				CubeListBuilder.create().texOffs(57, 58).addBox(4.0F, 0.0F, -2.5F, 4.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(0, 18)
						...
						.addBox(4.0F, 3.001F, -3.5F, 4.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(16, 42).addBox(4.5F, 1.001F, -1.5F, 3.0F,
		...
		PartDefinition RightLeg_r1 = bone8.addOrReplaceChild("RightLeg_r1",
				CubeListBuilder.create().texOffs(65, 67).addBox(-1.7F, -1.0F, -6.0F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
		...
		PartDefinition RightLeg_r2 = bone8.addOrReplaceChild("RightLeg_r2",
				CubeListBuilder.create().texOffs(27, 69).addBox(-0.3F, -1.0F, -6.0F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(17, 18)
						.addBox(0.1971F, 0.5F, -6.0017F, 1.0F, 0.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(6.0467F, 3.0F, -1.5267F, 0.0F, -0.3927F, 0.0F));
		PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg", CubeListBuilder.create(), PartPose.offset(-2.9807F, 5.0F, 3.1428F));
		PartDefinition RightLeg2 = RightLeg.addOrReplaceChild("RightLeg2",
				CubeListBuilder.create().texOffs(82, 72).addBox(-1.0087F, 9.0F, -0.6004F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(23, 76)
		...
		PartDefinition right_lower_leg = RightLeg2.addOrReplaceChild("right_lower_leg",
				CubeListBuilder.create().texOffs(56, 6).addBox(-2.0F, -1.0F, -2.5F, 4.0F, 6.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(55, 81)
						.addBox(-1.0F, 1.0F, -0.5F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(16, 82).addBox(-0.5F, 0.0F, 0.0F, 1.0F, 9.0F,
								1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.0087F, 10.0F, -0.1004F, 0.6066F, 0.084F, -0.1005F));
		PartDefinition bone7 = right_lower_leg.addOrReplaceChild("bone7",
				CubeListBuilder.create().texOffs(18, 60).addBox(-2.0F, 0.0F, -2.5F, 4.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(27, 0)
						...
						.addBox(-2.0F, 3.001F, -3.5F, 4.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(11, 76).addBox(-1.5F, 1.001F, -1.5F, 3.0F,
								3.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition RightLeg_r3 = bone7.addOrReplaceChild("RightLeg_r3",
				CubeListBuilder.create().texOffs(0, 72).addBox(-1.7F, -1.0F, -6.0F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(29, 0)
		...
		PartDefinition RightLeg_r4 = bone7.addOrReplaceChild("RightLeg_r4",
				CubeListBuilder.create().texOffs(71, 1).addBox(-0.3F, -1.0F, -6.0F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(25, 0)
						.addBox(0.2009F, 0.5F, -6.0032F, 1.0F, 0.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0467F, 3.0F, -1.5267F, 0.0F, -0.3927F, 0.0F));
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(56, 71).addBox(-8.05F, -10.8571F, 0.9857F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
						.texOffs(22, 69).addBox(6.05F, -10.8571F, 0.9857F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(31, 11)
		...
		PartDefinition endo_torso = Body.addOrReplaceChild("endo_torso",
				CubeListBuilder.create().texOffs(80, 0).addBox(1.5F, -21.0F, -2.5F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(47, 78)
