...
public class ModelNightmare_Chica<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone3 = LeftArm2.addOrReplaceChild("bone3", CubeListBuilder.create().texOffs(4, 85).addBox(-0.3F, 0.2F, -0.5F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(71, 82)
				.addBox(-0.8F, 1.2F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(36, 63).addBox(-2.01F, -0.3F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bone2 = RightArm2.addOrReplaceChild("bone2", CubeListBuilder.create().texOffs(0, 85).addBox(-0.5F, 0.2F, -0.5F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(82, 20)
				.addBox(-1.0F, 1.2F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(66, 17).addBox(-2.01F, -0.3F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bone4 = LeftLeg2.addOrReplaceChild("bone4", CubeListBuilder.create().texOffs(0, 56).addBox(-2.0F, -1.0F, -2.5F, 4.0F, 6.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(39, 80)
		...
		PartDefinition RightLeg2 = RightLeg.addOrReplaceChild("RightLeg2",
				...
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.3024F, 0.05F, 0.121F));
		PartDefinition right_lower_leg = RightLeg2.addOrReplaceChild("right_lower_leg", CubeListBuilder.create().texOffs(56, 6).addBox(-2.0F, -1.0F, -2.5F, 4.0F, 6.0F, 5.0F, new CubeDeformation(0.0F)).texOffs(55, 81)
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(56, 71).addBox(-8.05F, -10.8571F, 0.9857F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(22, 69).addBox(6.05F, -10.8571F, 0.9857F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(31, 11)
						.addBox(-4.5F, -1.7571F, -2.0143F, 9.0F, 3.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(0, 0).addBox(-5.5F, -11.7571F, -3.0143F, 11.0F, 10.0F, 8.0F, new CubeDeformation(0.0F)),
