...
public class ModelUnwithered_Bonnie_Posed<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("fnaf_mod", "model_unwithered_bonnie_posed"),
			"main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone9 = Body.addOrReplaceChild("bone9",
				CubeListBuilder.create().texOffs(77, 98).addBox(-1.0F, -0.5F, -0.7823F, 2.0F, 1.0F, 15.0F, new CubeDeformation(0.0F)).texOffs(96, 98)
						.addBox(-3.0F, -0.5F, -7.7823F, 6.0F, 1.0F, 7.0F, new CubeDeformation(0.001F)).texOffs(96, 106)
		...
		PartDefinition cube_r1 = bone9.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(77, 114).addBox(-7.0F, -1.0F, 0.0F, 4.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(9.1459F, 0.5F, -11.5706F, 0.0F, -0.3927F, 0.0F));
		PartDefinition cube_r2 = bone9.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(94, 115).addBox(-13.0F, -1.0F, 0.0F, 4.0F, 1.0F, 9.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bone2 = RightArm.addOrReplaceChild("bone2",
				...
				PartPose.offsetAndRotation(0.0F, 8.3F, 0.0F, -1.4835F, 0.0F, 0.0F));
		PartDefinition right_hand = bone2.addOrReplaceChild("right_hand",
				CubeListBuilder.create().texOffs(42, 38).addBox(-0.71F, 2.4F, -1.9F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.2F)).texOffs(28, 21)
						...
						.addBox(-0.41F, 0.7F, -1.5F, 1.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(52, 5)
		...
		PartDefinition RightTop = RightEar2.addOrReplaceChild("RightTop", CubeListBuilder.create(),
				PartPose.offsetAndRotation(-1.0F, -6.0783F, 1.9924F, -0.829F, 0.0F, 0.0F));
