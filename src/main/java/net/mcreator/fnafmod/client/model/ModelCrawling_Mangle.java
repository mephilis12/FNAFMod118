	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition right_hand3 = right_lower_leg.addOrReplaceChild("right_hand3",
				CubeListBuilder.create().texOffs(31, 45).addBox(-1.1F, 0.0F, -1.5F, 2.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(21, 17)
						.addBox(0.9F, 1.0F, -0.5F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(42, 5).addBox(-1.1F, 2.0F, -1.5F, 3.0F, 2.0F,
		...
		PartDefinition LeftLowerLeg = partdefinition.addOrReplaceChild("LeftLowerLeg",
				CubeListBuilder.create().texOffs(39, 26).addBox(-1.5F, 5.901F, -2.5F, 3.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(49, 48)
		...
		PartDefinition bone7 = LeftLowerLeg.addOrReplaceChild("bone7",
				CubeListBuilder.create().texOffs(18, 0).addBox(0.0F, 0.902F, -4.5F, 2.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition BackLowerLeg = partdefinition.addOrReplaceChild("BackLowerLeg",
				CubeListBuilder.create().texOffs(39, 26).addBox(-1.3F, 5.901F, -2.5F, 3.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(49, 48)
		...
		PartDefinition bone12 = BackLowerLeg.addOrReplaceChild("bone12",
				CubeListBuilder.create().texOffs(18, 0).addBox(-0.9F, 0.902F, -4.5F, 2.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.1F, 6.0F, -2.0F));
		...
		PartDefinition RightLoweLeg = partdefinition.addOrReplaceChild("RightLoweLeg",
				CubeListBuilder.create().texOffs(49, 48).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bone14 = RightLoweLeg.addOrReplaceChild("bone14",
				CubeListBuilder.create().texOffs(18, 29).addBox(-2.8F, -1.099F, -7.2F, 5.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(38, 21)
						.addBox(-1.8F, -0.099F, -2.7F, 3.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(23, 21).addBox(-2.8F, -2.099F, -3.2F,
								5.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.3F, 6.0F, 0.2F, -0.0873F, 0.0F, 0.0F));
		PartDefinition Neck3 = partdefinition.addOrReplaceChild("Neck3",
				CubeListBuilder.create().texOffs(0, 13).addBox(0.0F, 0.0F, -0.5F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(50, 24)
		...
		PartDefinition endo_torso = Body.addOrReplaceChild(
				"endo_torso", CubeListBuilder.create().texOffs(28, 17).addBox(-1.0F, -17.0F, -2.0F, 8.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
						.texOffs(41, 50).addBox(1.0F, -15.0F, -2.0F, 4.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bone4 = endo_torso.addOrReplaceChild("bone4",
				CubeListBuilder.create().texOffs(48, 18).addBox(-1.3758F, -2.25F, -1.4192F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
						.texOffs(50, 36).addBox(-7.3658F, -9.76F, -0.9092F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(50, 36)
