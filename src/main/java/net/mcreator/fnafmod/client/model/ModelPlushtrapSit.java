	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = bone.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(17, 7).addBox(-2.0F, 1.8125F, -0.5F, 4.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(18, 5).addBox(-2.5F, -3.6875F, -0.5F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 3)
						...
						.addBox(-1.5F, 0.8125F, -1.0F, 3.0F, 0.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(14, 8).addBox(-1.5F, -3.6875F, -1.0F, 3.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(53, 9)
						.addBox(-0.5F, -3.9375F, -2.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(53, 6).addBox(-1.5F, -4.4375F, -2.0F, 3.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r1 = bone12.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(0, 58).addBox(-2.5F, -1.0F, -1.0F, 5.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r2 = bone11.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(21, 21).addBox(-0.5F, 0.0F, -1.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.5F, -0.5F, 0.0F, 0.0F, 0.0F, 0.3054F));
		PartDefinition cube_r3 = bone11.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(8, 23).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.5F, 0.0F, -1.5F, -0.8303F, 0.5545F, 0.4486F));
		PartDefinition LeftArm = bone.addOrReplaceChild("LeftArm", CubeListBuilder.create(), PartPose.offsetAndRotation(2.5F, -12.5F, 0.5F, -0.9163F, 0.0F, 0.0F));
		...
		PartDefinition bone8 = bone7.addOrReplaceChild("bone8", CubeListBuilder.create().texOffs(1, 17).addBox(0.0F, -0.5F, -1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.0F, 0.0F, 0.0F, 1.0868F, 0.4318F, -0.2166F));
		PartDefinition cube_r4 = bone8.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(13, 21).addBox(-0.75F, 0.0F, -1.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.5F, -0.5F, 0.0F, 0.0F, 0.0F, -0.6981F));
		PartDefinition cube_r5 = bone8.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(22, 11).addBox(-0.5F, -0.5F, 0.5F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition Head2 = Head.addOrReplaceChild("Head2",
				CubeListBuilder.create().texOffs(14, 25).addBox(-0.5F, -3.1F, -3.4F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(17, 27).addBox(-1.8F, -3.6F, -2.2F, 1.0F, 1.0F, 0.0F, new CubeDeformation(-0.2F)).texOffs(17, 27)
						.addBox(0.8F, -3.6F, -2.2F, 1.0F, 1.0F, 0.0F, new CubeDeformation(-0.2F)).texOffs(34, 46).addBox(-2.0F, -2.6F, -3.5F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(41, 47)
						.addBox(-2.5F, -4.6F, -2.5F, 5.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(43, 57).addBox(-1.5F, -5.6F, -2.5F, 3.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(7, 16)
		...
		PartDefinition cube_r6 = bone16.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(39, 4).addBox(-1.0F, -2.0F, -0.5F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r7 = bone15.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(39, 4).addBox(-1.0F, -2.0F, -0.5F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
