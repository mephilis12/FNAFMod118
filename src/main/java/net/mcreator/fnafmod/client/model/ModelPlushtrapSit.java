...
public class ModelPlushtrapSit<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("fnaf_mod", "model_plushtrap_sit"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone = partdefinition.addOrReplaceChild("bone", CubeListBuilder.create(), PartPose.offset(0.0F, 31.0F, 3.0F));
		PartDefinition RightLeg = bone.addOrReplaceChild("RightLeg",
				CubeListBuilder.create().texOffs(24, 30).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(62, -1)
		...
		PartDefinition bone4 = RightLeg.addOrReplaceChild("bone4",
				CubeListBuilder.create().texOffs(0, 19).addBox(0.0F, 0.5F, -0.5F, 0.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(16, 33)
		...
		PartDefinition bone17 = bone4.addOrReplaceChild("bone17",
				CubeListBuilder.create().texOffs(0, 40).addBox(-1.6F, 1.0F, -4.0F, 3.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(30, 59)
		...
		PartDefinition Body = bone.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(17, 7).addBox(-2.0F, 1.8125F, -0.5F, 4.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(18, 5)
						...
						.addBox(-0.5F, -3.9375F, -2.5F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(53, 6).addBox(-1.5F, -4.4375F, -2.0F,
		...
		PartDefinition LeftLeg = bone.addOrReplaceChild("LeftLeg",
				CubeListBuilder.create().texOffs(24, 38).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(62, -1)
						.addBox(0.0F, -0.5F, -0.5F, 0.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.5F, -8.5F, -1.5F, -2.1717F, -0.1462F, -0.058F));
		PartDefinition bone5 = LeftLeg.addOrReplaceChild("bone5",
				CubeListBuilder.create().texOffs(17, 19).addBox(0.0F, 0.5F, -0.5F, 0.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(16, 41)
						.addBox(-1.0F, -0.7F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition RightArm = bone.addOrReplaceChild("RightArm", CubeListBuilder.create(), PartPose.offset(-2.5F, -12.5F, 0.5F));
		...
		PartDefinition bone8 = bone7.addOrReplaceChild("bone8",
				CubeListBuilder.create().texOffs(1, 17).addBox(0.0F, -0.5F, -1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.0F, 0.0F, 0.0F, 1.0868F, 0.4318F, -0.2166F));
		PartDefinition cube_r4 = bone8.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(13, 21).addBox(-0.75F, 0.0F, -1.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(2.5F, -0.5F, 0.0F, 0.0F, 0.0F, -0.6981F));
		PartDefinition cube_r5 = bone8.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(22, 11).addBox(-0.5F, -0.5F, 0.5F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.5F, -0.5F, -2.0F, -0.7854F, 0.0F, 0.0F));
		PartDefinition Head = bone.addOrReplaceChild("Head", CubeListBuilder.create(), PartPose.offset(0.0F, -15.0F, 0.5F));
