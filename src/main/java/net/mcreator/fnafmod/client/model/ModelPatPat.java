...
public class ModelPatPat<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Sign = partdefinition.addOrReplaceChild("Sign",
				CubeListBuilder.create().texOffs(0, 20).addBox(-1.0F, -18.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(34, 24)
		...
		PartDefinition cube_r1 = Sign.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(0, 64).addBox(0.001F, 0.0F, 0.0F, 0.0F, 11.0F, 12.0F, new CubeDeformation(0.0F)),
