	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head2 = Head.addOrReplaceChild("Head2",
				CubeListBuilder.create().texOffs(34, 0).addBox(-4.0F, -2.2F, -4.0F, 8.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(74, 37)
						...
						.addBox(-3.5F, -8.2F, -5.0F, 7.0F, 6.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(30, 26).addBox(-4.5F, -5.2F, -5.0F, 9.0F,
		...
		PartDefinition cube_r1 = Jaw.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(53, 36).addBox(-5.0F, -1.7F, -2.5F, 8.0F, 2.0F, 5.0F, new CubeDeformation(-0.01F)).texOffs(38, 15)
		...
		PartDefinition LeftEar = Head2.addOrReplaceChild("LeftEar",
				CubeListBuilder.create().texOffs(0, 109).addBox(-1.5F, -6.75F, -1.5F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(124, 122)
						.addBox(-1.0F, -7.0F, -0.5F, 2.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(54, 61).addBox(-1.0F, -1.0F, -1.5F, 2.0F,
		...
		PartDefinition bone11 = LeftEar.addOrReplaceChild("bone11",
				CubeListBuilder.create().texOffs(16, 109).addBox(-1.5F, -4.25F, -1.0F, 3.0F, 4.0F, 2.0F, new CubeDeformation(0.01F)).texOffs(114, 122)
		...
		PartDefinition bone12 = bone11.addOrReplaceChild("bone12",
				CubeListBuilder.create().texOffs(114, 122).addBox(-1.0F, -2.0F, 0.0F, 2.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(39, 110)
		...
		PartDefinition RightEar = Head2.addOrReplaceChild("RightEar",
				CubeListBuilder.create().texOffs(0, 121).addBox(-1.5F, -6.75F, -0.5F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(124, 122)
						.addBox(-1.0F, -7.0F, 0.5F, 2.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(60, 18).addBox(-1.0F, -1.0F, -0.5F, 2.0F,
								2.0F, 1.0F, new CubeDeformation(-0.01F)),
		...
		PartDefinition bone9 = RightEar.addOrReplaceChild("bone9",
				CubeListBuilder.create().texOffs(16, 121).addBox(-1.5F, -4.25F, -1.0F, 3.0F, 4.0F, 2.0F, new CubeDeformation(0.01F)).texOffs(114, 122)
						.addBox(-1.0F, -5.0F, 0.0F, 2.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -7.0F, 0.5F, 1.6581F, 0.0F, 0.0F));
		PartDefinition bone10 = bone9.addOrReplaceChild("bone10",
				CubeListBuilder.create().texOffs(39, 122).addBox(-1.5F, -2.75F, -1.0F, 3.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(114, 122)
		...
		PartDefinition right_hand = bone2.addOrReplaceChild("right_hand",
				CubeListBuilder.create().texOffs(65, 82).addBox(-0.9F, 0.5F, -2.0F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(4, 85)
						.addBox(-0.4F, 0.7F, -1.5F, 1.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(30, 12).addBox(0.6F, 1.2F, -1.0F, 2.0F, 3.0F,
		...
		PartDefinition LeftArm_r2 = right_hand.addOrReplaceChild("LeftArm_r2",
				CubeListBuilder.create().texOffs(0, 57).addBox(-0.5F, -2.5F, 0.5F, 3.0F, 3.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(0, 54)
		...
		PartDefinition bone8 = bone4.addOrReplaceChild("bone8",
				CubeListBuilder.create().texOffs(75, 0).addBox(-1.9F, 3.001F, -5.5F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(80, 41)
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(79, 28).addBox(-8.05F, -11.6F, 0.9857F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(62, 32)
						...
						.addBox(-5.5F, -8.5F, -3.0143F, 11.0F, 6.0F, 8.0F, new CubeDeformation(0.0F)).texOffs(0, 0).addBox(-6.5F, -12.5F, -3.0143F,
								13.0F, 4.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 6.0F, 1.0143F, 0.3927F, 0.0F, 0.0F));
		PartDefinition cube_r2 = Body.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(35, 5).addBox(-4.5F, -1.5F, -3.5F, 9.0F, 3.0F, 7.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r3 = endo_torso.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(71, 61).addBox(-4.0F, -1.5F, -1.0F, 8.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
