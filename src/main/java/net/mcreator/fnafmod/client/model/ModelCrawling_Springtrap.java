...
public class ModelCrawling_Springtrap<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("fnaf_mod", "model_crawling_springtrap"),
			"main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition LeftArm = partdefinition.addOrReplaceChild("LeftArm",
				CubeListBuilder.create().texOffs(35, 73).addBox(-2.01F, 0.9F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 47)
						...
						.addBox(-1.35F, 1.5F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(14, 38).addBox(-0.8F, 6.4F, -1.0F, 2.0F,
		...
		PartDefinition bone6 = bone3.addOrReplaceChild("bone6",
				CubeListBuilder.create().texOffs(9, 45).addBox(-0.5724F, 0.0681F, -1.5F, 1.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(99, 56)
		...
		PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm",
				CubeListBuilder.create().texOffs(35, 73).addBox(-2.01F, 1.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(27, 65)
						...
						.addBox(-0.5F, 0.5F, -0.5F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(14, 38).addBox(-1.0F, 6.5F, -1.0F, 2.0F,
								2.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg",
				CubeListBuilder.create().texOffs(74, 30).addBox(-1.9F, -0.5F, -2.0F, 4.0F, 8.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(14, 38)
						...
						.addBox(-1.4F, 1.0F, -1.5F, 3.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(4, 47).addBox(-0.4436F, -1.5F, -0.4981F,
								1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bone4 = LeftLeg.addOrReplaceChild("bone4",
				CubeListBuilder.create().texOffs(95, 123).addBox(-1.9F, -1.5F, -2.5F, 4.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(4, 47)
						.addBox(-0.4F, 0.0F, -0.5F, 1.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(28, 111).addBox(-0.9F, 1.0F, -1.0F, 2.0F,
								5.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bone12 = bone4.addOrReplaceChild("bone12",
				CubeListBuilder.create().texOffs(0, 122).addBox(-1.5F, 0.5915F, -1.2209F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F))
						.texOffs(54, 123).addBox(-2.0F, 2.5915F, -5.2209F, 4.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(28, 22)
		...
		PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg",
				CubeListBuilder.create().texOffs(14, 38).addBox(-1.0F, 8.5F, -0.5F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(0, 16)
						...
						.addBox(-1.5F, 1.0F, -1.5F, 3.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(4, 47).addBox(-0.4564F, -1.5F, -0.4981F,
								1.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition right_lower_leg = RightLeg.addOrReplaceChild("right_lower_leg",
				CubeListBuilder.create().texOffs(98, 9).addBox(-2.0F, 0.5F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(83, 123)
						...
						.addBox(-0.5F, 0.0F, -0.5F, 1.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(28, 111).addBox(-1.0F, 1.0F, -1.0F, 2.0F,
								5.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bone13 = right_lower_leg.addOrReplaceChild("bone13",
				CubeListBuilder.create().texOffs(28, 22).addBox(-1.0F, -0.4093F, 0.2791F, 2.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(0, 122)
