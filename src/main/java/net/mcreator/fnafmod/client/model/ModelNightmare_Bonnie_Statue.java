...
public class ModelNightmare_Bonnie_Statue<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("fnaf_mod", "model_nightmare_bonnie_statue"),
			"main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(79, 28).addBox(-8.05F, -2.8571F, 0.9857F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
						.texOffs(62, 32).addBox(6.05F, -2.8571F, 0.9857F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(35, 5)
