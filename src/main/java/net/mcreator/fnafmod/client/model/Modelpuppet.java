...
public class Modelpuppet<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition left_lower_arm = left_arm.addOrReplaceChild("left_lower_arm",
				CubeListBuilder.create().texOffs(4, 34).addBox(-1.3056F, -3.3536F, -1.3914F, 1.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition right_lower_arm = right_arm.addOrReplaceChild("right_lower_arm",
				CubeListBuilder.create().texOffs(34, 11).addBox(-1.6414F, -3.0F, -1.0556F, 1.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 12.0F, 0.0F, 0.0F, -0.7854F, 0.0F));
		...
		PartDefinition left_lower_leg = left_leg.addOrReplaceChild("left_lower_leg",
				CubeListBuilder.create().texOffs(34, 0).addBox(-0.5F, -4.3333F, -0.5F, 1.0F, 10.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition right_lower_leg = right_leg.addOrReplaceChild("right_lower_leg",
				CubeListBuilder.create().texOffs(33, 31).addBox(-0.5F, -4.3333F, -0.5F, 1.0F, 10.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 14.8333F, 0.0F, 0.0F, -0.7854F, 0.0F));
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(23, 26).addBox(-1.5F, -23.0F, -1.0F, 4.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(25, 31)
