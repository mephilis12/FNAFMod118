...
public class ModelMangle_Day<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Body = partdefinition.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(50, 36).addBox(-7.49F, -13.51F, -0.99F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(50, 36)
				.addBox(-2.49F, -13.51F, -1.99F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(50, 36).addBox(5.49F, -13.51F, -0.99F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 26.0F, 1.0F));
		PartDefinition LeftArm = Body.addOrReplaceChild("LeftArm", CubeListBuilder.create().texOffs(23, 52).addBox(-0.35F, 1.1F, -0.5F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(29, 37)
		...
		PartDefinition bone5 = LeftArm2.addOrReplaceChild("bone5", CubeListBuilder.create().texOffs(0, 13).addBox(-0.45F, 1.0F, -0.5F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(29, 37)
				.addBox(-1.5F, 1.1F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(50, 36).addBox(-0.95F, 6.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 7.9F, 0.0F, -0.3054F, 0.0F, 0.829F));
		PartDefinition RightArm = Body.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(29, 37).addBox(-1.5F, 2.0F, -1.5F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(23, 52)
		...
		PartDefinition RightArm2 = Body.addOrReplaceChild("RightArm2", CubeListBuilder.create().texOffs(50, 24).addBox(-1.0F, 2.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(23, 52)
				.addBox(-0.5F, 1.0F, -0.5F, 1.0F, 7.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(50, 36).addBox(-1.0F, 7.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bone8 = LeftArm3.addOrReplaceChild("bone8", CubeListBuilder.create().texOffs(0, 13).addBox(-0.5F, 1.0F, -0.5F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(50, 24)
				.addBox(-1.0F, 2.1F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(50, 36).addBox(-1.0F, 7.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition cube_r2 = endoi_jaw.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(46, 14).addBox(-1.5F, -0.75F, -1.0F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(0, 13).addBox(-3.5F, -0.25F, -2.5F, 7.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)).texOffs(7, 46)
						.addBox(-1.5F, -0.75F, -5.5F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(28, 6).addBox(-2.5F, -0.25F, -6.5F, 5.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 35)
		...
		PartDefinition cube_r3 = endoi_jaw.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(0, 40).addBox(-2.5F, -2.25F, -3.5F, 5.0F, 9.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bone4 = LeftLeg.addOrReplaceChild("bone4", CubeListBuilder.create().texOffs(49, 48).addBox(-0.5F, 1.001F, -0.5F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 7.0F, 0.0F, 1.8744F, -0.1278F, 0.0285F));
		PartDefinition bone7 = bone4.addOrReplaceChild("bone7",
				CubeListBuilder.create().texOffs(18, 0).addBox(-1.0462F, 0.0753F, -6.21F, 2.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(39, 26).addBox(-1.5462F, -0.9258F, -2.21F, 3.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bone11 = LeftLeg2.addOrReplaceChild("bone11", CubeListBuilder.create().texOffs(49, 48).addBox(-1.4F, 1.001F, -0.5F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 7.0F, 0.0F, 2.1357F, 0.0025F, 0.1526F));
		PartDefinition bone12 = bone11.addOrReplaceChild("bone12",
				CubeListBuilder.create().texOffs(18, 0).addBox(0.1F, 0.902F, -6.5F, 2.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(39, 26).addBox(-0.4F, -0.099F, -2.5F, 3.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition RightLeg_r4 = bone12.addOrReplaceChild("RightLeg_r4", CubeListBuilder.create().texOffs(18, 0).addBox(-0.3F, 1.0F, -4.5F, 2.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.1F, 0.002F, -2.0F, 0.0F, -0.3927F, 0.0F));
		PartDefinition bone13 = bone11.addOrReplaceChild("bone13", CubeListBuilder.create(), PartPose.offsetAndRotation(-0.1F, 7.0F, 0.7F, 0.0F, -0.1309F, 0.0F));
		...
		PartDefinition right_lower_leg = RightLeg.addOrReplaceChild("right_lower_leg", CubeListBuilder.create().texOffs(49, 48).addBox(-1.0F, 1.0F, -1.1F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition right_hand3 = right_lower_leg.addOrReplaceChild("right_hand3",
				CubeListBuilder.create().texOffs(31, 45).addBox(-1.1F, 0.0F, -1.5F, 2.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(21, 17).addBox(0.9F, 1.0F, -0.5F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 7.0F, -0.1F, -0.1793F, 0.5872F, -0.3161F));
		PartDefinition LeftArm_r1 = right_hand3.addOrReplaceChild("LeftArm_r1", CubeListBuilder.create().texOffs(42, 5).addBox(-0.5333F, -0.5F, -1.5F, 3.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition right_lower_leg2 = RightLeg2.addOrReplaceChild("right_lower_leg2", CubeListBuilder.create().texOffs(49, 48).addBox(-1.5F, 1.0F, -0.5F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 7.0F, 0.0F, 2.1372F, 0.0852F, -0.0189F));
		PartDefinition bone14 = right_lower_leg2.addOrReplaceChild("bone14", CubeListBuilder.create().texOffs(18, 29).addBox(-2.8F, -1.099F, -7.2F, 5.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(38, 21)
		...
		PartDefinition endo_torso = Body.addOrReplaceChild("endo_torso",
				CubeListBuilder.create().texOffs(48, 18).addBox(1.5F, -19.0F, -2.5F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(19, 40).addBox(2.0F, -18.0F, -2.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(28, 17)
						.addBox(-1.0F, -17.0F, -2.0F, 8.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(41, 50).addBox(1.0F, -15.0F, -2.0F, 4.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(51, 41)
						.addBox(2.0F, -28.5F, -2.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(18, 26).addBox(2.5F, -30.0F, -1.5F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(0, 54)
						.addBox(6.5F, -26.5F, -2.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(-0.01F)).texOffs(22, 4).addBox(7.5F, -26.0F, -1.0F, 2.0F, 1.0F, 0.0F, new CubeDeformation(-0.01F)).texOffs(22, 4)
						.addBox(-3.5F, -26.0F, -1.0F, 2.0F, 1.0F, 0.0F, new CubeDeformation(-0.01F)).texOffs(0, 54).addBox(-1.5F, -26.5F, -2.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(-0.01F)).texOffs(0, 26)
		...
		PartDefinition right_hand4 = endo_torso.addOrReplaceChild("right_hand4", CubeListBuilder.create().texOffs(31, 45).addBox(-1.0F, -0.2F, -1.5F, 2.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(21, 17)
