...
public class ModelPlushtrap<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Head2 = Head.addOrReplaceChild("Head2",
				CubeListBuilder.create().texOffs(14, 25).addBox(-0.5F, -3.1F, -3.4F, 1.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(17, 27)
						...
						.addBox(-2.0F, -2.6F, -3.5F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(41, 47).mirror()
						.addBox(-2.5F, -4.6F, -2.5F, 5.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false).texOffs(43, 57)
						...
						.addBox(0.8F, -3.6F, -2.0F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.25F)).texOffs(37, 37).addBox(-2.0F, -4.1F, -2.0F, 4.0F,
		...
		PartDefinition bone20 = Head2.addOrReplaceChild("bone20",
				CubeListBuilder.create().texOffs(22, 8).addBox(-1.5F, -0.5F, -3.5F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(12, 0)
						...
						.addBox(-1.5F, -1.05F, -3.3F, 3.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(14, 28).addBox(-2.3F, -1.05F, -2.5F, 0.0F,
								1.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0873F, 0.0F, 0.0F));
		PartDefinition LeftEar = Head2.addOrReplaceChild("LeftEar",
				CubeListBuilder.create().texOffs(33, 0).addBox(-1.1305F, -4.4914F, -0.5F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(11, 0)
		...
		PartDefinition bone16 = LeftEar.addOrReplaceChild("bone16",
				CubeListBuilder.create().texOffs(13, 0).addBox(-0.6305F, -4.2011F, 0.0F, 1.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(39, 1)
		...
		PartDefinition cube_r1 = bone16.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(39, 4).addBox(-1.0F, -2.0F, -0.5F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition RightEar = Head2.addOrReplaceChild("RightEar",
				CubeListBuilder.create().texOffs(33, 0).addBox(-0.8695F, -4.4914F, -0.5F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(11, 0)
		...
		PartDefinition bone15 = RightEar.addOrReplaceChild("bone15",
				CubeListBuilder.create().texOffs(13, 0).addBox(-0.3695F, -4.2011F, 0.0F, 1.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(39, 1)
		...
		PartDefinition cube_r2 = bone15.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(39, 4).addBox(-1.0F, -2.0F, -0.5F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition LeftArm2 = LeftArm.addOrReplaceChild("LeftArm2",
				CubeListBuilder.create().texOffs(53, 27).addBox(0.0F, -1.0F, -1.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(55, 26)
		...
		PartDefinition bone7 = LeftArm2.addOrReplaceChild("bone7",
				CubeListBuilder.create().texOffs(24, 10).addBox(0.0F, -0.5F, 0.0F, 3.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)).texOffs(8, 49)
		...
		PartDefinition bone8 = bone7.addOrReplaceChild("bone8",
				CubeListBuilder.create().texOffs(1, 17).addBox(0.0F, -0.5F, -1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(22, 11)
						.addBox(1.0F, -0.5F, -2.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(13, 21).addBox(2.0F, -0.5F, -1.0F, 1.0F,
								2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(3.0F, 0.0F, 0.0F, 0.48F, 0.0F, 0.0F));
		...
		PartDefinition RightArm2 = RightArm.addOrReplaceChild("RightArm2",
				CubeListBuilder.create().texOffs(39, 27).addBox(-3.0F, -1.0F, -1.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(41, 26)
		...
		PartDefinition bone10 = RightArm2.addOrReplaceChild("bone10",
				CubeListBuilder.create().texOffs(15, 55).addBox(-3.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(3, 24)
						.addBox(-3.0F, -0.5F, 0.0F, 3.0F, 1.0F, 0.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.0F, 0.0F, 0.0F, 0.598F, -1.3681F, 0.282F));
		PartDefinition bone11 = bone10.addOrReplaceChild("bone11",
				CubeListBuilder.create().texOffs(1, 21).addBox(-2.0F, -0.5F, -1.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-3.0F, 0.0F, 0.0F, 0.0917F, -0.1199F, 0.313F));
		PartDefinition cube_r3 = bone11.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(21, 21).addBox(-0.5F, 0.0F, -1.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-2.5F, -0.5F, 0.0F, 0.0F, 0.0F, 0.3054F));
		PartDefinition cube_r4 = bone11.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(8, 23).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.5F, 0.0F, -1.5F, -0.8303F, 0.5545F, 0.4486F));
		PartDefinition RightLeg = partdefinition.addOrReplaceChild(
				"RightLeg", CubeListBuilder.create().texOffs(24, 30).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F))
						.texOffs(62, -1).addBox(0.0F, -0.5F, -0.5F, 0.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-1.5F, 17.5F, 0.5F));
		PartDefinition bone4 = RightLeg
				.addOrReplaceChild(
						"bone4", CubeListBuilder.create().texOffs(0, 19).addBox(0.0F, 0.5F, -0.5F, 0.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
								.texOffs(16, 33).addBox(-1.0F, -0.7F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
						PartPose.offset(0.0F, 3.0F, 0.0F));
		PartDefinition bone17 = bone4
				.addOrReplaceChild("bone17",
						CubeListBuilder.create().texOffs(0, 40).addBox(-1.6F, 1.0F, -4.0F, 3.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
								.texOffs(30, 59).addBox(-1.0F, 0.0F, -2.0F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)),
						PartPose.offset(0.0F, 1.5F, 0.0F));
		PartDefinition LeftLeg = partdefinition
				.addOrReplaceChild("LeftLeg",
						CubeListBuilder.create().texOffs(24, 38).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F))
								.texOffs(62, -1).addBox(0.0F, -0.5F, -0.5F, 0.0F, 4.0F, 1.0F, new CubeDeformation(0.0F)),
						PartPose.offset(1.5F, 17.5F, 0.5F));
		PartDefinition bone5 = LeftLeg
				.addOrReplaceChild("bone5",
						CubeListBuilder.create().texOffs(17, 19).addBox(0.0F, 0.5F, -0.5F, 0.0F, 2.0F, 1.0F, new CubeDeformation(0.0F))
								.texOffs(16, 41).addBox(-1.0F, -0.7F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
						PartPose.offset(0.0F, 3.0F, 0.0F));
		PartDefinition bone18 = bone5
				.addOrReplaceChild("bone18",
						CubeListBuilder.create().texOffs(0, 40).addBox(-1.6F, 1.0F, -4.0F, 3.0F, 1.0F, 2.0F, new CubeDeformation(0.0F))
								.texOffs(30, 59).addBox(-1.0F, 0.0F, -2.0F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)),
						PartPose.offset(0.0F, 1.5F, 0.0F));
		PartDefinition Body = partdefinition.addOrReplaceChild("Body",
				CubeListBuilder.create().texOffs(17, 7).addBox(-2.0F, 1.8125F, -0.5F, 4.0F, 0.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(18, 5)
						...
						.addBox(-1.5F, 0.8125F, -1.0F, 3.0F, 0.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(14, 8).addBox(-1.5F, -3.6875F, -1.0F,
								3.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, 14.6875F, 0.5F, 0.0873F, 0.0F, 0.0F));
		PartDefinition bone12 = Body.addOrReplaceChild("bone12",
				CubeListBuilder.create().texOffs(33, 12).addBox(-2.5F, -13.5F, -1.0F, 5.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 9.3125F, -0.5F));
		PartDefinition cube_r5 = bone12.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(0, 58).addBox(-2.5F, -1.0F, -1.0F, 5.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
