...
public class ModelSpringBonnie<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Jaw = Head.addOrReplaceChild(
				"Jaw", CubeListBuilder.create().texOffs(29, 10).addBox(-4.0F, -0.85F, -6.1652F, 8.0F, 2.0F, 7.0F, new CubeDeformation(0.0F))
						.texOffs(28, 0).addBox(-3.5F, -1.15F, -5.6652F, 7.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition LeftTop = LeftEar
				.addOrReplaceChild("LeftTop",
						CubeListBuilder.create().texOffs(70, 21).addBox(-1.5F, -5.3F, -1.0F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F))
								.texOffs(16, 49).addBox(-1.0F, -4.8F, 0.0F, 2.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition LeftTop2 = RightEar.addOrReplaceChild(
				"LeftTop2", CubeListBuilder.create().texOffs(0, 70).addBox(-1.5803F, -5.3F, -0.8211F, 3.0F, 5.0F, 2.0F, new CubeDeformation(0.0F))
						.texOffs(16, 49).addBox(-1.0803F, -4.8F, 0.1789F, 2.0F, 5.0F, 0.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition bone6 = bone3.addOrReplaceChild("bone6",
				CubeListBuilder.create().texOffs(48, 29).addBox(-0.5F, 0.6F, -1.625F, 1.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)).texOffs(68, 58)
						...
						.addBox(-1.0F, 2.1F, -2.125F, 3.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(44, 40).addBox(1.0F, 1.1F, -0.125F, 2.0F,
