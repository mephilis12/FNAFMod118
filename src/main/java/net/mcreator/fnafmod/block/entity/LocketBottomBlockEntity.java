...
public class LocketBottomBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public LocketBottomBlockEntity(BlockPos position, BlockState state) {
		super(FnafModModBlockEntities.LOCKET_BOTTOM.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return new TextComponent("locket_bottom");
	}
