...
public class ChicaHeadDecorationTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<ChicaHeadDecorationTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<ChicaHeadDecorationTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
