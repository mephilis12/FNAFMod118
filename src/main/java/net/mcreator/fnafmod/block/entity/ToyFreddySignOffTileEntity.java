...
public class ToyFreddySignOffTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<ToyFreddySignOffTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<ToyFreddySignOffTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
