...
public class RetroFreddySignTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<RetroFreddySignTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<RetroFreddySignTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
