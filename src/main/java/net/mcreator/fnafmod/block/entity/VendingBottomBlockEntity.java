...
public class VendingBottomBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public VendingBottomBlockEntity(BlockPos position, BlockState state) {
		super(FnafModModBlockEntities.VENDING_BOTTOM.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("vending_bottom");
	}
