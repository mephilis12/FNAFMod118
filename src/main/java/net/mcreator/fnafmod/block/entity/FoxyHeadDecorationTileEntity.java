...
public class FoxyHeadDecorationTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<FoxyHeadDecorationTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<FoxyHeadDecorationTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
