...
public class SpringBonnieDecorTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<SpringBonnieDecorTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<SpringBonnieDecorTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
