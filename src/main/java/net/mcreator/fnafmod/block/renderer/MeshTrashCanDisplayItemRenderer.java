...
public class MeshTrashCanDisplayItemRenderer extends GeoItemRenderer<MeshTrashCanDisplayItem> {
	...
	@Override
	public RenderType getRenderType(MeshTrashCanDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
