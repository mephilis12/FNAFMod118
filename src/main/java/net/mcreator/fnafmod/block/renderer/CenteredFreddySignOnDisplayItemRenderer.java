...
public class CenteredFreddySignOnDisplayItemRenderer extends GeoItemRenderer<CenteredFreddySignOnDisplayItem> {
	...
	@Override
	public RenderType getRenderType(CenteredFreddySignOnDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
