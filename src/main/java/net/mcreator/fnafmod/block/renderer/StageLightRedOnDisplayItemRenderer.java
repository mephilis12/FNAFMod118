...
public class StageLightRedOnDisplayItemRenderer extends GeoItemRenderer<StageLightRedOnDisplayItem> {
	...
	@Override
	public RenderType getRenderType(StageLightRedOnDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
