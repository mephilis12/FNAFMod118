...
public class RetroFreddySignOnDisplayItemRenderer extends GeoItemRenderer<RetroFreddySignOnDisplayItem> {
	...
	@Override
	public RenderType getRenderType(RetroFreddySignOnDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
