...
public class FoxyHeadDecorationDisplayItemRenderer extends GeoItemRenderer<FoxyHeadDecorationDisplayItem> {
	...
	@Override
	public RenderType getRenderType(FoxyHeadDecorationDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
