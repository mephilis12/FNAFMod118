...
public class FredbearSignDisplayItemRenderer extends GeoItemRenderer<FredbearSignDisplayItem> {
	...
	@Override
	public RenderType getRenderType(FredbearSignDisplayItem animatable, float partialTick, PoseStack poseStack, MultiBufferSource bufferSource, VertexConsumer buffer, int packedLight, ResourceLocation texture) {
